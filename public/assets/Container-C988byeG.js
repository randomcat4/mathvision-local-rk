...
const T = $(),
  ...
  y = (e) => R({ props: e, name: "MuiContainer", defaultTheme: T }),
  L = (e, s) => {
    const o = (i) => M(s, i),
      { classes: u, fixed: p, disableGutters: l, maxWidth: t } = e,
      a = { root: ["root", t && `maxWidth${c(String(t))}`, p && "fixed", l && "disableGutters"] };
    return G(a, o, u);
  };
function N(e = {}) {
  const {
    ...
    p = s(
      ...
      ({ theme: t, ownerState: a }) =>
        ...
        Object.keys(t.breakpoints.values).reduce((i, r) => {
          const d = r,
            n = t.breakpoints.values[d];
          return (
            n !== 0 && (i[t.breakpoints.up(d)] = { maxWidth: `${n}${t.breakpoints.unit}` }),
            i
          );
        }, {}),
      ({ theme: t, ownerState: a }) => ({
  ...
  return h.forwardRef(function (a, i) {
    const r = o(a),
      ...
      x = { ...r, component: n, disableGutters: m, fixed: b, maxWidth: f },
      g = L(x, u);
    return W.jsx(p, { as: n, ownerState: x, className: k(g.root, d), ref: i, ...C });
  });
}
const D = N({
  ...
  useThemeProps: (e) => P({ props: e, name: "MuiContainer" }),
});
export { D as C };
