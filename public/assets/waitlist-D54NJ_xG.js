...
import { A as o } from "./AccessStatusPage-BWPFK5HR.js";
...
function i() {
  return t.jsx(o, {
    ...
    message:
      "Your account is on the waitlist while access is limited. We may email you once a spot opens and your account is allowed to use the app.",
    showWaitlistSignupForm: !0,
  });
}
const l = i;
