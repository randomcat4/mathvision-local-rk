...
var Xn = (t, e, n) =>
  e in t ? Kn(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (t[e] = n);
...
import { a3 as nr, a4 as Me } from "./ChatPanelMoreMenu-B1X9SOWN.js";
import { P as rr } from "./play-3zl_nde-.js";
import { C as or } from "./MChip-DiH8NXBU.js";
import { A as ir } from "./arrow-right-DvMAP92m.js";
import { a as sr } from "./LoadingSection-wWBu2CqJ.js";
import { D as cr } from "./Divider-BcuihGce.js";
import { h as W, T as V, b as ar, j as lr } from "./ThinkingElapsedLabel-DKCKD95O.js";
...
var dr = gn("function"),
  pr = (t) => t === null,
  Fe = (t) => Object.prototype.toString.call(t).slice(8, -1) === "RegExp",
  je = (t) => !mr(t) && !pr(t) && (dr(t) || typeof t == "object"),
  mr = gn("undefined");
function gr(t, e, n) {
  return xr(n, t, e)
    ? !0
        ...
        : Array.isArray(t) && Array.isArray(e)
          ...
          : t instanceof Map && e instanceof Map
            ...
            : t instanceof Set && e instanceof Set
              ? Tr(t, e)
              : t instanceof WeakMap || t instanceof WeakSet
                ? !1
                : ArrayBuffer.isView(t) && ArrayBuffer.isView(e)
                  ? yr(t, e)
                  : Fe(t) && Fe(e)
                    ? t.source === e.source && t.flags === e.flags
                    : t instanceof Error && e instanceof Error
                      ? br(t, e, n)
...
function hr(t, e, n) {
  ...
  for (let o = r; o-- !== 0;) if (!Ft(t[o], e[o], n)) return !1;
  return !0;
}
function yr(t, e) {
...
function br(t, e, n) {
  return t.message === e.message && t.name === e.name && Ft(t.cause, e.cause, n);
}
function wr(t, e, n) {
  if (t.size !== e.size) return !1;
  for (const r of t.entries()) if (!e.has(r[0])) return !1;
  for (const r of t.entries()) if (!Ft(r[1], e.get(r[0]), n)) return !1;
  return !0;
}
function Er(t, e, n) {
  const r = Object.keys(t);
  if (r.length !== Object.keys(e).length) return !1;
  for (let o = r.length; o-- !== 0;) if (!Object.prototype.hasOwnProperty.call(e, r[o])) return !1;
  for (let o = r.length; o-- !== 0;) {
    const i = r[o];
    if (!(i === "_owner" && t.$$typeof) && !Ft(t[i], e[i], n)) return !1;
  }
  return !0;
}
function Tr(t, e) {
  if (t.size !== e.size) return !1;
  for (const n of t.entries()) if (!e.has(n[0])) return !1;
  return !0;
}
function xr(t, e, n) {
  var r;
  return ((r = t.get(e)) == null ? void 0 : r.has(n)) ?? !1;
}
function Sr(t, e, n) {
  let r = t.get(e);
  (r || ((r = new WeakSet()), t.set(e, r)), r.add(n));
}
function Te(t, e) {
...
function Pr(t, e) {
  const n = g.useRef(e);
  return (Te(e, n.current) || (n.current = e), g.useMemo(t, n.current));
}
function Ar(t) {
  g.useEffect(() => {
    t();
...
var Lr = Zn(),
  ...
  Ir = ["bigint", "boolean", "null", "number", "string", "symbol", "undefined"];
function jt(t) {
...
var Mr = ["innerHTML", "ownerDocument", "style", "attributes", "nodeValue"],
  Bt = (t) => Array.isArray(t),
  Fr = (t) => jt(t) === "AsyncGeneratorFunction",
  jr = ot("AsyncFunction"),
  Br = Ct("bigint"),
  $r = (t) => t === !0 || t === !1,
  Hr = ot("Date"),
  Ur = ot("Error"),
  yt = Ct("function"),
  zr = ot("GeneratorFunction"),
  Wr = (t) => typeof t == "number" && Number.isInteger(t),
  he = ot("Map"),
  yn = (t) => Number.isNaN(t),
  xe = (t) => t === null,
  bn = ot("Function"),
  ...
  Oe = (t) => xe(t) || Se(t),
  wn = (t) => !Se(t),
  Xr = (t) => Ct("number")(t) && !yn(t),
  Jr = (t) => $t(t) && t.trim().length > 0,
  Zr = (t) => {
    if (!$t(t) || t.length === 0) return !1;
    const e = t.trim();
    return e.length > 0 && Number.isFinite(Number(e));
  },
  ne = (t) => !Oe(t) && (yt(t) || typeof t == "object"),
  En = (t) => {
    if (jt(t) !== "Object") return !1;
    const e = Object.getPrototypeOf(t);
    return e === null || e === Object.getPrototypeOf({});
  },
  Qr = (t) => xe(t) || _r(typeof t),
  to = (t) => jt(t) === "URL",
  Tn = (t) => !Oe(t) && yt(t[Symbol.iterator]),
  eo = (t) => Tn(t) && yt(t.next) && yt(t.throw),
  no = (t) => yt(t) && /^class\s/.test(t.toString()),
  ro = (t, e) => (!Bt(t) || !yt(e) ? !1 : t.every((n) => e(n))),
  oo = (t) => ne(t) && !En(t) && t.nodeType === 1 && $t(t.nodeName) && Mr.every((e) => e in t),
  io = (t) =>
    ($t(t) && t.length === 0) ||
    (Bt(t) && t.length === 0) ||
    ...
    (ye(t) && t.size === 0) ||
    (he(t) && t.size === 0),
  so = (t, e) => (!t || !e ? !1 : Object.getPrototypeOf(t) === e.prototype),
  co = (t, e) => (Bt(t) ? t.indexOf(e) > -1 : !1),
  ao = (t, e, n) => {
    if (!ne(t) || !e) return !1;
    const r = t[e];
    return yt(n) ? n(r) : wn(r);
  };
function j(t) {
  ...
  if (Bt(t)) return "Array";
  if (bn(t)) return "Function";
  const e = jt(t);
  return e || "Object";
}
j.array = Bt;
...
j.weakSet = Kr;
var X = j;
/* v8 ignore next -- @preserve */ var le, Be;
function lo() {
  if (Be) return le;
  Be = 1;
  var t = function (r) {
    ...
    n = function (r) {
      return r === null || typeof r == "boolean" || typeof r > "u"
        ? ""
        : typeof r == "number"
          ? r.toString()
          : typeof r == "string"
            ...
            : Array.isArray(r)
              ? r.reduce(e, "")
              : t(r) && Object.prototype.hasOwnProperty.call(r.props, "children")
                ? n(r.props.children)
                : "";
    };
  return ((n.default = n), (le = n), le);
}
var uo = lo();
const ue = ee(uo);
var fe = { exports: {} },
    ...
    $e ||
      ...
      (function (t) {
        ...
        function n() {
          return function (i) {
            return (
              typeof i == "object" && i !== null && !(i instanceof RegExp) && !(i instanceof Date)
            );
          };
        }
        function r(o) {
          ...
          function s(b) {
            ...
            const v = b.length,
              P = new Array(v);
            for (E; E < v; ++E) P[E] = d(b[E]);
            return P;
          }
          function a(b) {
            const E = {};
            if (u && Object.getPrototypeOf(b) !== e) return u(b);
            const v = l(b);
            let P, _, L;
            for (P = 0, _ = v.length; P < _; ++P) i((L = v[P])) && (E[L] = d(b[L]));
            return E;
          }
          function c(b, E) {
            const v = b.length,
            ...
            for (_; _ < v; ++_) L[_] = d(b[_]);
            for (_ = 0; _ < P; ++_) L[_ + v] = d(E[_]);
            return L;
          }
          const f = Object.prototype.propertyIsEnumerable;
          function m(b) {
            const E = Object.keys(b),
              v = Object.getOwnPropertySymbols(b);
            for (let P = 0, _ = v.length; P < _; ++P) f.call(b, v[P]) && E.push(v[P]);
            return E;
          }
          const l = o != null && o.symbols ? m : Object.keys,
            u =
              typeof (o == null ? void 0 : o.cloneProtoObject) == "function"
                ? o.cloneProtoObject
                : void 0,
            p =
              typeof (o == null ? void 0 : o.isMergeableObject) == "function"
                ? o.isMergeableObject
                : n(),
            h = (o == null ? void 0 : o.onlyDefinedProperties) === !0;
          function T(b) {
            return typeof b != "object" || b === null;
          }
          const S =
            o && typeof o.mergeArray == "function"
              ? o.mergeArray({ clone: d, deepmerge: w, getKeys: l, isMergeableObject: p })
              : c;
          function d(b) {
            return p(b) ? (Array.isArray(b) ? s(b) : a(b)) : b;
          }
          function y(b, E) {
            const v = {},
              P = l(b),
            ...
            for (L = 0, C = P.length; L < C; ++L)
              i((x = P[L])) && _.indexOf(x) === -1 && (v[x] = d(b[x]));
            for (L = 0, C = _.length; L < C; ++L)
              if (i((x = _[L])))
                if (x in b)
                  P.indexOf(x) !== -1 &&
                    (u && p(E[x]) && Object.getPrototypeOf(E[x]) !== e
                      ? (v[x] = u(E[x]))
                      : (v[x] = w(b[x], E[x])));
                else {
                  if (h && typeof E[x] > "u") continue;
                  v[x] = d(E[x]);
                }
            return v;
          }
          function w(b, E) {
            if (h && typeof E > "u") return d(b);
            const v = Array.isArray(E),
              P = Array.isArray(b);
            return T(E) ? E : p(b) ? (v && P ? S(b, E) : v !== P ? d(E) : y(b, E)) : d(E);
          }
          function O() {
            ...
            let b;
            for (let E = 0, v = arguments.length; E < v; ++E) b = w(b, arguments[E]);
            return b;
          }
          return o != null && o.all ? O : w;
        }
        ((t.exports = r),
          (t.exports.default = r),
          (t.exports.deepmerge = r),
          Object.defineProperty(t.exports, "isMergeableObject", { get: n }));
      })(fe)),
    fe.exports
  );
}
...
function go() {
  ...
  var t = new Error("Element already at target scroll position"),
    e = new Error("Scroll cancelled"),
    n = Math.min,
    r = Date.now;
  de = { left: o("scrollLeft"), top: o("scrollTop") };
  function o(a) {
    return function (f, m, l, u) {
      ...
      var p = r(),
        h = f[a],
        T = l.ease || i,
        S = isNaN(l.duration) ? 350 : +l.duration,
        d = !1;
      return (h === m ? u(t, f[a]) : requestAnimationFrame(w), y);
      function y() {
        d = !0;
      }
      function w(O) {
...
function wo() {
  return (
    Ue ||
      ...
      (function (t) {
        (function (e, n) {
          t.exports ? (t.exports = n()) : (e.Scrollparent = n());
        })(bo, function () {
          function e(r) {
...
const xn = ee(Eo),
  ...
  ze = ["start", "end"],
  We = To.reduce((t, e) => t.concat(e, e + "-" + ze[0], e + "-" + ze[1]), []),
  Rt = Math.min,
  Et = Math.max,
  Kt = Math.round,
  Wt = Math.floor,
  it = (t) => ({ x: t, y: t }),
  xo = { left: "right", right: "left", bottom: "top", top: "bottom" };
function be(t, e, n) {
  return Et(t, Rt(e, n));
}
function Pt(t, e) {
...
function Co(t, e, n, r) {
  ...
  return (o && ((i = i.map((s) => s + "-" + o)), e && (i = i.concat(i.map(Xt)))), i);
}
function Jt(t) {
  const e = ft(t);
...
function Rn(t) {
  return typeof t != "number" ? Po(t) : { top: t, right: t, bottom: t, left: t };
}
function Zt(t) {
...
function qe(t, e, n) {
  ...
  switch (c) {
    case "top":
      p = { x: m, y: r.y - o.height };
      break;
    case "bottom":
      p = { x: m, y: r.y + r.height };
      break;
    case "right":
      p = { x: r.x + r.width, y: l };
      break;
...
async function Ao(t, e) {
  ...
  const { x: r, y: o, platform: i, rects: s, elements: a, strategy: c } = t,
    ...
    h = Rn(p),
    S = a[u ? (l === "floating" ? "reference" : "floating") : l],
    d = Zt(
    ...
    O = (await (i.isElement == null ? void 0 : i.isElement(w)))
...
const ko = 50,
  Lo = async (t, e, n) => {
    const {
      ...
      a = s.detectOverflow ? s : { ...s, detectOverflow: Ao },
      c = await (s.isRTL == null ? void 0 : s.isRTL(e));
    let f = await s.getElementRects({ reference: t, floating: e, strategy: o }),
      { x: m, y: l } = qe(f, r, c),
      u = r,
      p = 0;
    const h = {};
    ...
    return { x: m, y: l, placement: u, strategy: o, middlewareData: h };
  },
  No = (t) => ({
    name: "arrow",
    options: t,
    async fn(e) {
      const { x: n, y: r, placement: o, rects: i, platform: s, elements: a, middlewareData: c } = e,
        { element: f, padding: m = 0 } = Pt(t, e) || {};
      if (f == null) return {};
      const l = Rn(m),
        u = { x: n, y: r },
        p = ve(o),
        h = Re(p),
        T = await s.getDimensions(f),
        S = p === "y",
        d = S ? "top" : "left",
        y = S ? "bottom" : "right",
        w = S ? "clientHeight" : "clientWidth",
        O = i.reference[h] + i.reference[p] - u[p] - i.floating[h],
        b = u[p] - i.reference[p],
        E = await (s.getOffsetParent == null ? void 0 : s.getOffsetParent(f));
      let v = E ? E[w] : 0;
      (!v || !(await (s.isElement == null ? void 0 : s.isElement(E)))) &&
      ...
      return {
        [p]: u[p] + D,
        data: { [p]: M, centerOffset: k - M - D, ...($ && { alignmentOffset: D }) },
        reset: $,
      };
    },
  });
function Io(t, e, n) {
  return (
    t
      ...
      : n.filter((o) => ft(o) === o)
  ).filter((o) => (t ? st(o) === t || (e ? Xt(o) !== o : !1) : !0));
}
const Do = function (t) {
    return (
      t === void 0 && (t = {}),
      {
        ...
        async fn(e) {
          var n, r, o;
          const { rects: i, middlewareData: s, placement: a, platform: c, elements: f } = e,
            {
              crossAxis: m = !1,
              alignment: l,
            ...
            T = l !== void 0 || u === We ? Io(l || null, p, u) : u,
            S = await c.detectOverflow(e, h),
            d = ((n = s.autoPlacement) == null ? void 0 : n.index) || 0,
            y = T[d];
          if (y == null) return {};
          const w = On(y, i, await (c.isRTL == null ? void 0 : c.isRTL(f.floating)));
          if (a !== y) return { reset: { placement: T[0] } };
          const O = [S[ft(y)], S[w[0]], S[w[1]]],
            b = [
              ...(((r = s.autoPlacement) == null ? void 0 : r.overflows) || []),
              { placement: y, overflows: O },
            ],
            E = T[d + 1];
          if (E) return { data: { index: d + 1, overflows: b }, reset: { placement: E } };
          const v = b
              .map((L) => {
                const C = st(L.placement);
                return [
                  L.placement,
                  C && m ? L.overflows.slice(0, 2).reduce((x, A) => x + A, 0) : L.overflows[0],
                  L.overflows,
                ];
              })
              .sort((L, C) => L[1] - C[1]),
            _ =
              ((o = v.filter((L) => L[2].slice(0, st(L[0]) ? 2 : 3).every((C) => C <= 0))[0]) ==
              null
                ? void 0
                : o[0]) || v[0][0];
          return _ !== a ? { data: { index: d + 1, overflows: b }, reset: { placement: _ } } : {};
        },
      }
    );
  },
      ...
      t === void 0 && (t = {}),
      {
        ...
        async fn(e) {
          ...
          const d = ft(o),
            y = ht(a),
            w = ft(a) === a,
            O = await (c.isRTL == null ? void 0 : c.isRTL(f.floating)),
            b = u || (w || !T ? [Jt(a)] : So(a)),
            E = h !== "none";
          !u && E && b.push(...Co(a, T, h, O));
          const v = [a, ...b],
            P = await c.detectOverflow(e, S),
            _ = [];
          ...
          if (((L = [...L, { placement: o, overflows: _ }]), !_.every((k) => k <= 0))) {
            var C, x;
            const k = (((C = i.flip) == null ? void 0 : C.index) || 0) + 1,
              M = v[k];
            if (
              M &&
              (!(l === "alignment" ? y !== ht(M) : !1) ||
                L.every((N) => (ht(N.placement) === y ? N.overflows[0] > 0 : !0)))
            )
              return { data: { index: k, overflows: L }, reset: { placement: M } };
            let $ =
...
async function Fo(t, e) {
  ...
  let {
    ...
    : { mainAxis: l.mainAxis || 0, crossAxis: l.crossAxis || 0, alignmentAxis: l.alignmentAxis };
  return (
    a && typeof h == "number" && (p = a === "end" ? h * -1 : h),
    c ? { x: p * m, y: u * f } : { x: u * f, y: p * m }
  );
}
const jo = function (t) {
    return (
    ...
    return (
      t === void 0 && (t = {}),
      {
        ...
        async fn(e) {
          ...
          const S = c.fn({ ...e, [p]: h, [u]: T });
          return { ...S, data: { x: S.x - n, y: S.y - r, enabled: { [p]: s, [u]: a } } };
        },
      }
    );
  };
...
function ct(t) {
  var e;
  return (e = (vn(t) ? t.ownerDocument : t.document) || window.document) == null
    ? void 0
    : e.documentElement;
}
function vn(t) {
  return re() ? t instanceof Node || t instanceof tt(t).Node : !1;
}
function nt(t) {
  return re() ? t instanceof Element || t instanceof tt(t).Element : !1;
}
function dt(t) {
  return re() ? t instanceof HTMLElement || t instanceof tt(t).HTMLElement : !1;
}
function Ye(t) {
  return !re() || typeof ShadowRoot > "u"
    ? !1
    : t instanceof ShadowRoot || t instanceof tt(t).ShadowRoot;
}
function Ht(t) {
...
function Pe() {
  return (
    pe == null &&
      (pe = typeof CSS < "u" && CSS.supports && CSS.supports("-webkit-backdrop-filter", "none")),
    pe
  );
}
function vt(t) {
...
function bt(t) {
  if (At(t) === "html") return t;
  const e = t.assignedSlot || t.parentNode || (Ye(t) && t.host) || ct(t);
  return Ye(e) ? e.host : e;
}
function Cn(t) {
  const e = bt(t);
  return vt(e) ? (t.ownerDocument ? t.ownerDocument.body : t.body) : dt(e) && Ht(e) ? e : Cn(e);
}
function _t(t, e, n) {
  var r;
  ...
  if (i) {
    const a = we(s);
    return e.concat(s, s.visualViewport || [], Ht(o) ? o : [], a && n ? _t(a) : []);
  } else return e.concat(o, _t(o, [], n));
}
function we(t) {
...
function Ot(t) {
  ...
  const n = e.getBoundingClientRect(),
    { width: r, height: o, $: i } = Pn(e);
  let s = (i ? Kt(n.width) : n.width) / r,
    a = (i ? Kt(n.height) : n.height) / o;
  return (
...
function Tt(t, e, n, r) {
  ...
  if (i) {
    ...
    for (; T && r && p !== h;) {
      const S = Ot(T),
        ...
        y = rt(T),
        w = d.left + (T.clientLeft + parseFloat(y.paddingLeft)) * S.x,
        O = d.top + (T.clientTop + parseFloat(y.paddingTop)) * S.y;
      ((c *= S.x),
        (f *= S.y),
        (m *= S.x),
        (l *= S.y),
  ...
  return Zt({ width: m, height: l, x: c, y: f });
}
function se(t, e) {
  const n = ie(t).scrollLeft;
  return e ? e.left + n : Tt(ct(t)).left + n;
}
function kn(t, e) {
  const n = t.getBoundingClientRect(),
    r = n.left + e.scrollLeft - se(t, n),
    o = n.top + e.scrollTop;
  return { x: r, y: o };
}
function Go(t) {
  ...
  if ((l || (!l && !i)) && ((At(r) !== "body" || Ht(s)) && (c = ie(r)), l)) {
    const p = Tt(r);
    ((f = Ot(r)), (m.x = p.x + r.clientLeft), (m.y = p.y + r.clientTop));
  }
...
function Yo(t) {
  const e = ct(t),
    ...
    i = Et(e.scrollHeight, e.clientHeight, r.scrollHeight, r.clientHeight);
  let s = -n.scrollLeft + se(t);
  const a = -n.scrollTop;
  return (
    rt(r).direction === "rtl" && (s += Et(e.clientWidth, r.clientWidth) - o),
...
function Ko(t, e) {
  ...
  if (o) {
    ...
    const m = Pe();
    (!m || (m && e === "fixed")) && ((a = o.offsetLeft), (c = o.offsetTop));
  }
  const f = se(r);
  if (f <= 0) {
    const m = r.ownerDocument,
      ...
      p =
        (m.compatMode === "CSS1Compat" && parseFloat(u.marginLeft) + parseFloat(u.marginRight)) ||
        0,
      h = Math.abs(r.clientWidth - l.clientWidth - p);
    h <= Ke && (i -= h);
  } else f <= Ke && (i += f);
  return { width: i, height: s, x: a, y: c };
}
function Xo(t, e) {
  const n = Tt(t, !0, e === "fixed"),
    r = n.top + t.clientTop,
    ...
    c = o * i.x,
    f = r * i.y;
  return { width: s, height: a, x: c, y: f };
}
function Xe(t, e, n) {
  let r;
  if (e === "viewport") r = Ko(t, n);
  else if (e === "document") r = Yo(ct(t));
  else if (nt(e)) r = Xo(e, n);
  else {
    const o = An(t);
...
function Ln(t, e) {
  const n = bt(t);
  return n === e || !nt(n) || vt(n) ? !1 : rt(n).position === "fixed" || Ln(n, e);
}
function Jo(t, e) {
  const n = e.get(t);
  if (n) return n;
  let r = _t(t, [], !1).filter((a) => nt(a) && At(a) !== "body"),
    o = null;
...
function Zo(t) {
  ...
  const s = [...(n === "clippingAncestors" ? (oe(e) ? [] : Jo(e, this._c)) : [].concat(n)), r],
    a = Xe(e, s[0], o);
  let c = a.top,
    f = a.right,
    m = a.bottom,
  ...
  for (let u = 1; u < s.length; u++) {
    const p = Xe(e, s[u], o);
    ((c = Et(p.top, c)), (f = Rt(p.right, f)), (m = Rt(p.bottom, m)), (l = Et(p.left, l)));
  }
  return { width: f - l, height: m - c, x: l, y: c };
}
function Qo(t) {
...
function ti(t, e, n) {
  ...
  if (r || (!r && !i))
    if (((At(e) !== "body" || Ht(o)) && (a = ie(e)), r)) {
      const p = Tt(e, !0, i, e);
      ((c.x = p.x + e.clientLeft), (c.y = p.y + e.clientTop));
    } else o && f();
  i && !r && o && f();
  const m = o && !r && !i ? kn(o, a) : it(0),
    l = s.left + a.scrollLeft - c.x - m.x,
    u = s.top + a.scrollTop - c.y - m.y;
  return { x: l, y: u, width: s.width, height: s.height };
}
function me(t) {
  return rt(t).position === "static";
}
function Je(t, e) {
  if (!dt(t) || rt(t).position === "fixed") return null;
  if (e) return e(t);
...
function Nn(t, e) {
  ...
  if (!dt(t)) {
    let o = bt(t);
    for (; o && !vt(o);) {
      if (nt(o) && !me(o)) return o;
      o = bt(o);
    }
    return n;
  }
  let r = Je(t, e);
  for (; r && $o(r) && me(r);) r = Je(r, e);
  return r && vt(r) && me(r) && !Ce(r) ? n : r || zo(t) || n;
}
...
function oi(t, e) {
  ...
  function s(a, c) {
    ...
    const f = t.getBoundingClientRect(),
      { left: m, top: l, width: u, height: p } = f;
    if ((a || e(), !u || !p)) return;
    const h = Wt(l),
      T = Wt(o.clientWidth - (m + u)),
      S = Wt(o.clientHeight - (l + p)),
      d = Wt(m),
      w = {
    ...
    function b(E) {
      ...
      (v === 1 && !In(f, t.getBoundingClientRect()) && s(), (O = !1));
    }
    try {
...
function Ze(t, e, n, r) {
  ...
  const {
    ...
    m = o || i ? [...(f ? _t(f) : []), ...(e ? _t(e) : [])] : [];
  m.forEach((d) => {
    (o && d.addEventListener("scroll", n, { passive: !0 }), i && d.addEventListener("resize", n));
  });
  ...
  function S() {
    const d = Tt(t);
    (T && !In(T, d) && n(), (T = d), (h = requestAnimationFrame(S)));
  }
  return (
    n(),
    () => {
...
const ii = jo,
  ...
  li = (t, e, n) => {
    const r = new Map(),
      o = { platform: ri, ...n },
      i = { ...o.platform, _c: r };
    return Lo(t, e, { ...o, platform: i });
  };
var ui = typeof document < "u",
  fi = function () {},
  Yt = ui ? g.useLayoutEffect : fi;
function Qt(t, e) {
  if (t === e) return !0;
  ...
  if (t && e && typeof t == "object") {
    if (Array.isArray(t)) {
      ...
      for (r = n; r-- !== 0;) if (!Qt(t[r], e[r])) return !1;
      return !0;
    }
    ...
    for (r = n; r-- !== 0;) {
      const i = o[r];
      if (!(i === "_owner" && t.$$typeof) && !Qt(t[i], e[i])) return !1;
    }
    return !0;
  }
  return t !== t && e !== e;
...
function en(t) {
  ...
  const [h, T] = g.useState(null),
    [S, d] = g.useState(null),
    y = g.useCallback((N) => {
      N !== E.current && ((E.current = N), T(N));
    }, []),
    w = g.useCallback((N) => {
      N !== v.current && ((v.current = N), d(N));
    }, []),
    O = i || h,
    b = s || S,
    E = g.useRef(null),
    ...
    A = g.useCallback(() => {
      ...
      const N = { placement: e, strategy: n, middleware: u };
      (C.current && (N.platform = C.current),
        li(E.current, v.current, N).then((U) => {
          const z = { ...U, isPositioned: x.current !== !1 };
          k.current &&
            !Qt(P.current, z) &&
            ((P.current = z),
            pn.flushSync(() => {
  ...
  Yt(() => {
    f === !1 &&
      ...
      ((P.current.isPositioned = !1), l((N) => ({ ...N, isPositioned: !1 })));
  }, [f]);
  const k = g.useRef(!1);
  (Yt(
    () => (
    ...
    Yt(() => {
      if ((O && (E.current = O), b && (v.current = b), O && b)) {
        if (L.current) return L.current(O, b, A);
        A();
      }
    }, [O, b, A, L, _]));
  const M = g.useMemo(
      () => ({ reference: E, floating: v, setReference: y, setFloating: w }),
      [y, w],
    ),
    $ = g.useMemo(() => ({ reference: O, floating: b }), [O, b]),
    D = g.useMemo(() => {
      ...
      return a
        ? {
            ...
            ...(Dn($.floating) >= 1.5 && { willChange: "transform" }),
          }
        : { position: n, left: U, top: z };
    }, [n, a, $.floating, m.x, m.y]);
  return g.useMemo(
    () => ({ ...m, update: A, refs: M, elements: $, floatingStyles: D }),
    [m, A, M, $, D],
  );
}
const di = (t) => {
    ...
    return {
      ...
      fn(n) {
        ...
        return r && e(r)
          ? r.current != null
            ? Qe({ element: r.current, padding: o }).fn(n)
            : {}
          : r
            ? Qe({ element: r, padding: o }).fn(n)
            : {};
      },
    };
  },
  ...
  wi = { isFixed: !1, locale: _n, placement: "bottom" },
  Ei = { continuous: !1, debug: !1, run: !1, scrollToFirstStep: !1, steps: [] },
  B = {
    INIT: "init",
    START: "start",
    STOP: "stop",
...
function St(...t) {
  return mo({ all: !0, isMergeableObject: (e) => !(!X.plainObject(e) || g.isValidElement(e)) })(
    ...t,
  );
}
function Mn(t) {
...
function lt(t, e = {}) {
  ...
  let i = ue(t);
  if (i)
    (i.includes("{current}") || i.includes("{total}")) &&
      r &&
      o &&
      (i = i.replace("{current}", r.toString()).replace("{total}", o.toString()));
  else if (g.isValidElement(t) && !Object.values(t.props).length && Mn(t.type) === "function")
    try {
      i = lt(t.type({}), e);
    } catch {
      i = ue(n);
...
function Y(t, e, n, ...r) {
  if (!t) return;
  const o = new Date(),
    i = `${String(o.getHours()).padStart(2, "0")}:${String(o.getMinutes()).padStart(2, "0")}:${String(o.getSeconds()).padStart(2, "0")}.${String(o.getMilliseconds()).padStart(3, "0")}`;
  console.log(`${e} %c${n}%c ${i}`, "font-weight: bold", "color: gray; font-weight: normal", ...r);
}
function Si(t, e) {
  const n = xi(e);
  return { ...t, ...n };
...
function te(t, ...e) {
  if (!X.plainObject(t)) throw new TypeError("Expected an object");
  const n = {};
  for (const r in t) ({}).hasOwnProperty.call(t, r) && !e.includes(r) && (n[r] = t[r]);
  return n;
}
function rn(t, ...e) {
  if (!X.plainObject(t)) throw new TypeError("Expected an object");
...
function Ee(t, e, n) {
  const r = (i) => i.replace("{current}", String(e)).replace("{total}", String(n));
  if (Mn(t) === "string") return r(t);
  if (!g.isValidElement(t)) return t;
  const { children: o } = t.props;
  if (X.string(o) && o.includes("{current}")) return g.cloneElement(t, { children: r(o) });
  if (Array.isArray(o))
...
function sn(t) {
  let e = 0,
    n = 0,
    r = t;
  for (; r;) ((e += r.offsetTop), (n += r.offsetLeft), (r = r.offsetParent));
  return { left: n, top: e };
}
function Le(t) {
...
function Ri(t = !1) {
  ...
  if (!e || !n) return 0;
  if (t) {
    const r = [e.scrollHeight, e.offsetHeight, n.clientHeight, n.scrollHeight, n.offsetHeight].sort(
        (i, s) => i - s,
      ),
...
function et(t) {
  ...
  if (typeof t == "object" && "current" in t) return t.current;
  if (typeof t == "string")
    try {
...
function vi(t, e, n) {
  const r = Le(t),
    o = kt(t),
    i = o ? !o.isSameNode(Z()) : !1,
    s = n ?? Lt(t);
  let a = 0,
    c = (r == null ? void 0 : r.top) ?? 0;
  return (
    i && s
      ? (c = (r == null ? void 0 : r.top) ?? 0)
      : o instanceof HTMLElement &&
        ((a = o.scrollTop), !i && !s && (c += a), o.isSameNode(Z()) || (c += Z().scrollTop)),
    Math.floor(c - e)
  );
}
function kt(t, e) {
  ...
  const n = xn(t);
  if (n) {
    if (n.isSameNode(Z())) return e ? document : Z();
    if (!(n.scrollHeight > n.offsetHeight)) return Z();
  }
  return n;
}
function Ci(t) {
...
function Pi(t, e) {
  if (!t) return 0;
  const n = xn(t) ?? Z(),
    r = parseFloat(getComputedStyle(t).scrollMarginTop) || 0,
    o = Le(n),
    i = n.scrollTop ?? 0,
    { offsetTop: s = 0, scrollTop: a = 0 } = n;
  let c = t.getBoundingClientRect().top + a;
  if (s && (Fn(t) || Ai(t))) {
    const m = t.getBoundingClientRect(),
      l = m.top - ((o == null ? void 0 : o.top) ?? 0),
      u = l + m.height,
      p = n.clientHeight,
      h = p * 0.2;
    l >= h && u <= p - h ? (c = i) : (c = l + i);
...
function cn(t) {
  const { isFirstStep: e, scrollToFirstStep: n, step: r, target: o, targetLifecycle: i } = t;
  if (r.skipScroll || (e && !n && i !== R.TOOLTIP) || r.placement === "center") return !1;
  const s = o != null && o.isConnected ? kt(o) : Z(),
    a = s ? !s.isSameNode(Z()) : !1;
  return (r.isFixed || Lt(o)) && !a ? !1 : s.scrollHeight > s.clientHeight;
}
function Z() {
  return document.scrollingElement ?? document.documentElement;
}
function an(t, e) {
  ...
  const i = new Promise((s) => {
    const { scrollTop: a } = r,
      c = t > a ? t - a : a - t;
    o = yo.top(r, t, { duration: c < 100 ? 50 : n }, () => {
      s();
    });
  });
  return { cancel: o, promise: i };
}
function ki(t) {
  const e = t.replace(/^#?([\da-f])([\da-f])([\da-f])$/i, (r, o, i, s) => o + o + i + i + s + s),
    n = /^#?([\da-f]{2})([\da-f]{2})([\da-f]{2})/i.exec(e);
...
const jn = {
  ...
  Gt = { ...jn, borderRadius: 4, padding: 8 };
function Li(t, e) {
  const { styles: n } = t,
    r = St(n ?? {}, e.styles ?? {});
  let { width: o } = e;
  ke() && (o = typeof o == "number" && window.innerWidth < o ? window.innerWidth - 30 : o);
  const i = {
    bottom: 0,
    left: 0,
    overflow: "hidden",
  ...
  return St(
    {
      ...
      beaconWrapper: { ...jn, display: "inline-flex", borderRadius: "50%", position: "relative" },
      beacon: { height: e.beaconSize, width: e.beaconSize },
      beaconInner: {
      ...
      buttonBack: { ...Gt, color: e.primaryColor, marginLeft: "auto", marginRight: 5 },
      buttonClose: {
        ...Gt,
        color: e.textColor,
        height: 12,
      ...
      buttonPrimary: { ...Gt, backgroundColor: e.primaryColor, color: e.backgroundColor },
      buttonSkip: { ...Gt, color: e.textColor, fontSize: 14 },
      floater: {
      ...
      overlay: { ...i, backgroundColor: e.overlayColor },
      spotlight: {},
      tooltip: {
      ...
      tooltipContent: { paddingBottom: 12, paddingTop: 12 },
      tooltipFooter: { alignItems: "center", display: "flex", justifyContent: "flex-end" },
...
function Ne(t, e) {
  ...
  const n = St(
    ...
    r = St(yi, t.options ?? {}, rn(e, ...Ni)),
    o = Li(t, { ...n, ...r }),
    i = St(bi, t.floatingOptions ?? {}, n.floatingOptions ?? {});
  return {
    ...n,
    ...r,
...
function Di(t, e, n) {
  const { action: r } = e,
    o = n && [B.PREV, B.NEXT].includes(r);
  return t.skipBeacon || t.placement === "center" || o;
}
function Bn(t, e = !1) {
  return X.plainObject(t)
    ? t.target
      ? !0
      : (Y(e, "tour", "target is missing from the step"), !1)
    : (Y(e, "tour", "step must be an object"), !1);
}
function $n(t, e = !1) {
  return X.array(t) ? t.every((n) => Bn(n, e)) : (Y(e, "tour", "steps must be an array"), !1);
}
var _i = class {
  constructor(t) {
    ...
    G(this, "cleanupPositionData", () => {
      ((this.beaconPosition = null), (this.tooltipPosition = null));
    });
    ...
    G(this, "setPositionData", (t, e) => {
      var r, o, i;
      (((r = t === "beacon" ? this.beaconPosition : this.tooltipPosition) == null
        ? void 0
        : r.placement) !== e.placement &&
        Y(this.debug, `step:${this.state.index}`, "positioned", `${t} ${e.placement}`),
        t === "beacon" ? (this.beaconPosition = e) : (this.tooltipPosition = e),
        (this.state.lifecycle === R.BEACON_BEFORE || this.state.lifecycle === R.TOOLTIP_BEFORE) &&
          !this.state.positioned &&
          this.updateState({ positioned: !0 }));
      const n =
        (i = (o = this.getStep()) == null ? void 0 : o.floatingOptions) == null
          ? void 0
          : i.onPosition;
      n && n(e);
    });
    G(this, "setSteps", (t) => {
      ((this.steps = t), this.updateState({ size: t.length }));
    });
    G(this, "dispatch", (t, e) => {
    ...
    G(this, "updateState", (t, e = !1) => {
      const { controlled: n, index: r } = this.state,
        o = this.snapshot,
        i = n && !e && t.index !== void 0 ? r : (t.index ?? r),
        s = {
        ...
        a = this.applyTransitions(s);
      if (((this.state = a), !Te(o, a))) {
        this.snapshot = Object.freeze({ ...a });
        for (const c of this.listeners) c(this.snapshot);
      }
    });
    const { initialStepIndex: e, stepIndex: n, steps: r = [] } = t ?? {},
      o = X.number(n);
    let i = 0;
    ((this.debug = (t == null ? void 0 : t.debug) ?? !1),
      o
        ? ((i = n),
          X.number(e) && Y(this.debug, "tour", "initialStepIndex is ignored in controlled mode"))
        : X.number(e) &&
          (e >= 0 && e < r.length
            ? (i = e)
            : r.length > 0 && Y(this.debug, "tour", "initialStepIndex is out of bounds")),
      (this.props = t ?? { steps: [] }),
      (this.steps = r),
      (this.state = {
        action: B.INIT,
  ...
  applyTransitions(t) {
    return t.status === F.WAITING && t.size > 0 ? { ...t, status: F.RUNNING } : t;
  }
  getStep(t) {
  ...
  return (
    ...
    g.useMemo(() => {
      ...
      return {
        ...
        stop: (d = !1) => {
          const { index: y, status: w } = i();
          [F.FINISHED, F.SKIPPED].includes(w) ||
            t.current.updateState({
              action: B.STOP,
              index: y + (d ? 1 : 0),
              lifecycle: R.COMPLETE,
...
function Bi(t, e) {
  ...
  g.useEffect(() => {
    ...
    return (
      Y(!0, "tour", "init", r),
      (n.current = r),
      t.current.subscribe((o) => {
        const i = n.current;
        if (((n.current = o), !i)) return;
        const s = {};
        let a = !1;
        for (const c of Object.keys(o))
          o[c] !== i[c] &&
            !ji.has(c) &&
            ((s[c] = { from: i[c], to: o[c] }), (c === "status" || c === "size") && (a = !0));
        Object.keys(s).length &&
          ((!a && o.index >= o.size) || Y(!0, a ? "tour" : `step:${o.index}`, "state", s));
      })
    );
  }, [e, t]);
}
  ...
  return (
    ...
    g.useCallback(
      (i, s, a) => {
        ...
        ((f = r.current) == null || f.call(r, c, o.current), n.current.dispatch(c, o.current));
      },
      [n],
    )
  );
...
function gt(t, e) {
  return {
    ...
    hasChangedTo(n, r) {
      const o = t[n],
        i = e[n];
      return Array.isArray(r) ? r.includes(o) && !r.includes(i) : o === r && i !== r;
    },
    previous: e,
  };
}
function Hi(t) {
  const {
    ...
    { action: f, index: m, lifecycle: l, positioned: u, scrolling: p, size: h, status: T } = s,
    S = hn(a) ?? null,
    d = g.useRef(null),
    y = g.useRef(i),
    w = g.useRef(s),
  ...
  (g.useEffect(() => {
    ...
    const { hasChangedTo: x } = gt(w.current, O.current),
      A = x("action", [B.NEXT, B.PREV, B.SKIP, B.CLOSE, B.REPLAY]),
      k = f === B.START && (d.current === B.CLOSE || d.current === B.REPLAY);
    (A || k) && (d.current = f);
  }, [f]),
    g.useEffect(() => {
      if (!O.current)
      ...
      const { hasChanged: x } = gt(w.current, O.current),
        A = b.current;
      if ((x("index") && C(), T !== F.RUNNING || !A || l !== R.INIT))
        return () => {
          C();
        };
      ...
      if (A.before && !L.current) {
        (Y(M, `step:${m}`, "before()", A),
          (L.current = { cancel: () => {} }),
          c.current.updateState({ waiting: !0 }),
          r(q.STEP_BEFORE_HOOK, A, { action: d.current ?? w.current.action }));
        const $ = () => {
            ((L.current = null),
        ...
        const U = N
          ? setTimeout(() => {
              D.signal.aborted ||
                ...
                D.abort(),
                e(A, "before_hook"),
                r(q.ERROR, A, { error: new Error("Step before hook timed out") }),
                $());
            }, N)
          : null;
        A.before({
          ...
          .then(() => {
            D.signal.aborted || (U && clearTimeout(U), $());
          })
          .catch((z) => {
            D.signal.aborted ||
              (U && clearTimeout(U),
              e(A, "before_hook"),
              r(q.ERROR, A, { error: z instanceof Error ? z : new Error(String(z)) }),
              $());
          });
      } else if (!L.current) {
        P.current && _.current !== A.target && C();
        const $ = et(A.target);
        if ($ && Vt($))
          (C(),
            c.current.updateState({
          ...
          c.current.updateState({ action: d.current ?? B.UPDATE, lifecycle: R.READY, waiting: !1 });
        else if (!P.current) {
          ...
          ((_.current = A.target),
            ...
            (P.current = setInterval(() => {
              const U = et(A.target),
                ...
                at = z >= D;
              ((U && Vt(U)) || at) &&
                (Y(M, `step:${m}`, "polling", U && Vt(U) ? "found" : "timed out", `${z}ms`),
                C(),
                c.current.updateState({
                  action: d.current ?? B.UPDATE,
                  lifecycle: R.READY,
    ...
    g.useEffect(() => {
      if (!O.current) return;
      const { hasChanged: x, hasChangedTo: A, previous: k } = gt(w.current, O.current),
        M = b.current;
      if (!M) return;
      const $ = et(M.target),
        D = !!$;
      if (D && Vt($)) {
        if (
          (A("lifecycle", R.READY) &&
            k.lifecycle === R.INIT &&
            r(q.STEP_BEFORE, M, { action: d.current ?? w.current.action }),
          A("lifecycle", R.READY))
        ) {
          const N = w.current,
            U = Di(M, N, y.current.continuous) ? R.TOOLTIP : R.BEACON,
            z = et(M.scrollTarget ?? M.spotlightTarget ?? M.target),
            at = cn({
            ...
            Ut = U === R.TOOLTIP ? R.TOOLTIP_BEFORE : R.BEACON_BEFORE;
          (Y(y.current.debug, `step:${m}`, "scroll", at ? "needed" : "skipped"),
            c.current.updateState({ action: B.UPDATE, lifecycle: Ut, scrolling: at }));
        }
      } else if (
        ...
        (Y(y.current.debug, `step:${m}`, D ? "Target not visible" : "Target not mounted", M),
    ...
    g.useEffect(() => {
      ...
      if (k && x("lifecycle", R.TOOLTIP_BEFORE) && A.lifecycle === R.BEACON) {
        ...
        if (
          ...
          c.current.updateState({ scrolling: !0, positioned: !1 });
          return;
        }
      }
      ...
      if (k && $ && !p) {
        ...
        c.current.updateState({ action: B.UPDATE, lifecycle: N });
      }
      (k && x("lifecycle", R.BEACON) && r(q.BEACON, k),
        k && x("lifecycle", R.TOOLTIP) && r(q.TOOLTIP, k));
      const D = w.current;
      if (
        (D.status === F.RUNNING || (D.controlled && D.status === F.PAUSED && k)) &&
        M &&
    ...
    g.useEffect(() => {
      ...
      if (x("action", B.REPLAY) && x("lifecycle", R.COMPLETE)) {
        c.current.updateState({ lifecycle: R.INIT });
        return;
      }
      (h &&
        !k &&
        l === R.INIT &&
        c.current.updateState({ action: B.UPDATE, lifecycle: R.COMPLETE, status: F.FINISHED }),
        !w.current.controlled &&
          T === F.RUNNING &&
          x("lifecycle", R.COMPLETE) &&
          m < h &&
          c.current.updateState({ action: B.UPDATE, lifecycle: R.INIT }),
        x("lifecycle", R.COMPLETE) &&
          m >= h &&
          c.current.updateState({ action: B.UPDATE, lifecycle: R.COMPLETE, status: F.FINISHED }));
      ...
      if ($ && x("status", [F.FINISHED, F.SKIPPED])) {
        let D;
        (k ? (D = m) : M ? (D = A.index ?? m) : (D = m - 1),
          r(q.TOUR_END, $, { index: D }),
          w.current.controlled || v.current.reset(),
          (d.current = null));
      }
      (k && x("action", B.STOP) && ((d.current = null), r(q.TOUR_STATUS, k)),
        k && x("action", B.RESET) && (r(q.TOUR_STATUS, k), (d.current = null)));
    }, [f, r, m, l, h, T, c]));
}
        ...
        (Te(p.steps, f) ||
          ($n(f, i)
            ...
            : (Y(i, "tour", "Steps are not valid", f),
              e(q.ERROR, f[0] ?? { target: "", content: "" }, {
                error: new Error("Steps are not valid"),
              }))),
        h("run"))
      )
        a ? o.current.getState().size && u.current.start(c ?? s) : u.current.stop();
      else if (X.number(c) && h("stepIndex")) {
        const T = X.number(p.stepIndex) && p.stepIndex < c ? B.NEXT : B.PREV;
        [F.FINISHED, F.SKIPPED].includes(l.current.status) ||
          o.current.updateState({ action: T, index: c, lifecycle: R.INIT, positioned: !1 }, !0);
      }
    }, [i, e, s, n, a, c, f, o]));
}
function zi(t, e) {
  ...
  if (i.scrollTarget || i.spotlightTarget) return Math.max(0, t);
  let s = t - i.spotlightPadding.top;
  if (r === R.BEACON_BEFORE && n != null && n.placement) {
    const l = Wi(n);
    ["bottom"].includes(n.placement) || (s += Math.floor(l - o));
    ...
    if (l === "top") {
      const u =
        ...
        p = (c = i.floatingOptions) != null && c.hideArrow ? 0 : i.arrowSize,
        h = i.offset + i.spotlightPadding.top + p;
      s -= u + h;
      ...
      const u =
        ...
        p = ((m = et(i.target)) == null ? void 0 : m.getBoundingClientRect().height) ?? 0,
        h = o + i.spotlightPadding.top + p / 2 - u / 2;
      h < o && (s -= o - h);
    }
  }
  return Math.max(0, s);
...
function Wi(t) {
  var n;
  const e = (n = t.middlewareData) == null ? void 0 : n.offset;
  return e ? (["left", "right"].some((r) => t.placement.startsWith(r)) ? e.x : e.y) : 0;
}
function Vi({ emitEvent: t, previousState: e, props: n, state: r, step: o, store: i }) {
  ...
  ((u.current = r),
    ...
    g.useEffect(() => {
      ...
      const { hasChangedTo: S } = gt(u.current, p.current),
        ...
        { debug: y } = h.current,
        { scrollDuration: w } = d,
        O = a === R.BEACON_BEFORE || a === R.TOOLTIP_BEFORE;
      if (m === F.RUNNING && O && f && S("positioned", !0)) {
        const E = et(d.scrollTarget ?? d.spotlightTarget ?? d.target),
          v = i.current.getPositionData("beacon"),
          P = kt(E),
          _ = P ? !P.isSameNode(Z()) : !1;
        ((b = l.current) == null || b.call(l),
          (async () => {
            if (_ && !Lt(P)) {
              const D = Z(),
                N = Ci(P),
                U = { initial: D.scrollTop, target: N, element: D, duration: w };
              t(q.SCROLL_START, d, { scroll: U });
              const { cancel: z, promise: at } = an(N, { element: D, duration: w });
              ((l.current = z), await at, t(q.SCROLL_END, d, { scroll: U }));
            }
            const C = Math.floor(Pi(E, d.scrollOffset)) || 0,
              x = _
                ? C
                : zi(C, { beaconPosition: v, lifecycle: a, scrollOffset: d.scrollOffset, step: d });
            Y(y, `step:${s}`, "scroll", _ ? "custom" : "document", `${C} → ${x}`);
            const A = P,
              k = { initial: A.scrollTop, target: x, element: A, duration: w };
            t(q.SCROLL_START, d, { scroll: k });
            const { cancel: M, promise: $ } = an(x, { element: A, duration: w });
            ((l.current = M),
              await $,
              t(q.SCROLL_END, d, { scroll: k }),
              i.current.updateState({ scrolling: !1 }));
          })().catch(() => {
            i.current.updateState({ scrolling: !1 });
          }));
      }
...
function Gi(t) {
  const e = Pr(() => Si(Ei, t), [t]),
    { debug: n, initialStepIndex: r, onEvent: o, run: i, stepIndex: s, steps: a } = e,
    c = g.useRef(Mi(e)),
    f = Lr.useSyncExternalStore(
      c.current.subscribe,
  ...
  const h = Fi(c, n, p),
    T = $i(o, h, c),
    { index: S, size: d, status: y } = f,
    w = hn(f),
    O = g.useMemo(() => Ne(e, a[S]), [S, e, a]);
  return (
    Ar(() => {
      i && d && $n(a, n) && h.start(s ?? r);
    }),
    Cr(() => {
      i && d && y === F.IDLE && c.current.updateState({ status: F.READY });
    }, [i, d, y]),
    Ui({ controls: h, emitEvent: T, props: e, state: f, store: c }),
    Hi({
      addFailure: u,
      controls: h,
      emitEvent: T,
    ...
    Vi({ emitEvent: T, previousState: w, props: e, state: f, step: O, store: c }),
    { controls: h, failures: m, mergedProps: e, state: f, step: O, store: c }
  );
}
function qi(t) {
  ...
  return (
    g.useEffect(() => {
      ...
      if (t)
        ...
        ((i.id = Ti), document.body.appendChild(i), (r = i));
      }
      return (
        n(r),
        () => {
          !r || o || (r.parentNode === document.body && document.body.removeChild(r));
        }
      );
    }, [t]),
    e
...
function Ki({ nonce: t, step: e }) {
  ...
  if (
    (g.useEffect(() => {
      if (r || document.getElementById("joyride-loader-animation")) return Mt;
  ...
  if (n) {
    const c = n;
    a = I.createElement(c, { step: e });
  } else
    a = I.createElement("div", {
      style: { ...Yi, height: o, width: i, borderTopColor: e.primaryColor },
    });
  return I.createElement(
    "div",
    { className: "react-joyride__loader", "data-testid": "loader", style: s },
    a,
  );
}
const Xi = { height: 0, isFixed: !1, left: 0, top: 0, width: 0 };
function It(t, e) {
  const n = et(t);
  if (!n) return Xi;
  const r = Le(n),
    ...
    i = vi(n, e.top, o);
  return {
    height: Math.round(((r == null ? void 0 : r.height) ?? 0) + e.top + e.bottom),
    isFixed: o,
    left: Math.round(((r == null ? void 0 : r.left) ?? 0) - e.left),
    top: i,
    width: Math.round(((r == null ? void 0 : r.width) ?? 0) + e.left + e.right),
  };
}
function Ji(t, e, n) {
  ...
  (g.useEffect(() => {
    ...
    const u = (h) => {
        ((s.current = kt(h, !0)),
          s.current && s.current.addEventListener("scroll", f, { passive: !0 }),
          window.addEventListener("scroll", f, { passive: !0 }),
          window.addEventListener("resize", f),
          typeof ResizeObserver < "u" &&
            ((c.current = new ResizeObserver(f)), c.current.observe(h)),
          o(It(t, e)));
      },
      p = et(t);
    return (
      p
        ...
        : ((l = new MutationObserver(() => {
            const h = et(t);
            h && (l == null || l.disconnect(), (l = null), u(h));
          })),
          l.observe(document.body, { childList: !0, subtree: !0 })),
      () => {
        var h;
        (l == null || l.disconnect(),
          s.current && s.current.removeEventListener("scroll", f),
          window.removeEventListener("scroll", f),
          window.removeEventListener("resize", f),
          (h = c.current) == null || h.disconnect(),
          clearTimeout(i.current));
      }
    );
  }, [t, e, f]),
    g.useEffect(() => {
      (a.current && !n && o(It(t, e)), (a.current = n));
    }, [n, t, e]));
  let m = r;
  return (a.current && !n && (m = It(t, e)), m);
}
function Zi(t, e, n) {
...
function ts(t) {
  ...
  const {
    ...
    d = Ji(u ?? h, m, f || T),
    y = g.useRef(null),
    w = (o === R.TOOLTIP || o === R.TOOLTIP_BEFORE) && a !== "center",
    [O, b] = g.useState(!1),
    E = c ? (($ = y.current) == null ? void 0 : $.offsetParent) : null,
    v = (E == null ? void 0 : E.clientWidth) ?? S.width,
    P = (E == null ? void 0 : E.clientHeight) ?? Ri() ?? S.height,
    _ = ((D = p.overlay) == null ? void 0 : D.backgroundColor) ?? "rgba(0, 0, 0, 0.5)",
    L = g.useMemo(() => {
      const { backgroundColor: N, mixBlendMode: U, ...z } = p.overlay;
      return { height: P, pointerEvents: "none", ...z };
    }, [P, p.overlay]),
    C = w && !f && !T;
  g.useEffect(() => {
    C ? requestAnimationFrame(() => b(!0)) : b(!1);
  }, [C]);
  const x = n && Qi.includes(o),
    A = !n && o !== R.TOOLTIP;
  if (r || (!T && (x || A))) return null;
  let k = "";
  if (C)
    if (c && E) {
      const N = et(u ?? h);
    ...
    } else k = un(d.left, d.top, d.width, d.height, l);
  const M = Zi(v, P, k);
  return I.createElement(
    "div",
    {
    ...
    I.createElement(
      "svg",
      {
        ...
        style: { height: P, left: 0, position: d.isFixed ? "fixed" : "absolute", top: 0, width: v },
      },
      I.createElement("path", {
        ...
        fillRule: "evenodd",
        onClick: i,
        style: { cursor: s ? "pointer" : "default", pointerEvents: "auto" },
      }),
      k &&
        I.createElement("path", {
          d: k,
...
function Hn(t) {
  ...
  return n ? pn.createPortal(e, n) : null;
}
const es =
...
function rs(t, e, n) {
  ...
  switch (r) {
    case "top":
      return { points: `0,0 ${e / 2},${n} ${e},0`, ...ut(t, e, n) };
    case "bottom":
      return { points: `${e},${n} ${e / 2},0 0,${n}`, ...ut(t, e, n) };
    case "left":
      return { points: `0,0 ${n},${e / 2} 0,${e}`, ...ut(t, e, n) };
    case "right":
      return { points: `${n},${e} ${n},0 0,${e / 2}`, ...ut(t, e, n) };
    default:
      return null;
  }
}
function os(t, e, n, r) {
  ...
  switch (o) {
    case "top":
      return { bottom: -n, left: e.x ?? 0, ...ut(t, r, n) };
    case "bottom":
      return { top: -n, left: e.x ?? 0, ...ut(t, r, n) };
    case "left":
      return { right: -n, top: e.y ?? 0, ...ut(t, r, n) };
    case "right":
      return { left: -n, top: e.y ?? 0, ...ut(t, r, n) };
    default:
      return {};
  }
}
function is({
  ...
  let c = null;
  if (a) {
    if (!ut(r, n, i)) return null;
    c = I.createElement(
      "span",
      { style: { flexShrink: 0 } },
      I.createElement(a, { base: n, placement: r, size: i }),
    );
  } else {
    const f = rs(r, n, i);
    if (!f) return null;
    c = I.createElement(
      "svg",
      { height: f.height, width: f.width, xmlns: "http://www.w3.org/2000/svg" },
      I.createElement("polygon", { fill: "currentColor", points: f.points }),
    );
  }
  return I.createElement(
    "span",
    {
      ...
      "data-testid": "arrow",
      style: { ...s, ...os(r, o, i, n), ...(o ? {} : { visibility: "hidden" }) },
    },
    c,
  );
}
function ss(t) {
  const {
    ...
    p = !!e;
  g.useEffect(() => {
    if (p || document.getElementById("joyride-beacon-animation")) return Mt;
    ...
    const d = setTimeout(() => {
      X.domElement(u.current) && c && u.current.focus();
    }, 0);
    return () => {
      clearTimeout(d);
  ...
  if (e) {
    const S = e;
    T = I.createElement(S, { continuous: n, index: r, isLastStep: o, size: f, step: m });
  } else
    T = I.createElement(
      "span",
      { style: l.beacon },
      I.createElement("span", { style: l.beaconOuter }),
      I.createElement("span", { style: l.beaconInner }),
    );
  return I.createElement(
    "button",
    {
...
function as(t) {
  const {
    ...
    { buttons: f, content: m, styles: l, title: u } = a,
    p = {};
  (f.includes("primary") &&
    ...
    (p.close =
      f.includes("close") &&
      I.createElement(cs, { "data-testid": "button-close", styles: l.buttonClose, ...n })));
  const h = u
    ? { "aria-labelledby": "joyride-tooltip-title", "aria-describedby": "joyride-tooltip-content" }
    : { "aria-label": lt(m), "aria-describedby": "joyride-tooltip-content" };
  return I.createElement(
    "div",
    {
      key: "JoyrideTooltip",
    ...
    I.createElement(
      ...
      u && I.createElement("h4", { id: "joyride-tooltip-title", style: l.tooltipTitle }, u),
      I.createElement("div", { id: "joyride-tooltip-content", style: l.tooltipContent }, m),
    ),
    f.some((T) => T === "back" || T === "primary" || T === "skip") &&
      I.createElement(
        "div",
        { style: l.tooltipFooter },
        I.createElement("div", { style: l.tooltipFooterSpacer }, p.skip),
        p.back,
        p.primary,
      ),
    p.close,
...
function ls(t) {
  const { continuous: e, controls: n, index: r, isLastStep: o, size: i, step: s } = t,
    a = (d) => {
      (d.preventDefault(), n.prev(Q.BUTTON_BACK));
    },
    c = (d) => {
      (d.preventDefault(),
        s.closeButtonAction === "skip"
          ? n.skip(Q.BUTTON_CLOSE)
          : s.closeButtonAction === "replay"
    ...
    m = (d) => {
      (d.preventDefault(), n.skip(Q.BUTTON_SKIP));
    },
    l = () => {
      const { back: d, close: y, last: w, next: O, nextWithProgress: b, skip: E } = s.locale,
        v = lt(d),
        P = lt(y),
        _ = lt(w),
        L = lt(O),
      ...
      let x = y,
        A = P;
      if (e) {
        if (((x = O), (A = L), s.showProgress && !o)) {
          const k = lt(b, { step: r + 1, steps: i });
          ((x = Ee(b, r + 1, i)), (A = k));
        }
        o && ((x = w), (A = _));
      }
      return {
        ...
        tooltipProps: { "aria-modal": !0, role: "alertdialog" },
      };
    },
    { arrowComponent: u, beaconComponent: p, tooltipComponent: h, ...T } = s;
  let S;
  if (h) {
    const d = h;
    S = I.createElement(d, {
...
function us(t) {
  if (t.startsWith("left")) return ["top", "bottom"];
  if (t.startsWith("right")) return ["bottom", "top"];
}
function fs(t, e, n) {
  var r, o;
  return t
    ? [gi()]
    : ((r = e.floatingOptions) == null ? void 0 : r.flipOptions) === !1
      ? []
      : [
          mi({
            crossAxis: !1,
            ...
            padding: 20,
            ...((o = e.floatingOptions) == null ? void 0 : o.flipOptions),
          }),
        ];
}
function ds(t) {
  ...
  const {
    ...
    b = g.useMemo(() => (Fn(p) ? kt(p) : void 0), [p]),
    E = g.useMemo(() => Lt(p), [p]),
    v = g.useMemo(() => (b ? { boundary: b, rootBoundary: "viewport" } : {}), [b]),
    P = y || w ? "bottom" : u.placement,
    _ = y
      ? "fixed"
      : (((U = u.floatingOptions) == null ? void 0 : U.strategy) ??
        ...
        : [
            nn(
              ({ placement: xt }) => {
                ...
                xt.startsWith("top")
                  ? (zt = "top")
                  : xt.startsWith("bottom")
                    ? (zt = "bottom")
                    : xt.startsWith("left") && (zt = "left");
                const Yn = u.spotlightTarget ? 0 : u.spotlightPadding[zt];
                return (
                  u.offset +
                  Yn +
                  ((_e = u.floatingOptions) != null && _e.hideArrow ? 0 : u.arrowSize)
                );
              },
              [
                u.offset,
                ...
                u.spotlightTarget,
                u.arrowSize,
                (K = u.floatingOptions) == null ? void 0 : K.hideArrow,
              ],
            ),
            ...fs(w, u, P),
            pi({
              padding: 10,
              ...v,
              ...((pt = u.floatingOptions) == null ? void 0 : pt.shiftOptions),
            }),
            ...((Nt = u.floatingOptions) != null && Nt.hideArrow
              ? []
              : [hi({ element: T, padding: u.arrowSpacing }, [u.arrowSpacing, u.arrowBase])]),
            ...(((De = u.floatingOptions) == null ? void 0 : De.middleware) ?? []),
          ];
    }, [y, u, w, P, v]),
    C = en({
      ...(y ? { elements: { reference: O } } : {}),
      placement: P,
      strategy: _,
      middleware: L,
    }),
    x = en({
      ...
      middleware: g.useMemo(() => {
        ...
        return [
          nn(
            ((pt = (K = u.floatingOptions) == null ? void 0 : K.beaconOptions) == null
              ? void 0
              : pt.offset) ?? -18,
          ),
        ];
      }, [
        (at = (z = u.floatingOptions) == null ? void 0 : z.beaconOptions) == null
          ? void 0
          : at.offset,
      ]),
  ...
  ((d.current = C.middlewareData),
    ...
    g.useEffect(() => {
      ...
      if (!(!pt || !K || o !== R.TOOLTIP))
        return Ze(pt, K, C.update, (Nt = u.floatingOptions) == null ? void 0 : Nt.autoUpdate);
    }, [
      o,
      C.update,
      (Ut = u.floatingOptions) == null ? void 0 : Ut.autoUpdate,
      u.target,
      C.elements,
    ]),
    g.useEffect(() => {
      (!y && p && C.refs.setReference(p), p && x.refs.setReference(p));
    }, [x.refs, y, p, C.refs]),
    g.useEffect(() => {
      C.isPositioned &&
        c("tooltip", {
  ...
  const A = u.zIndex + 1,
    k = g.useCallback(
      (K) => {
        (K.type === "mouseenter" && u.beaconTrigger !== "hover") ||
          h({ lifecycle: R.TOOLTIP_BEFORE, positioned: !1 });
      },
      [u.beaconTrigger, h],
    ),
    M = g.useCallback(
      (K) => {
        K && (C.refs.setFloating(K), f(K));
      },
      [C.refs, f],
    ),
    { arrow: $, floater: D } = u.styles;
  let N = null;
    ...
    (o === R.BEACON || o === R.BEACON_BEFORE) &&
      (N = I.createElement(
        "div",
        {
          ...
          style: on({ ...x.floatingStyles, zIndex: A }),
        },
        I.createElement(ss, {
  ...
  return I.createElement(Hn, { element: a }, N);
}
function ps(t) {
  const {
      continuous: e,
...
function ms({ controls: t, mergedProps: e, state: n, step: r, store: o }) {
  const { continuous: i, debug: s, nonce: a, portalElement: c, scrollToFirstStep: f } = e,
    m = qi(c),
    { index: l, lifecycle: u, status: p } = n,
    h = p === F.RUNNING,
    [T, S] = g.useState(!1),
    d = g.useRef(null),
    y = (r == null ? void 0 : r.loaderDelay) ?? 0;
  (g.useEffect(
    () => (
      n.waiting
        ? y === 0
    ...
    g.useEffect(() => {
      ...
      const b = (E) => {
        !r ||
          ...
          (E.key === "Escape" &&
            r.dismissKeyAction &&
            (r.dismissKeyAction === "next"
              ? t.next(Q.KEYBOARD)
              : r.dismissKeyAction === "replay"
                ? t.replay(Q.KEYBOARD)
                : t.close(Q.KEYBOARD)));
      };
      return (
        document.body.addEventListener("keydown", b, { passive: !0 }),
        () => {
  ...
  const w = g.useCallback(() => {
    switch (r == null ? void 0 : r.overlayClickAction) {
      case "close":
        t.close(Q.OVERLAY);
        break;
      case "next":
  ...
  }, [t, r == null ? void 0 : r.overlayClickAction]);
  if (!r || !h) return null;
  ...
  return I.createElement(
    ...
    I.createElement(
      ...
      I.createElement(
        I.Fragment,
        null,
        T && I.createElement(Ki, { nonce: a, step: r }),
        !O &&
          I.createElement(ts, {
            ...r,
            continuous: i,
...
function gs(t) {
  const { controls: e, failures: n, mergedProps: r, state: o, step: i, store: s } = Gi(t);
  return {
    controls: e,
    failures: n,
    ...
    step: i,
    Tour: ke()
      ? I.createElement(ms, { controls: e, mergedProps: r, state: o, step: i, store: s })
      : null,
  };
}
function hs(t) {
...
function Un(t) {
  return ke() ? I.createElement(hs, t) : null;
}
const ys = { px: 2.25, pb: 2, pt: 1.8 },
  bs = { minWidth: 0 },
  ws = (t) => ({
    alignItems: "center",
  ...
  Ts = {
    animation: "thread-tour-content-enter 320ms cubic-bezier(0.22, 1, 0.36, 1) both",
    minHeight: 94,
    pt: 1.9,
  ...
  xs = { alignItems: "center", justifyContent: "space-between", minHeight: 40, pt: 1.5 },
  ...
  Wn = (t) => ({
    arrow: { filter: `drop-shadow(0 5px 5px ${J(t.palette.surface.shadow, 0.12)})` },
    floater: { filter: "none", willChange: "opacity" },
    tooltip: {
    ...
    beaconInner: { backgroundColor: t.palette.primary.main },
    beaconOuter: {
    ...
    H.jsx(Qn, {
      styles: (t) => ({
        ...
        "@media (prefers-reduced-motion: reduce)": {
          ...
          ".react-joyride__tooltip [data-thread-tour-content]": { animation: "none !important" },
        },
  ...
  Gn = ({
    ...
    H.jsxs("div", {
      className: "react-joyride__tooltip",
      "data-joyride-step": i,
      ...(c.id && { "data-joyride-id": c.id }),
      style: c.styles.tooltip,
      ...m,
      "aria-labelledby": c.title ? f : void 0,
      "aria-describedby": n,
      children: [
        H.jsx(mt, { "aria-hidden": "true", sx: Rs }),
        H.jsxs(mt, {
          sx: ys,
          children: [
            (o || r) &&
              H.jsxs(mt, {
                ...
                sx: Ss,
                children: [
                  o && H.jsx(mt, { "aria-hidden": "true", sx: ws, children: o }),
                  r &&
                    H.jsx(mt, {
                      sx: bs,
                      children: H.jsx(ce, {
            ...
            H.jsxs(
              mt,
              {
                ...
                children: [
                  ...
                  H.jsx(ce, { id: n, variant: "body2", color: "text.secondary", children: e }),
                ],
              },
              i,
            ),
            H.jsx(cr, {}),
            H.jsx(mt, { direction: "row", spacing: 1, sx: xs, children: t }),
          ],
        }),
      ],
    }),
            ...
            children: [
              s.buttons.includes("back") &&
                ...
                H.jsx(Dt, {
                  ...
                  "data-testid": "button-back",
                  size: "small",
                  startIcon: H.jsx(nr, { "aria-hidden": "true", size: 16 }),
                  title: t.title,
                  variant: "outlined",
                  onClick: t.onClick,
              ...
              s.buttons.includes("primary") &&
                H.jsx(Dt, {
                  ...
                  "data-testid": "button-primary",
                  endIcon: n
                    ? H.jsx(or, { "aria-hidden": "true", size: 16 })
                    : H.jsx(ir, { "aria-hidden": "true", size: 16 }),
                  size: "small",
                  sx: zn,
                  title: r.title,
                  variant: "contained",
                  onClick: r.onClick,
                  children: r["aria-label"],
                }),
            ],
          }),
        ],
  ...
  Cs = ({ index: t, primaryProps: e, skipProps: n, step: r, tooltipProps: o }) => {
    var c;
    const i = `thread-tour-button-soft-guide-title-${t}`,
      s = `thread-tour-button-soft-guide-content-${t}`,
      a = (c = r.data) == null ? void 0 : c.onShowNow;
    ...
    return H.jsx(Gn, {
      ...
      contentId: s,
      eyebrow: "Quick start",
      icon: H.jsx(fr, { "aria-hidden": "true", size: 21, strokeWidth: 2.2 }),
      content: r.content,
      actions: H.jsxs(H.Fragment, {
        children: [
          H.jsx(Dt, {
          ...
          H.jsx(Dt, {
            ...
            endIcon: H.jsx(rr, { "aria-hidden": "true", fill: "currentColor", size: 14 }),
            size: "small",
            sx: zn,
            title: e.title,
            variant: "contained",
  ...
  ks = {
    ...
    compute: "Compute runs a concrete Python or Sage calculation and reports the observed result.",
    visualization:
  ...
  Ls = ar.map((t) => ({ target: lr[t.value], title: t.label, content: ks[t.value] })),
  Ns = (t) => () =>
    typeof document > "u"
      ? null
      : (document.querySelector(W(t)) ?? document.querySelector(W(V.composerOperation))),
  Is = async (t) => {
    if (typeof document > "u" || document.querySelector(W(t))) return;
    const n = await dn(V.composerOperation, fn),
      r = n == null ? void 0 : n.querySelector('[role="combobox"]');
    !r ||
      r.getAttribute("aria-expanded") === "true" ||
      (r.dispatchEvent(new MouseEvent("mousedown", { bubbles: !0, button: 0 })), await dn(t, fn));
  },
  Ds = () =>
    new Promise((t) => {
      var r;
      ...
      const e = document.querySelector(W(V.composerOperationChat)),
        n = e == null ? void 0 : e.closest(".MuiPopover-root");
      ((r = n == null ? void 0 : n.querySelector(".MuiBackdrop-root")) == null || r.click(),
        window.requestAnimationFrame(() => {
          t();
        }));
    }),
  Cc = ({
    includeProChatCallStep: t = !1,
    includeChatSidebarStep: e = !1,
    includeWorkspaceToolbarSteps: n = !0,
    run: r,
    onEvent: o,
  }) => {
    const i = mn(),
      s = tr(),
      a = er("(prefers-reduced-motion: reduce)", { noSsr: !0 });
    qn(r);
    const c = g.useMemo(
        () => [
          {
          ...
          ...(e
            ? [
                ...
                },
                {
                  ...
                  title: "Close panel",
                  content: "Hide the chat side panel when you want more room to work.",
                  placement: "right",
                },
              ]
            : []),
            ...
            ? [
                {
                  ...
                  content: "Open or close the workspace side panel without leaving your chat.",
          ...
          ...(s
            ...
            : [
                ...
                },
                {
                  ...
                  content: "Turn mathematical variable highlighting on or off for this chat.",
                  placement: "bottom-end",
                },
                ...(n
                  ? []
            ...
            ? [
                {
                  ...
                  title: "Theme",
                  content: "Choose from five light and dark themes. Your selection is saved.",
                  placement: "bottom-end",
                },
                {
                  target: W(V.workspaceMoreActions),
      ...
      children: [
        ...
        H.jsx(Un, {
          ...
          options: {
            ...
            skipBeacon: !0,
            skipScroll: !1,
            spotlightPadding: { top: 12, right: 12, bottom: 12, left: 12 },
  ...
  Pc = ({ run: t, onDismiss: e, onShowNow: n, tourKey: r = Me.thread }) => {
    const o = mn();
    qn(t);
    const i = g.useMemo(() => {
        ...
        return [
          {
            target: W(V.workspaceMoreActions),
            title: c ? "Learn the hierarchy composer" : "Learn the message composer",
            content:
      ...
      a = g.useCallback(
        (c) => {
          (c.status !== F.FINISHED && c.status !== F.SKIPPED) || e();
        },
        [e],
      );
    return H.jsxs(H.Fragment, {
      children: [
        ...
        H.jsx(Un, {
          ...
          run: t,
          steps: i,
          locale: { last: "Show me now", skip: "Maybe later" },
          options: {
            arrowBase: 24,
            ...
            skipBeacon: !0,
            skipScroll: !0,
            spotlightPadding: { top: 9, right: 9, bottom: 9, left: 9 },
