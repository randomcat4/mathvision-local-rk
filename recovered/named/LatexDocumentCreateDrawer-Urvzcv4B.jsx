  ...
  return (
    <_Component2 sx={M}>
      <_Component2 sx={_}>
        ...
        <_Component variant="caption" color={c.type}>
          {c.message}
        </_Component>
      </_Component2>
      <_Component2 sx={he}>
        ...
        {e && (
          <_Component2 sx={ye}>
            {o.length === 0 && (
              <I severity={e.success ? "success" : "info"} variant="outlined">
                {e.success
...
const LatexDocumentCreateDrawer = ({
  open: e,
  initialName: o,
  onClose: i,
  onDocumentCreated: x,
        ...
        if (d.result.success) {
          ...
          f.error(
            "LaTeX compile failed. " +
              d.result.diagnostics.map((a) => a.message).join(", "),
          );
        }
        return;
      }
  ...
  const R = async (a) => {
    ...
    try {
      ...
      f.error(
        h instanceof Error ? h.message : "Could not create LaTeX project.",
      );
    }
  };
  return (
    ...
    >
      <_Component2 sx={de}>
        <_Component variant="h6" color="textPrimary">
          Create LaTeX project
        </_Component>
        <V aria-label="Close add LaTeX drawer" disableRipple={true} onClick={i}>
          <W size={18} />
        </V>
      </_Component2>
      <_Component2 component="form" sx={xe} onSubmit={R}>
        <_Component3
          autoFocus={true}
          label="Project name"
          value={p}
        ...
        <_Component2 sx={ue}>
          ...
          <T
            ...
            startIcon={
              L ? (
                <C size={16} thickness={5} color="inherit" />
              ) : (
                <_Component5 size={16} />
              )
            }
...
export { LatexDocumentCreateDrawer };
