...
const w = ({ quote: a, tone: s, onJump: i, onRemove: t }) => {
  const o = i !== undefined;
  ...
  return (
    <_Component5
      ...
      sx={k(s, o, t !== undefined)}
      onClick={o ? c : undefined}
    >
      {o && (
        <_Component2
          type="button"
      ...
      {!o && (
        <_Component3 sx={S} aria-hidden="true">
          <_Component size={19} />
        </_Component3>
      )}
      <_Component3 sx={I}>
        <C content={a.text} tone={s === "message" ? "user" : "assistant"} />
      </_Component3>
      {t && (
        <_Component2
          type="button"
...
const QuotedSelection = l.memo(w);
export { QuotedSelection as Q };
