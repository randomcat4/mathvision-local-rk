...
const R = ({ displayMode: t, onDisplayModeChange: n }) => {
  const i = t === "pdf";
  return (
    <_Component4 sx={C}>
      <_Component
      ...
      />
      <_Component3 htmlFor="switch-pdf-latex">
        <_Component2 variant="caption">View as PDF</_Component2>
      </_Component3>
    </_Component4>
  );
};
const T = ({
  ...
  t ? (
    <_Component4 sx={l}>
      <_Component5 size={28} />
      <_Component2 variant="body2" color="textSecondary" align="center">
        Compiling PDF
      </_Component2>
    </_Component4>
  ) : n && r ? (
    ...
    <_Component4 sx={v}>
      <_Component6 severity="error" variant="outlined">
        {i}
      </_Component6>
    </_Component4>
  ) : (
