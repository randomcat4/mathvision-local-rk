...
const V = (e) => {
  ...
  try {
    ...
    const s =
      o.pathname.length > 1 ? o.pathname.replace(/\/+$/, "") : o.pathname;
    if (
      (s !== "/chats" && !s.startsWith("/chats/")) ||
      s === "/chats/tour-guide"
    ) {
      return u;
    } else {
...
function ee() {
  ...
  return (
    <W value={Y}>
      <_Component sx={q}>
        <_Component sx={H} />
        <_Component component="main" sx={z}>
          <M activePanelKey="chats">
            <U
              isOpen={true}
          ...
          <_Component component="section" sx={G}>
            <_Component aria-label="Tour guide toolbar" sx={K}>
              <_Component ref={E} aria-label="Chat status" sx={N} />
              <_Component
