...
const ReportFeedbackDialog = ({ open: a, selectedChat: r, onClose: c }) => {
  ...
  return (
    <C open={a} maxWidth="sm" fullWidth={true} onClose={i}>
      <D component="form" onSubmit={j}>
        <M sx={O}>
        ...
        <_ sx={U}>
          ...
          <A disabled={o}>
            <I id="report-feedback-kind-label">Type</I>
            <B
              row={true}
        ...
        <_Component3>
          <_Component2 disabled={o} onClick={i}>
            Cancel
          </_Component2>
          <_Component2
            type="submit"
