          ...
          >
            <_Component2 spacing={3}>
              <_Component2 spacing={1}>
                <_Component variant="h4">Review Math Vision terms</_Component>
                <_Component variant="body1" color="textSecondary">
                  Please review and accept the current Terms of Service before
                  continuing.
                </_Component>
              </_Component2>
              <B />
              {a.isLoading ? (
                ...
                <_Component2 spacing={2}>
                  <_Component2 spacing={0.75}>
                    <_Component variant="subtitle2">
                      <_Component3 to="/terms" target="_blank" rel="noreferrer">
                        Terms version:{" "}
                        {(e == null ? undefined : e.termsVersion) ?? "Current"}
                      </_Component3>
                    </_Component>
                    <_Component variant="subtitle2">
                      <_Component3
                      ...
                      >
                        ...
                        {(e == null ? undefined : e.privacyPolicyVersion) ??
                          "Current"}
                      </_Component3>
                    </_Component>
                  </_Component2>
                  {l ? <Q severity="error">{l}</Q> : null}
                  <_Component2
                    direction={{
                      xs: "column",
                      sm: "row",
                  ...
                  >
                    <E
                      variant="contained"
                      startIcon={<_Component4 fontSize="small" />}
                      disabled={a.isFetching}
                      onClick={() => o.mutate()}
                    >
                      Agree
                    </E>
