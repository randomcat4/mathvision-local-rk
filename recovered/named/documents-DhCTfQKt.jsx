...
const f = {
  h1: ({ children: n }) => (
    <_Component component="h1" variant="h4" gutterBottom={true}>
      {n}
    </_Component>
  ),
  h2: ({ children: n }) => (
    <_Component component="h2" variant="h5" gutterBottom={true}>
      {n}
    </_Component>
  ),
  h3: ({ children: n }) => (
    <_Component component="h3" variant="h6" gutterBottom={true}>
      {n}
    </_Component>
  ),
  p: ({ children: n }) => (
    <_Component component="p" variant="body1" color="textSecondary">
      {n}
    </_Component>
  ),
  ul: ({ children: n }) => (
  ...
  li: ({ children: n }) => (
    <_Component component="li" variant="body1" color="textSecondary">
      {n}
    </_Component>
  ),
  a: ({ children: n, href: i }) => {
  ...
  return (
    ...
    >
      <_Component9 maxWidth="md">
        ...
        >
          <_Component2 spacing={3.5}>
            <_Component2 spacing={1}>
              <_Component variant="h3">{n.title}</_Component>
              <_Component variant="body2" color="textSecondary">
                Effective {n.effectiveDate} | Version {n.version}
              </_Component>
            </_Component2>
            <_Component4 />
            <_Component2 spacing={3}>
              <_Component5 components={f}>{n.markdown}</_Component5>
            </_Component2>
            <_Component4 />
            <_Component2
              direction={{
