...
const B = (t) =>
  t
    .replace(_, (r, n, i) => p(n, i))
    .replace(N, (r, n, i) => (P(n, i) ? p(n, i) : r));
        ...
        if (c.length === 0 || c.some((e) => e === undefined)) {
          ...
          return c
            .map((e) => {
              if (!e) {
                throw new Error(
                  "Literature source marker resolved without a source.",
                );
              }
...
const StructuredMarkdown = ({
  ...
  return (
    <_Component
      content={T}
      mathLabelPrefix={e ? undefined : a}
      mathSyntax={s}
      mode={d}
      sx={c}
      components={C}
      highlights={e ? undefined : o}
      showCodeCopyButton={!e}
    />
  );
};
export { StructuredMarkdown as S };
