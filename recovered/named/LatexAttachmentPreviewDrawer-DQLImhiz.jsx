...
const J = ({
  ...
  if (!n.isValidElement(s)) {
    throw new Error(
      "LatexAttachmentPreviewDrawer requires a single React element child.",
    );
  }
  const l = (t) => {
    b(t);
    ...
    <e.Fragment>
      ...
      >
        <_Component3 sx={A}>
          <_Component3 sx={W}>
            <div>
              <_Component variant="h6" color="textPrimary" noWrap={true}>
                {a}
              </_Component>
...
export {
  J as LatexAttachmentPreviewDrawer,
  ee as decodeBase64Text,
  te as isLatexAttachmentName,
};
