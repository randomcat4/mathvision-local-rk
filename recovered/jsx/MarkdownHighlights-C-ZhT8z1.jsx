import { ab as Bt, am as Ct, r as Y, F as Et, c7 as r1, aL as a1, aw as fn, c8 as n1, aJ as pn, G as ae, H as Me, j as l0, I as Dt, K as V0, a3 as It, aM as qe, aN as ha, c9 as i1, bP as s1, a8 as vn, aD as gn, A as bn, aH as l1, aP as yn, ca as wt, a_ as _t, bQ as o1, bR as u1, b7 as c1, a$ as h1, E as at, a6 as _Component5, B as _Component4, g as G0 } from "./index-BM3ZINIl.js";
import { d as xn, o as wn } from "./TextField-D8vc_sXz.js";
import { f as f1, p as ma, a as da, n as fa, h as p1, s as v1, c as g1, v as b1, S as y1 } from "./index-Yb6ONXKu.js";
function x1(r) {
...
const pa = Y.forwardRef(function (e, t) {
  const a = Et({
    props: e,
    name: "MuiCollapse"
  });
  ...
  const x0 = Y.useRef();
  const t0 = typeof u == "number" ? `${u}px` : u;
  const c0 = C === "horizontal";
  const d0 = c0 ? "width" : "height";
  const a0 = Y.useRef(null);
  const w0 = pn(t, a0);
  const J0 = () => V.current ? V.current[c0 ? "clientWidth" : "clientHeight"] : 0;
  const L0 = qe(a0, (K, O0) => {
    if (V.current && c0) {
  ...
  const C0 = qe(a0, (K, O0) => {
    ...
    if ($ === "auto") {
      ...
      K.style.transitionDuration = `${F0}ms`;
      x0.current = F0;
    } else {
      K.style.transitionDuration = typeof m0 == "string" ? m0 : `${m0}ms`;
    }
    K.style[d0] = `${D0}px`;
    K.style.transitionTimingFunction = k0;
    if (x) {
      x(K, O0);
    }
  });
  ...
  const ye = qe(a0, K => {
    ...
    if ($ === "auto") {
      ...
      K.style.transitionDuration = `${k0}ms`;
      x0.current = k0;
    } else {
      K.style.transitionDuration = typeof D0 == "string" ? D0 : `${D0}ms`;
    }
    K.style[d0] = t0;
    K.style.transitionTimingFunction = m0;
    if (B) {
      B(K);
    }
  });
  ...
  const [Ce, H0] = ae("root", {
    ...
    additionalProps: {
      style: {
        [c0 ? "minWidth" : "minHeight"]: t0,
        ...O
      }
    }
  });
  const [Ee, De] = ae("wrapper", {
    ref: V,
    className: G.wrapper,
    elementType: k1,
    externalForwardedProps: E0,
  ...
  const [Ie, ee] = ae("wrapperInner", {
    className: G.wrapperInner,
    elementType: T1,
    externalForwardedProps: E0,
    ownerState: X
  });
  return <P in={f} onEnter={L0} onEntered={Q0} onEntering={C0} onExit={h0} onExited={_0} onExiting={ye} addEndListener={Ve} nodeRef={a0} timeout={$ === "auto" ? null : $} {...U}>{(K, {
      ownerState: O0,
      ...D0
    }) => {
      const m0 = {
      ...
      return <Ce {...H0} className={Me(H0.className, {
        entered: G.entered,
        exited: !f && t0 === "0px" && G.hidden
      }[K])} ownerState={m0} {...D0}><Ee {...De} ownerState={m0}><Ie {...ee} ownerState={m0}>{i}</Ie></Ee></Ce>;
    }}</P>;
});
if (pa) {
...
const W0 = Ct("MuiTab", ["root", "labelIcon", "textColorInherit", "textColorPrimary", "textColorSecondary", "selected", "disabled", "fullWidth", "wrapped", "icon"]);
const M1 = r => {
  const {
    classes: e,
    textColor: t,
  ...
  const d = {
    root: ["root", i && l && "labelIcon", `textColor${vn(t)}`, a && "fullWidth", n && "wrapped", u && "selected", c && "disabled"],
    icon: ["icon"]
  };
  return Dt(d, A1, e);
};
const _Component = V0(gn, {
  name: "MuiTab",
  slot: "Root",
  overridesResolver: (r, e) => {
    const {
    ...
    return [e.root, t.label && t.icon && e.labelIcon, e[`textColor${vn(t.textColor)}`], t.fullWidth && e.fullWidth, t.wrapped && e.wrapped, {
      [`& .${W0.icon}`]: e.icon
    }];
  }
})(It(({
  ...
  variants: [{
    ...
    style: {
      color: (r.vars || r).palette.text.secondary,
      [`&.${W0.selected}`]: {
        color: (r.vars || r).palette.secondary.main
      },
      [`&.${W0.disabled}`]: {
        color: (r.vars || r).palette.text.disabled
      }
...
const T4 = Y.forwardRef(function (e, t) {
  const a = Et({
    props: e,
    name: "MuiTab"
  });
  ...
  const X = $.getItemMap().size === 0 && T ? 0 : P.tabIndex;
  const G = {
    ...a,
    disabled: i,
  ...
  const J = M1(G);
  const Z = c && g && Y.isValidElement(c) ? Y.cloneElement(c, {
    className: Me(J.icon, c.props.className)
  }) : c;
  const V = t0 => {
    if (!T && y) {
      y(t0, N);
  ...
  return <_Component internalNativeButton={true} focusRipple={!l} className={Me(J.root, n)} ref={P.ref} role="tab" aria-selected={T} disabled={i} onClick={V} onFocus={x0} tabIndex={X} ownerState={G} {...O}>{d === "top" || d === "start" ? <Y.Fragment>{Z}{g}</Y.Fragment> : <Y.Fragment>{g}{Z}</Y.Fragment>}{f}</_Component>;
});
const B1 = bn(<path d="M15.41 16.09l-4.58-4.59 4.58-4.59L14 5.5l-6 6 6 6z" />);
const C1 = bn(<path d="M8.59 16.34l4.58-4.59-4.58-4.59L10 5.75l6 6-6 6z" />);
function E1(r) {
...
const O1 = Y.forwardRef(function (e, t) {
  const a = Et({
    props: e,
    name: "MuiTabScrollButton"
  });
  ...
  const T = L1(w);
  const B = i.StartScrollButtonIcon ?? B1;
  const C = i.EndScrollButtonIcon ?? C1;
  const N = wt({
    elementType: B,
  ...
  return <H1 component="div" className={Me(T.root, n)} ref={t} role={null} ownerState={w} tabIndex={null} {...y} style={{
    ...y.style,
    ...(c === "vertical" && {
      "--TabScrollButton-svgRotate": `rotate(${x ? -90 : 90}deg)`
    })
  }}>{u === "left" ? <B {...N} /> : <C {...q} />}</H1>;
});
function F1(r) {
...
const er = Ct("MuiTabs", ["root", "vertical", "list", "centered", "scroller", "fixed", "scrollableX", "scrollableY", "hideScrollbar", "scrollButtons", "scrollButtonsHideMobile", "indicator"]);
const P1 = r => {
  const {
    vertical: e,
    fixed: t,
  ...
  return Dt({
    ...
    scroller: ["scroller", t && "fixed", a && "hideScrollbar", n && "scrollableX", i && "scrollableY"],
...
const G1 = V0("div", {
  ...
  overridesResolver: (r, e) => {
    ...
    return [e.scroller, t.fixed && e.fixed, t.hideScrollbar && e.hideScrollbar, t.scrollableX && e.scrollableX, t.scrollableY && e.scrollableY];
  }
})({
  position: "relative",
...
const va = {};
const A4 = Y.forwardRef(function (e, t) {
  const a = Et({
    props: e,
    name: "MuiTabs"
  });
  ...
  const {
    ...
    className: g,
    component: y = "div",
    allowScrollButtonsMobile: x = false,
    ...
    value: P,
    variant: U = "standard",
    visibleScrollbar: X = false,
    ...G
  } = a;
  const J = U === "scrollable";
  const Z = B === "vertical";
  const V = Z ? "scrollTop" : "scrollLeft";
  const x0 = Z ? "top" : "left";
  const t0 = Z ? "bottom" : "right";
  const c0 = Z ? "clientHeight" : "clientWidth";
  const d0 = Z ? "height" : "width";
  const a0 = {
    ...a,
    component: y,
  ...
  const [C0, Q0] = Y.useState(false);
  const [h0, _0] = Y.useState(va);
  const [ye, Ve] = Y.useState(false);
  const [E0, Ce] = Y.useState(false);
  const [H0, Ee] = Y.useState(false);
  const De = P === false ? null : P;
  const [Ie, ee] = Y.useState(false);
  const [K, O0] = Y.useState({
    overflow: "hidden",
    scrollbarWidth: 0
  });
  const D0 = new Map();
  const m0 = Y.useRef(null);
  const k0 = Y.useRef(null);
  const F0 = {
    slots: q,
    slotProps: O
  };
  ...
  const we = _t(() => {
    ...
    if (Z) {
      Q = "top";
      if (R && I) {
        W = R.top - I.top + I.scrollTop;
      }
    } else {
      Q = i ? "right" : "left";
      if (R && I) {
        W = (i ? -1 : 1) * (R[Q] - I[Q] + I.scrollLeft);
      }
    }
    const g0 = {
      [Q]: W,
    ...
    if (typeof h0[Q] != "number" || typeof h0[d0] != "number") {
      _0(g0);
    } else {
      const Se = Math.abs(h0[Q] - g0[Q]);
      const ke = Math.abs(h0[d0] - g0[d0]);
      if (Se >= 1 || ke >= 1) {
        _0(g0);
      }
    }
  ...
  const [_Component2, sa] = ae("scrollButtons", {
    ...
    additionalProps: {
      ...
      slotProps: {
        startScrollButtonIcon: J0,
        endScrollButtonIcon: L0
      }
    }
  });
  const ji = () => {
    const I = {
      scrollbarSizeListener: J ? <Kt {...Ne} onChange={Wi} /> : null
    };
    const W = J && (C === "auto" && (ye || E0) || C === true);
    I.scrollButtonStart = W ? <_Component2 direction={i ? "right" : "left"} onClick={st} disabled={!ye} {...sa} /> : null;
    I.scrollButtonEnd = W ? <_Component2 direction={i ? "left" : "right"} onClick={Yt} disabled={!E0} {...sa} /> : null;
    return I;
  };
  const la = _t(I => {
    const {
  ...
  Y.useEffect(() => {
    ...
    if (typeof MutationObserver !== "undefined") {
      g0 = new MutationObserver(W);
      g0.observe(k0.current, {
        childList: true
      });
    }
    return () => {
  ...
  Y.useEffect(() => {
    ...
    const R = I.length;
    if (typeof IntersectionObserver !== "undefined" && R > 0 && J && C !== false) {
      const W = I[0];
      const Q = I[R - 1];
      const g0 = {
        root: m0.current,
      ...
      const ke = new IntersectionObserver(Se, g0);
      ke.observe(W);
      const Ze = Qt => {
        Ce(!Qt[0].isIntersecting);
      };
      const ca = new IntersectionObserver(Ze, g0);
      ca.observe(Q);
      return () => {
        ke.disconnect();
        ca.disconnect();
  ...
  }, [J, C, H0, f == null ? undefined : f.length]);
  Y.useEffect(() => {
    Q0(true);
  }, []);
  Y.useEffect(() => {
  ...
  const oa = <Ui {...Xi} />;
  const ua = o1({
    activeItemId: Ie ? undefined : De,
    orientation: B,
    isRtl: i
  });
  const Zt = ua.getContainerProps();
  const Vi = Y.Children.toArray(f).filter(Y.isValidElement).map((I, R) => {
    const W = I.props.value === undefined ? R : I.props.value;
    D0.set(W, R);
    return {
      child: I,
      index: R,
  ...
  const [Zi, Ji] = ae("scroller", {
    ...
    additionalProps: {
      style: {
        overflow: K.overflow,
        [Z ? `margin${i ? "Left" : "Right"}` : "marginBottom"]: X ? undefined : -K.scrollbarWidth
      }
    }
  });
  const Qi = pn(Zt.ref, k0);
  const _i = I => {
    const R = k0.current;
    const W = c1(h1(R));
    if ((W == null ? undefined : W.getAttribute("role")) === "tab") {
      Zt.onKeyDown(I);
    }
  };
  const [_Component3, t1] = ae("list", {
    ref: Qi,
    className: w0.list,
    elementType: W1,
    externalForwardedProps: F0,
    ...
    getSlotProps: I => ({
      ...
      onBlur: R => {
        var W;
        if (!R.currentTarget.contains(R.relatedTarget)) {
          ee(false);
        }
        if ((W = I.onBlur) != null) {
          W.call(I, R);
  ...
  return <Yi {...Ki}>{Jt.scrollButtonStart}{Jt.scrollbarSizeListener}<Zi {...Ji}><_Component3 aria-label={l} aria-labelledby={u} aria-orientation={B === "vertical" ? "vertical" : null} role="tablist" {...t1}><u1.Provider value={ua}>{Vi}</u1.Provider></_Component3>{C0 && oa}</Zi>{Jt.scrollButtonEnd}</Yi>;
});
/**
...
function J1(r, e) {
  ...
  while (n < t.length) {
    ga.lastIndex = n;
    const u = ga.exec(t);
    const c = t.slice(n, u ? u.index : t.length);
    if (c) {
      if (i) {
        if (i === "#") {
          a.id = c;
...
function Sn(r, e, t) {
  ...
  function n(i, l, ...u) {
    ...
    if (i == null) {
      ...
      const f = a ? a.get(d) : undefined;
      c.tagName = f || d;
      if (Q1(l)) {
        u.unshift(l);
      } else {
        for (const [g, y] of Object.entries(l)) {
          _1(r, c.properties, g, y);
        }
      }
    }
    for (const d of u) {
    ...
    if (c.type === "element" && c.tagName === "template") {
      c.content = {
        type: "root",
        children: c.children
      };
...
function _1(r, e, t, a) {
  ...
  if (a != null) {
    if (typeof a == "number") {
      ...
      if (n.spaceSeparated) {
        i = ma(a);
      } else if (n.commaSeparated) {
        i = da(a);
      } else if (n.commaOrSpaceSeparated) {
        i = ma(da(a).join(" "));
      } else {
        i = ba(n, n.property, a);
      }
    ...
    if (Array.isArray(i)) {
      const l = [];
      for (const u of i) {
        l.push(ba(n, n.property, u));
      }
      i = l;
    }
    if (n.property === "className" && Array.isArray(e.className)) {
      i = e.className.concat(i);
    }
    e[n.property] = i;
  }
}
...
function ba(r, e, t) {
  if (typeof t == "string") {
    if (r.number && t && !Number.isNaN(Number(t))) {
      return Number(t);
    }
    if ((r.boolean || r.overloadedBoolean) && (t === "" || fa(t) === fa(e))) {
      return true;
    }
  }
  return t;
...
function kn(r, e) {
  const t = ss(r, e);
  if (t && e.afterTransform) {
    e.afterTransform(r, t);
  }
  return t;
}
function ss(r, e) {
...
function cs(r, e) {
  ...
  const a = t === tr.svg ? ns : as;
  const n = t === tr.html ? r.tagName.toLowerCase() : r.tagName;
  const i = t === tr.html && n === "template" ? r.content : r;
  const l = r.getAttributeNames();
  const u = {};
  let c = -1;
  while (++c < l.length) {
    u[l[c]] = r.getAttribute(l[c]) || "";
  }
  return a(n, u, Tn(i, e));
}
function Tn(r, e) {
...
const xa = function (r, e, t) {
  ...
  if (typeof e == "number") {
    ...
    e = r.children.indexOf(e);
    if (e < 0) {
      throw new Error("Expected child node or index");
    }
  }
  while (++e < r.children.length) {
    if (a(r.children[e], e, r)) {
      return r.children[e];
    }
  }
};
...
function Or(r) {
  return e;
  function e(t, a, n) {
    return !!vs(t) && !!r.call(this, t, typeof a == "number" ? a : undefined, n || undefined);
  }
}
function ps(r) {
  return !!r && typeof r == "object" && !!("type" in r) && r.type === "element" && !!("tagName" in r) && typeof r.tagName == "string";
}
function vs(r) {
...
const gs = ze("p");
const Ta = ze("tr");
const bs = ze(["datalist", "head", "noembed", "noframes", "noscript", "rp", "script", "style", "template", "title", ks, As]);
const An = ze(["address", "article", "aside", "blockquote", "body", "caption", "center", "dd", "dialog", "dir", "dl", "dt", "div", "figure", "figcaption", "footer", "form,", "h1", "h2", "h3", "h4", "h5", "h6", "header", "hgroup", "hr", "html", "legend", "li", "listing", "main", "menu", "nav", "ol", "p", "plaintext", "pre", "section", "ul", "xmp"]);
function ys(r, e) {
  const t = e || {};
  const a = "children" in r ? r.children : [];
  const n = An(r);
  const i = Bn(r, {
    whitespace: t.whitespace || "normal"
  });
  const l = [];
  if (r.type === "text" || r.type === "comment") {
    l.push(...zn(r, {
      breakBefore: true,
      breakAfter: true
    }));
...
function xs(r, e, t) {
  ...
  let u;
  let c;
  for (xr(r) || Ta(r) && xa(e, r, Ta) ? c = `
` : gs(r) ? (u = 2, c = 2) : An(r) && (u = 1, c = 1); ++i < n.length;) {
    l = l.concat(Mn(n[i], r, {
      whitespace: a,
      breakBefore: i ? undefined : u,
...
function zn(r, e) {
  ...
  while (i <= t.length) {
    wa.lastIndex = i;
    const c = wa.exec(t);
    const d = c && "index" in c ? c.index : t.length;
    a.push(Ss(t.slice(i, d).replace(/[\u061C\u200E\u200F\u202A-\u202E\u2066-\u2069]/g, ""), i === 0 ? e.breakBefore : true, d === t.length ? e.breakAfter : true));
    i = d + 1;
  }
  let l = -1;
  let u;
  while (++l < a.length) {
    if (a[l].charCodeAt(a[l].length - 1) === 8203 || l < a.length - 1 && a[l + 1].charCodeAt(0) === 8203) {
      n.push(a[l]);
      u = undefined;
    } else if (a[l]) {
      if (typeof u == "number") {
...
var Ms = /([A-Z])/g;
var Fr = r => r.replace(Ms, "-$1").toLowerCase();
var zs = {
  "&": "&amp;",
  ">": "&gt;",
  "<": "&lt;",
...
var Bs = /[&><"']/g;
var S0 = r => String(r).replace(Bs, e => zs[e]);
var bt = r => r.type === "ordgroup" || r.type === "color" ? r.body.length === 1 ? bt(r.body[0]) : r : r.type === "font" ? bt(r.body) : r;
var Cs = new Set(["mathord", "textord", "atom"]);
var le = r => Cs.has(bt(r).type);
var Es = r => {
  var e = /^[\x00-\x20]*([^\\/#?]*?)(:|&#0*58|&#x0*3a|&colon)/i.exec(r);
  if (e) {
    if (e[2] !== ":" || !/^[a-zA-Z][a-zA-Z0-9+\-.]*$/.test(e[1])) {
      return null;
    } else {
...
var wr = {
  ...
  maxExpand: {
    ...
    processor: r => Math.max(0, r),
    cli: "-e, --max-expand <n>",
    cliProcessor: r => r === "Infinity" ? Infinity : parseInt(r)
  },
  globalGroup: {
    type: "boolean",
    cli: false
...
class Pr {
  constructor(e = {}) {
    ...
    for (var t of Object.keys(wr)) {
      var a = wr[t];
      var n = e[t];
      this[t] = n !== undefined ? a.processor ? a.processor(n) : n : Ds(a);
    }
  }
...
var Oe = 6;
var M0 = 7;
var U0 = [new ce($r, 0, false), new ce(St, 0, true), new ce(He, 1, false), new ce(ie, 1, true), new ce(et, 2, false), new ce(P0, 2, true), new ce(Oe, 3, false), new ce(M0, 3, true)];
var Is = [et, P0, et, P0, Oe, M0, Oe, M0];
var Rs = [P0, P0, P0, P0, M0, M0, M0, M0];
var Ns = [He, ie, et, P0, Oe, M0, Oe, M0];
var qs = [ie, ie, P0, P0, M0, M0, M0, M0];
var Ls = [St, St, ie, ie, P0, P0, M0, M0];
var Hs = [$r, St, He, ie, He, ie, He, ie];
var F = {
  DISPLAY: U0[$r],
  TEXT: U0[He],
  SCRIPT: U0[et],
...
function En(e) {
  ...
  return e in kr || e in Ks || e === "ex";
}
function o0(e, t) {
  var a;
  if (e.unit in kr) {
    a = kr[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier;
  } else if (e.unit === "mu") {
    ...
    if (n !== t) {
      a *= n.sizeMultiplier / t.sizeMultiplier;
    }
  }
...
function Rn(e) {
  ...
  for (var i of Object.keys(this.attributes)) {
    if (Zs.test(i)) {
      throw new A("Invalid attribute name '" + i + "'");
    }
...
class R0 {
  constructor(e, t, a, n, i, l, u, c) {
    ...
    if (d) {
      this.classes.push(d + "_fallback");
    }
    if (/[îïíì]/.test(this.text)) {
      this.text = Qs[this.text];
    }
  }
  hasClass(e) {
    return this.classes.includes(e);
  ...
  toMarkup() {
    ...
    if (this.classes.length) {
      e = true;
      t += " class=\"";
      t += S0(fe(this.classes));
      t += "\"";
    }
    var a = "";
    if (this.italic > 0) {
      a += "margin-right:" + z(this.italic) + ";";
    }
    for (var n of Object.keys(this.style)) {
      a += Fr(n) + ":" + this.style[n] + ";";
    }
...
class pe {
  ...
  toNode() {
    ...
    if (this.alternate) {
      ...
      t.setAttribute("d", Aa[this.pathName]);
    }
    return t;
  }
  toMarkup() {
    if (this.alternate) {
      return "<path d=\"" + S0(this.alternate) + "\"/>";
    } else {
      return "<path d=\"" + S0(Aa[this.pathName]) + "\"/>";
    }
  }
}
class Tr {
...
function al(r) {
  ...
  if (!rr[e]) {
    var t = rr[e] = {
      cssEmPerMu: ot.quad[e] / 18
    };
    for (var a in ot) {
      if (ot.hasOwnProperty(a)) {
        t[a] = ot[a][e];
      }
    }
  }
...
s(o, h, v, "⋈", "\\bowtie", true);
s(o, h, v, "⌣", "\\smile", true);
s(o, h, v, "⊑", "\\sqsubseteq", true);
s(o, h, v, "⊒", "\\sqsupseteq", true);
s(o, h, v, "≐", "\\doteq", true);
s(o, h, v, "⌢", "\\frown", true);
s(o, h, v, "∋", "\\ni", true);
s(o, h, v, "∝", "\\propto", true);
...
s(o, h, z0, "⎱", "\\rmoustache", true);
s(o, h, N0, "⎰", "\\lmoustache", true);
s(o, h, z0, "⟯", "\\rgroup", true);
s(o, h, N0, "⟮", "\\lgroup", true);
s(o, h, D, "∓", "\\mp", true);
s(o, h, D, "⊖", "\\ominus", true);
s(o, h, D, "⊎", "\\uplus", true);
s(o, h, D, "⊓", "\\sqcap", true);
s(o, h, D, "∗", "\\ast");
s(o, h, D, "⊔", "\\sqcup", true);
s(o, h, D, "◯", "\\bigcirc", true);
s(o, h, D, "∙", "\\bullet", true);
s(o, h, D, "‡", "\\ddagger");
s(o, h, D, "≀", "\\wr", true);
s(o, h, D, "⨿", "\\amalg");
s(o, h, D, "&", "\\And");
s(o, h, v, "⟵", "\\longleftarrow", true);
s(o, h, v, "⇐", "\\Leftarrow", true);
s(o, h, v, "⟸", "\\Longleftarrow", true);
s(o, h, v, "⟶", "\\longrightarrow", true);
s(o, h, v, "⇒", "\\Rightarrow", true);
s(o, h, v, "⟹", "\\Longrightarrow", true);
s(o, h, v, "↔", "\\leftrightarrow", true);
s(o, h, v, "⟷", "\\longleftrightarrow", true);
s(o, h, v, "⇔", "\\Leftrightarrow", true);
s(o, h, v, "⟺", "\\Longleftrightarrow", true);
s(o, h, v, "↦", "\\mapsto", true);
s(o, h, v, "⟼", "\\longmapsto", true);
s(o, h, v, "↗", "\\nearrow", true);
s(o, h, v, "↩", "\\hookleftarrow", true);
s(o, h, v, "↪", "\\hookrightarrow", true);
s(o, h, v, "↘", "\\searrow", true);
s(o, h, v, "↼", "\\leftharpoonup", true);
s(o, h, v, "⇀", "\\rightharpoonup", true);
s(o, h, v, "↙", "\\swarrow", true);
s(o, h, v, "↽", "\\leftharpoondown", true);
s(o, h, v, "⇁", "\\rightharpoondown", true);
s(o, h, v, "↖", "\\nwarrow", true);
s(o, h, v, "⇌", "\\rightleftharpoons", true);
s(o, p, v, "≮", "\\nless", true);
s(o, p, v, "", "\\@nleqslant");
s(o, p, v, "", "\\@nleqq");
s(o, p, v, "⪇", "\\lneq", true);
...
s(o, p, v, "", "\\@lvertneqq");
s(o, p, v, "⋦", "\\lnsim", true);
s(o, p, v, "⪉", "\\lnapprox", true);
s(o, p, v, "⊀", "\\nprec", true);
s(o, p, v, "⋠", "\\npreceq", true);
s(o, p, v, "⋨", "\\precnsim", true);
s(o, p, v, "⪹", "\\precnapprox", true);
s(o, p, v, "≁", "\\nsim", true);
s(o, p, v, "", "\\@nshortmid");
s(o, p, v, "∤", "\\nmid", true);
s(o, p, v, "⊬", "\\nvdash", true);
...
s(o, p, v, "⋪", "\\ntriangleleft");
s(o, p, v, "⋬", "\\ntrianglelefteq", true);
s(o, p, v, "⊊", "\\subsetneq", true);
s(o, p, v, "", "\\@varsubsetneq");
s(o, p, v, "⫋", "\\subsetneqq", true);
...
s(o, p, v, "", "\\@gvertneqq");
s(o, p, v, "⋧", "\\gnsim", true);
s(o, p, v, "⪊", "\\gnapprox", true);
s(o, p, v, "⊁", "\\nsucc", true);
s(o, p, v, "⋡", "\\nsucceq", true);
s(o, p, v, "⋩", "\\succnsim", true);
s(o, p, v, "⪺", "\\succnapprox", true);
s(o, p, v, "≆", "\\ncong", true);
...
s(o, p, v, "", "\\@nsupseteqq");
s(o, p, v, "⊋", "\\supsetneq", true);
s(o, p, v, "", "\\@varsupsetneq");
s(o, p, v, "⫌", "\\supsetneqq", true);
s(o, p, v, "", "\\@varsupsetneqq");
s(o, p, v, "⊮", "\\nVdash", true);
s(o, p, v, "⪵", "\\precneqq", true);
s(o, p, v, "⪶", "\\succneqq", true);
s(o, p, v, "", "\\@nsubseteqq");
s(o, p, D, "⊴", "\\unlhd");
s(o, p, D, "⊵", "\\unrhd");
s(o, p, v, "↚", "\\nleftarrow", true);
...
s(o, p, b, "ϰ", "\\varkappa");
s(o, p, N0, "┌", "\\@ulcorner", true);
s(o, p, z0, "┐", "\\@urcorner", true);
s(o, p, N0, "└", "\\@llcorner", true);
s(o, p, z0, "┘", "\\@lrcorner", true);
s(o, p, v, "≦", "\\leqq", true);
s(o, p, v, "⩽", "\\leqslant", true);
s(o, p, v, "⪕", "\\eqslantless", true);
s(o, p, v, "≲", "\\lesssim", true);
s(o, p, v, "⪅", "\\lessapprox", true);
s(o, p, v, "≊", "\\approxeq", true);
s(o, p, D, "⋖", "\\lessdot");
s(o, p, v, "⋘", "\\lll", true);
s(o, p, v, "≶", "\\lessgtr", true);
s(o, p, v, "⋚", "\\lesseqgtr", true);
s(o, p, v, "⪋", "\\lesseqqgtr", true);
s(o, p, v, "≑", "\\doteqdot");
s(o, p, v, "≓", "\\risingdotseq", true);
s(o, p, v, "≒", "\\fallingdotseq", true);
s(o, p, v, "∽", "\\backsim", true);
s(o, p, v, "⋍", "\\backsimeq", true);
s(o, p, v, "⫅", "\\subseteqq", true);
s(o, p, v, "⋐", "\\Subset", true);
s(o, p, v, "⊏", "\\sqsubset", true);
s(o, p, v, "≼", "\\preccurlyeq", true);
s(o, p, v, "⋞", "\\curlyeqprec", true);
s(o, p, v, "≾", "\\precsim", true);
s(o, p, v, "⪷", "\\precapprox", true);
...
s(o, p, v, "≎", "\\Bumpeq", true);
s(o, p, v, "≧", "\\geqq", true);
s(o, p, v, "⩾", "\\geqslant", true);
s(o, p, v, "⪖", "\\eqslantgtr", true);
s(o, p, v, "≳", "\\gtrsim", true);
s(o, p, v, "⪆", "\\gtrapprox", true);
s(o, p, D, "⋗", "\\gtrdot");
s(o, p, v, "⋙", "\\ggg", true);
s(o, p, v, "≷", "\\gtrless", true);
s(o, p, v, "⋛", "\\gtreqless", true);
s(o, p, v, "⪌", "\\gtreqqless", true);
s(o, p, v, "≖", "\\eqcirc", true);
s(o, p, v, "≗", "\\circeq", true);
s(o, p, v, "≜", "\\triangleq", true);
s(o, p, v, "∼", "\\thicksim");
s(o, p, v, "≈", "\\thickapprox");
s(o, p, v, "⫆", "\\supseteqq", true);
s(o, p, v, "⋑", "\\Supset", true);
s(o, p, v, "⊐", "\\sqsupset", true);
s(o, p, v, "≽", "\\succcurlyeq", true);
s(o, p, v, "⋟", "\\curlyeqsucc", true);
s(o, p, v, "≿", "\\succsim", true);
s(o, p, v, "⪸", "\\succapprox", true);
s(o, p, v, "⊳", "\\vartriangleright");
s(o, p, v, "⊵", "\\trianglerighteq");
s(o, p, v, "⊩", "\\Vdash", true);
s(o, p, v, "∣", "\\shortmid");
s(o, p, v, "∥", "\\shortparallel");
s(o, p, v, "≬", "\\between", true);
s(o, p, v, "⋔", "\\pitchfork", true);
s(o, p, v, "∝", "\\varpropto");
s(o, p, v, "◀", "\\blacktriangleleft");
s(o, p, v, "∴", "\\therefore", true);
s(o, p, v, "∍", "\\backepsilon");
s(o, p, v, "▶", "\\blacktriangleright");
s(o, p, v, "∵", "\\because", true);
s(o, p, v, "⋘", "\\llless");
s(o, p, v, "⋙", "\\gggtr");
s(o, p, D, "⊲", "\\lhd");
s(o, p, D, "⊳", "\\rhd");
...
s(o, h, v, "⋈", "\\Join");
s(o, p, v, "≑", "\\Doteq", true);
s(o, p, D, "∔", "\\dotplus", true);
s(o, p, D, "∖", "\\smallsetminus");
s(o, p, D, "⋒", "\\Cap", true);
s(o, p, D, "⋓", "\\Cup", true);
s(o, p, D, "⩞", "\\doublebarwedge", true);
s(o, p, D, "⊟", "\\boxminus", true);
s(o, p, D, "⊞", "\\boxplus", true);
s(o, p, D, "⋇", "\\divideontimes", true);
s(o, p, D, "⋉", "\\ltimes", true);
s(o, p, D, "⋊", "\\rtimes", true);
s(o, p, D, "⋋", "\\leftthreetimes", true);
s(o, p, D, "⋌", "\\rightthreetimes", true);
s(o, p, D, "⋏", "\\curlywedge", true);
s(o, p, D, "⋎", "\\curlyvee", true);
s(o, p, D, "⊝", "\\circleddash", true);
s(o, p, D, "⊛", "\\circledast", true);
s(o, p, D, "⋅", "\\centerdot");
s(o, p, D, "⊺", "\\intercal", true);
s(o, p, D, "⋒", "\\doublecap");
s(o, p, D, "⋓", "\\doublecup");
s(o, p, D, "⊠", "\\boxtimes", true);
s(o, p, v, "⇢", "\\dashrightarrow", true);
s(o, p, v, "⇠", "\\dashleftarrow", true);
s(o, p, v, "⇇", "\\leftleftarrows", true);
s(o, p, v, "⇆", "\\leftrightarrows", true);
s(o, p, v, "⇚", "\\Lleftarrow", true);
s(o, p, v, "↞", "\\twoheadleftarrow", true);
s(o, p, v, "↢", "\\leftarrowtail", true);
s(o, p, v, "↫", "\\looparrowleft", true);
s(o, p, v, "⇋", "\\leftrightharpoons", true);
s(o, p, v, "↶", "\\curvearrowleft", true);
s(o, p, v, "↺", "\\circlearrowleft", true);
s(o, p, v, "↰", "\\Lsh", true);
s(o, p, v, "⇈", "\\upuparrows", true);
s(o, p, v, "↿", "\\upharpoonleft", true);
s(o, p, v, "⇃", "\\downharpoonleft", true);
s(o, h, v, "⊶", "\\origof", true);
s(o, h, v, "⊷", "\\imageof", true);
s(o, p, v, "⊸", "\\multimap", true);
s(o, p, v, "↭", "\\leftrightsquigarrow", true);
s(o, p, v, "⇉", "\\rightrightarrows", true);
s(o, p, v, "⇄", "\\rightleftarrows", true);
s(o, p, v, "↠", "\\twoheadrightarrow", true);
s(o, p, v, "↣", "\\rightarrowtail", true);
s(o, p, v, "↬", "\\looparrowright", true);
s(o, p, v, "↷", "\\curvearrowright", true);
s(o, p, v, "↻", "\\circlearrowright", true);
s(o, p, v, "↱", "\\Rsh", true);
s(o, p, v, "⇊", "\\downdownarrows", true);
s(o, p, v, "↾", "\\upharpoonright", true);
s(o, p, v, "⇂", "\\downharpoonright", true);
s(o, p, v, "⇝", "\\rightsquigarrow", true);
s(o, p, v, "⇝", "\\leadsto");
s(o, p, v, "⇛", "\\Rrightarrow", true);
s(o, p, v, "↾", "\\restriction");
s(o, h, b, "‘", "`");
s(o, h, b, "$", "\\$");
s(S, h, b, "$", "\\$");
...
s(o, h, b, "∅", "\\emptyset");
s(o, p, b, "∅", "\\varnothing");
s(o, h, L, "α", "\\alpha", true);
s(o, h, L, "β", "\\beta", true);
s(o, h, L, "γ", "\\gamma", true);
s(o, h, L, "δ", "\\delta", true);
s(o, h, L, "ϵ", "\\epsilon", true);
s(o, h, L, "ζ", "\\zeta", true);
s(o, h, L, "η", "\\eta", true);
s(o, h, L, "θ", "\\theta", true);
s(o, h, L, "ι", "\\iota", true);
s(o, h, L, "κ", "\\kappa", true);
s(o, h, L, "λ", "\\lambda", true);
s(o, h, L, "μ", "\\mu", true);
s(o, h, L, "ν", "\\nu", true);
s(o, h, L, "ξ", "\\xi", true);
s(o, h, L, "ο", "\\omicron", true);
s(o, h, L, "π", "\\pi", true);
s(o, h, L, "ρ", "\\rho", true);
s(o, h, L, "σ", "\\sigma", true);
s(o, h, L, "τ", "\\tau", true);
s(o, h, L, "υ", "\\upsilon", true);
s(o, h, L, "ϕ", "\\phi", true);
s(o, h, L, "χ", "\\chi", true);
s(o, h, L, "ψ", "\\psi", true);
s(o, h, L, "ω", "\\omega", true);
s(o, h, L, "ε", "\\varepsilon", true);
s(o, h, L, "ϑ", "\\vartheta", true);
s(o, h, L, "ϖ", "\\varpi", true);
s(o, h, L, "ϱ", "\\varrho", true);
s(o, h, L, "ς", "\\varsigma", true);
s(o, h, L, "φ", "\\varphi", true);
s(o, h, D, "∗", "*", true);
s(o, h, D, "+", "+");
s(o, h, D, "−", "-", true);
s(o, h, D, "⋅", "\\cdot", true);
...
s(o, h, D, "∩", "\\cap", true);
s(o, h, D, "∪", "\\cup", true);
s(o, h, D, "∖", "\\setminus", true);
s(o, h, D, "∧", "\\land");
s(o, h, D, "∨", "\\lor");
s(o, h, D, "∧", "\\wedge", true);
s(o, h, D, "∨", "\\vee", true);
s(o, h, b, "√", "\\surd");
s(o, h, N0, "⟨", "\\langle", true);
s(o, h, N0, "∣", "\\lvert");
s(o, h, N0, "∥", "\\lVert");
s(o, h, z0, "?", "?");
s(o, h, z0, "!", "!");
s(o, h, z0, "⟩", "\\rangle", true);
s(o, h, z0, "∣", "\\rvert");
s(o, h, z0, "∥", "\\rVert");
s(o, h, v, "=", "=");
s(o, h, v, ":", ":");
...
s(o, h, v, "⊂", "\\subset", true);
s(o, h, v, "⊃", "\\supset", true);
s(o, h, v, "⊆", "\\subseteq", true);
s(o, h, v, "⊇", "\\supseteq", true);
s(o, p, v, "⊈", "\\nsubseteq", true);
s(o, p, v, "⊉", "\\nsupseteq", true);
s(o, h, v, "⊨", "\\models");
s(o, h, v, "←", "\\leftarrow", true);
...
s(o, h, N0, "{", "\\lbrace");
s(o, h, z0, "}", "\\rbrace");
s(o, h, N0, "[", "\\lbrack", true);
s(S, h, b, "[", "\\lbrack", true);
s(o, h, z0, "]", "\\rbrack", true);
s(S, h, b, "]", "\\rbrack", true);
s(o, h, N0, "(", "\\lparen", true);
s(o, h, z0, ")", "\\rparen", true);
s(S, h, b, "<", "\\textless", true);
s(S, h, b, ">", "\\textgreater", true);
s(o, h, N0, "⌊", "\\lfloor", true);
s(o, h, z0, "⌋", "\\rfloor", true);
s(o, h, N0, "⌈", "\\lceil", true);
s(o, h, z0, "⌉", "\\rceil", true);
s(o, h, b, "\\", "\\backslash");
s(o, h, b, "∣", "|");
...
s(o, h, v, "↑", "\\uparrow", true);
s(o, h, v, "⇑", "\\Uparrow", true);
s(o, h, v, "↓", "\\downarrow", true);
s(o, h, v, "⇓", "\\Downarrow", true);
s(o, h, v, "↕", "\\updownarrow", true);
s(o, h, v, "⇕", "\\Updownarrow", true);
s(o, h, v0, "∐", "\\coprod");
s(o, h, v0, "⋁", "\\bigvee");
s(o, h, v0, "⋀", "\\bigwedge");
...
s(o, h, b, "°", "\\degree", true);
s(S, h, b, "°", "\\degree");
s(S, h, b, "°", "\\textdegree", true);
s(o, h, b, "£", "\\pounds");
s(o, h, b, "£", "\\mathsterling", true);
s(S, h, b, "£", "\\pounds");
s(S, h, b, "£", "\\textsterling", true);
s(o, p, b, "✠", "\\maltese");
s(S, p, b, "✠", "\\maltese");
var za = "0123456789/@.\"";
...
var ht = [["mathbf", "textbf", "Main-Bold"], ["mathbf", "textbf", "Main-Bold"], ["mathnormal", "textit", "Math-Italic"], ["mathnormal", "textit", "Math-Italic"], ["boldsymbol", "boldsymbol", "Main-BoldItalic"], ["boldsymbol", "boldsymbol", "Main-BoldItalic"], ["mathscr", "textscr", "Script-Regular"], ["", "", ""], ["", "", ""], ["", "", ""], ["mathfrak", "textfrak", "Fraktur-Regular"], ["mathfrak", "textfrak", "Fraktur-Regular"], ["mathbb", "textbb", "AMS-Regular"], ["mathbb", "textbb", "AMS-Regular"], ["mathboldfrak", "textboldfrak", "Fraktur-Regular"], ["mathboldfrak", "textboldfrak", "Fraktur-Regular"], ["mathsf", "textsf", "SansSerif-Regular"], ["mathsf", "textsf", "SansSerif-Regular"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathitsf", "textitsf", "SansSerif-Italic"], ["mathitsf", "textitsf", "SansSerif-Italic"], ["", "", ""], ["", "", ""], ["mathtt", "texttt", "Typewriter-Regular"], ["mathtt", "texttt", "Typewriter-Regular"]];
var Da = [["mathbf", "textbf", "Main-Bold"], ["", "", ""], ["mathsf", "textsf", "SansSerif-Regular"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathtt", "texttt", "Typewriter-Regular"]];
var sl = (r, e) => {
  var t = r.charCodeAt(0);
  var a = r.charCodeAt(1);
  var n = (t - 55296) * 1024 + (a - 56320) + 65536;
  var i = e === "math" ? 0 : 1;
  if (n >= 119808 && n < 120484) {
    var l = Math.floor((n - 119808) / 26);
    return [ht[l][2], ht[l][i]];
  } else if (n >= 120782 && n <= 120831) {
    var u = Math.floor((n - 120782) / 10);
    return [Da[u][2], Da[u][i]];
  } else {
    if (n === 120485 || n === 120486) {
      return [ht[0][2], ht[0][i]];
    }
    if (n > 120486 && n < 120782) {
      return ["", ""];
    }
...
function A0(e, t, a, n, i) {
  ...
  if (u) {
    var d = u.italic;
    if (a === "text" || n && n.font === "mathit") {
      d = 0;
    }
    c = new R0(e, u.height, u.depth, d, u.skew, u.width, i);
  } else {
    if (typeof console !== "undefined") {
      console.warn("No character metrics " + ("for '" + e + "' in style '" + t + "' and mode '" + a + "'"));
    }
...
function Wr(e, t, a, n = []) {
  if (a.font === "boldsymbol" && Nt(e, "Main-Bold", t).metrics) {
    return A0(e, "Main-Bold", t, a, n.concat(["mathbf"]));
  } else if (e === "\\" || n0[t][e].font === "main") {
    return A0(e, "Main-Regular", t, a, n);
  } else {
    return A0(e, "AMS-Regular", t, a, n.concat(["amsrm"]));
  }
}
function ll(e, t, a, n, i) {
  if (i !== "textord" && Nt(e, "Math-BoldItalic", t).metrics) {
    return {
...
function qt(e, t, a) {
  ...
  var i = e.text;
  var l = ["mord"];
  var u = n === "math" || n === "text" && t.font;
  var c = u ? t.font : t.fontFamily;
  var d = "";
  var f = "";
  ...
  if (c) {
    ...
    if (c === "boldsymbol") {
      ...
      g = mt(c, t.fontWeight, t.fontShape);
      y = [c, t.fontWeight, t.fontShape];
    }
    if (Nt(i, g, n).metrics) {
      return A0(i, g, n, t, l.concat(y));
    }
    if (Nn.hasOwnProperty(i) && g.slice(0, 10) === "Typewriter") {
      var w = [];
      for (var T = 0; T < i.length; T++) {
        w.push(A0(i[T], g, n, t, l.concat(y)));
      }
      return ue(w);
    }
  }
  if (a === "mathord") {
    return A0(i, "Math-Italic", n, t, l.concat(["mathnormal"]));
  }
  if (a === "textord") {
...
var ol = (r, e) => {
  if (fe(r.classes) !== fe(e.classes) || r.skew !== e.skew || r.maxFontSize !== e.maxFontSize || r.italic !== 0 && r.hasClass("mathnormal")) {
    return false;
  }
...
var qn = r => {
  for (var e = 0; e < r.length - 1; e++) {
    var t = r[e];
    var a = r[e + 1];
    if (t instanceof R0 && a instanceof R0 && ol(t, a)) {
      t.text += a.text;
...
function cl(e) {
  if (e.positionType === "individualShift") {
    for (var t = e.children, a = [t[0]], n = -t[0].shift - t[0].elem.depth, i = n, l = 1; l < t.length; l++) {
      ...
      var c = u - (t[l - 1].elem.height + t[l - 1].elem.depth);
      i = i + u;
      a.push({
        type: "kern",
        size: c
...
function _(e, t) {
  ...
  for (var w = 0; w < a.length; w++) {
    ...
    if (T.type === "kern") {
      ...
      var B = T.elem;
      var C = T.wrapperClasses || [];
      var N = T.wrapperStyle || {};
      var q = k(C, [d, B], undefined, N);
      q.style.top = z(-i - x - B.depth);
      if (T.marginLeft) {
        q.style.marginLeft = T.marginLeft;
      }
      if (T.marginRight) {
        q.style.marginRight = T.marginRight;
      }
      f.push(q);
      x += B.height + B.depth;
    }
...
function On(e, t) {
  ...
  var u = new se([l], {
    ...
    height: z(i),
    style: "width:" + z(n),
    viewBox: "0 0 " + n * 1000 + " " + i * 1000,
    preserveAspectRatio: "xMinYMin"
  });
  var c = ve(["overlay"], [u], t);
  c.height = i;
  c.style.height = z(i);
  c.style.width = z(n);
  return c;
...
var dl = new Set(["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"]);
var fl = new Set(["rightmost", "mrel", "mclose", "mpunct"]);
var pl = {
  display: F.DISPLAY,
  text: F.TEXT,
  script: F.SCRIPT,
...
function y0(e, t, a, n = [null, null]) {
  ...
  if (e.length === 1) {
    ...
    } else if (f.type === "styling") {
      d = t.havingStyle(pl[f.style]);
    }
  }
  var g = k([n[0] || "leftmost"], [], t);
  var y = k([n[1] || "rightmost"], [], t);
  var x = a === "root";
  zr(i, (w, T) => {
    var B = T.classes[0];
    var C = w.classes[0];
  ...
  zr(i, (w, T) => {
    ...
    var N = Cr(T);
    var q = Cr(w);
    var O = N && q ? w.hasClass("mtight") ? (B = ml[N]) == null ? undefined : B[q] : (C = hl[N]) == null ? undefined : C[q] : null;
    if (O) {
      return Ln(O, d);
    }
  }, {
...
function Pn(e) {
  if (e instanceof We || e instanceof Rt || e instanceof je && e.hasClass("enclosing")) {
    return e;
  } else {
    return null;
  }
...
function dt(r, e) {
  ...
  if (t.depth) {
    a.style.verticalAlign = z(-t.depth);
  }
...
function Er(r, e) {
  ...
  for (var u = 0; u < a.length; u++) {
    l.push(a[u]);
    if (a[u].hasClass("mbin") || a[u].hasClass("mrel") || a[u].hasClass("allowbreak")) {
      var c = false;
      for (; u < a.length - 1 && a[u + 1].hasClass("mspace") && !a[u + 1].hasClass("newline");) {
        u++;
        l.push(a[u]);
        if (a[u].hasClass("nobreak")) {
          c = true;
        }
      }
      if (!c) {
  ...
  if (d) {
    ...
    if (f.depth) {
      g.style.verticalAlign = z(-f.depth);
    }
  }
  return f;
}
...
class M {
  ...
  toMarkup() {
    ...
    for (var t in this.attributes) {
      if (Object.prototype.hasOwnProperty.call(this.attributes, t)) {
        e += " " + t + "=\"";
        e += S0(this.attributes[t]);
        e += "\"";
      }
    }
    if (this.classes.length > 0) {
      e += " class =\"" + S0(fe(this.classes)) + "\"";
    }
    e += ">";
    for (var a = 0; a < this.children.length; a++) {
      e += this.children[a].toMarkup();
...
class Gn {
  ...
  toNode() {
    ...
    e.setAttribute("width", z(this.width));
    return e;
  }
  toMarkup() {
    if (this.character) {
      ...
      return "<mspace width=\"" + z(this.width) + "\"/>";
    }
  }
  toText() {
    if (this.character) {
...
var bl = new Set(["mrow", "mtable"]);
function $0(e, t, a) {
  if (n0[t][e] && n0[t][e].replace && e.charCodeAt(0) !== 55349 && (!Nn.hasOwnProperty(e) || !a || (!a.fontFamily || a.fontFamily.slice(4, 6) !== "tt") && (!a.font || a.font.slice(4, 6) !== "tt"))) {
    e = n0[t][e].replace;
  }
  return new p0(e);
}
  ...
  for (var u = 0; u < e.length; u++) {
    ...
    if (c instanceof M && l instanceof M) {
      if (c.type === "mtext" && l.type === "mtext" && c.getAttribute("mathvariant") === l.getAttribute("mathvariant")) {
        ...
        c.children = [...l.children, ...c.children];
        i.pop();
      } else if ((c.type === "msup" || c.type === "msub") && c.children.length >= 1 && (l.type === "mn" || lr(l))) {
        var d = c.children[0];
        if (d instanceof M && d.type === "mn") {
          d.children = [...l.children, ...d.children];
          i.pop();
        }
      } else if (l.type === "mi" && l.children.length === 1) {
        var f = l.children[0];
        if (f instanceof p0 && f.text === "̸" && (c.type === "mo" || c.type === "mi" || c.type === "mn")) {
          var g = c.children[0];
          if (g instanceof p0 && g.text.length > 0) {
...
function Ia(r, e, t, a, n) {
  var i = q0(r, t);
  var l;
  if (i.length === 1 && i[0] instanceof M && bl.has(i[0].type)) {
    l = i[0];
  } else {
    l = new M("mrow", i);
  }
  ...
  if (a) {
    d.setAttribute("display", "block");
  }
  var f = n ? "katex" : "katex-mathml";
  return k([f], [d]);
}
var yl = [[1, 1, 1], [2, 1, 1], [3, 1, 1], [4, 2, 1], [5, 2, 1], [6, 3, 1], [7, 4, 2], [8, 6, 3], [9, 7, 6], [10, 8, 7], [11, 10, 9]];
var Ra = [0.5, 0.6, 0.7, 0.8, 0.9, 1, 1.2, 1.44, 1.728, 2.074, 2.488];
function Na(e, t) {
  if (t.size < 2) {
    return e;
  } else {
    return yl[e - 1][t.size - 1];
  }
}
class ne {
  constructor(e) {
  ...
  havingBaseStyle(e) {
    ...
    if (this.size === t && this.textSize === ne.BASESIZE && this.style === e) {
      return this;
    } else {
      return this.extend({
        style: e,
  ...
  baseSizingClasses() {
    if (this.size !== ne.BASESIZE) {
      return ["sizing", "reset-size" + this.size, "size" + ne.BASESIZE];
    } else {
      return [];
    }
  }
  fontMetrics() {
    this._fontMetrics ||= al(this.size);
...
function xl(e, t, a) {
  ...
  var i;
  if (a.output === "mathml") {
    return Ia(e, t, n, a.displayMode, true);
  }
  if (a.output === "html") {
    var l = Er(e, n);
    i = k(["katex"], [l]);
  } else {
    var u = Ia(e, t, n, a.displayMode, false);
    var c = Er(e, n);
    i = k(["katex"], [u, c]);
  }
  return jn(i, a);
...
var Tl = new Set(["widehat", "widecheck", "widetilde", "utilde"]);
function Ht(e, t) {
  function a() {
    var u = 400000;
    var c = e.label.slice(1);
    if (Tl.has(c)) {
      var d = e;
      var f = d.base.type === "ordgroup" ? d.base.body.length : 1;
      var g;
      var y;
      var x;
      if (f > 5) {
        if (c === "widehat" || c === "widecheck") {
          g = 420;
          u = 2364;
          x = 0.42;
          y = c + "4";
  ...
  n.style.height = z(l);
  if (i > 0) {
    n.style.minWidth = z(i);
  }
  return n;
}
function Al(e, t, a, n, i) {
  var l;
  var u = e.height + e.depth + a + n;
...
function Ft(r) {
  if (r && (r.type === "atom" || il.hasOwnProperty(r.type))) {
    return r;
  } else {
    return null;
  }
...
var Un = r => {
  ...
  if (tl(r) && r.children.length === 1) {
    return Un(r.children[0]);
  }
};
var Vr = (r, e) => {
  var t;
  ...
  var l = a.isShifty && le(t);
  var u = 0;
  if (l) {
    var d;
    u = ((d = Un(i)) == null ? undefined : d.skew) ?? 0;
  }
  var f = a.label === "\\c";
  var g = f ? i.height + i.depth : Math.min(i.height, e.fontMetrics().xHeight);
  var y;
  if (a.isStretchy) {
    y = Ht(a, e);
    y = _({
...
var Xn = (r, e) => {
  ...
  var a = new M("mover", [r0(r.base, e), t]);
  a.setAttribute("accent", "true");
  return a;
};
var Ml = new RegExp(["\\acute", "\\grave", "\\ddot", "\\tilde", "\\bar", "\\breve", "\\check", "\\hat", "\\vec", "\\dot", "\\mathring"].map(r => "\\" + r).join("|"));
E({
  type: "accent",
  ...
  handler: (r, e) => {
    var t = Mt(e[0]);
    var a = !Ml.test(r.funcName);
    var n = !a || r.funcName === "\\widehat" || r.funcName === "\\widetilde" || r.funcName === "\\widecheck";
    return {
      type: "accent",
      mode: r.parser.mode,
      label: r.funcName,
...
E({
  ...
  handler: (r, e) => {
    ...
    var a = r.parser.mode;
    if (a === "math") {
      r.parser.settings.reportNonstrict("mathVsTextAccents", "LaTeX's accent " + r.funcName + " works only in text mode");
      a = "text";
    }
    return {
      type: "accent",
...
E({
  ...
  mathmlBuilder: (r, e) => {
    var t = Lt(r.label);
    var a = new M("munder", [r0(r.base, e), t]);
...
E({
  ...
  htmlBuilder(r, e) {
    var t = e.style;
    var a = e.havingStyle(t.sup());
    var n = Pe(e0(r.body, a, e), e);
    var i = r.label.slice(0, 2) === "\\x" ? "x" : "cd";
    ...
    var u = Ht(r, e);
    var c = -e.fontMetrics().axisHeight + u.height * 0.5;
    var d = -e.fontMetrics().axisHeight - u.height * 0.5 - 0.111;
    if (n.depth > 0.25 || r.label === "\\xleftequilibrium") {
      d -= n.depth;
    }
    var f;
    if (l) {
      var g = -e.fontMetrics().axisHeight + l.height + u.height * 0.5 + 0.111;
      f = _({
...
function Yn(r, e) {
  ...
  if (r.mclass === "minner") {
    ...
    } else if (r.mclass === "mpunct") {
      t.attributes.lspace = "0em";
      t.attributes.rspace = "0.17em";
    } else if (r.mclass === "mopen" || r.mclass === "mclose") {
      t.attributes.lspace = "0em";
      t.attributes.rspace = "0em";
    } else if (r.mclass === "minner") {
...
var Pt = r => {
  ...
  if (e.type === "atom" && (e.family === "bin" || e.family === "rel")) {
    return "m" + e.family;
  } else {
    return "mord";
  }
...
E({
  ...
  htmlBuilder(r, e) {
    var t = y0(r.body, e, true);
    var a = k([r.mclass], t, e);
    a.style.textShadow = "0.02em 0.01em 0.04px";
    return a;
  },
  mathmlBuilder(r, e) {
    var t = q0(r.body, e);
    var a = new M("mstyle", t);
...
var La = r => r.type === "textord" && r.text === "@";
var Bl = (r, e) => (r.type === "mathord" || r.type === "atom") && r.text === e;
function Cl(r, e, t) {
  var a = zl[r];
  switch (a) {
    case "\\\\cdrightarrow":
    ...
    case "\\downarrow":
      {
        ...
        var l = t.callFunction("\\Big", [i], []);
        var u = t.callFunction("\\\\cdright", [e[1]], []);
        var c = {
          type: "ordgroup",
          mode: "math",
          body: [n, l, u]
...
function El(r) {
  ...
  r.gullet.beginGroup();
  while (true) {
    e.push(r.parseExpression(false, "\\\\"));
    r.gullet.endGroup();
    r.gullet.beginGroup();
    var t = r.fetch().text;
    if (t === "&" || t === "\\\\") {
        ...
        if (!"=|.".includes(d)) {
          if ("<>AV".includes(d)) {
            for (var g = 0; g < 2; g++) {
              ...
              if (y) {
                throw new A("Missing a " + d + " character to complete a CD arrow.", l[c]);
              }
            }
          } else {
            throw new A("Expected one of \"<>AV=|.\" after @", l[c]);
          }
        }
        var w = Cl(d, f, r);
        var T = {
...
var Kn = (r, e) => {
  var t = y0(r.body, e.withColor(r.color), false);
  return ue(t);
};
var Zn = (r, e) => {
  var t = q0(r.body, e.withColor(r.color));
  var a = new M("mstyle", t);
  a.setAttribute("mathcolor", r.color);
  return a;
};
E({
  type: "color",
...
E({
  ...
  htmlBuilder(r, e) {
    ...
    if (r.newLine) {
      ...
      if (r.size) {
        t.style.marginTop = z(o0(r.size, e));
      }
    }
    return t;
  },
  mathmlBuilder(r, e) {
    ...
    if (r.newLine) {
      ...
      if (r.size) {
        t.setAttribute("height", z(o0(r.size, e)));
      }
    }
    return t;
  }
...
E({
  ...
  handler(r) {
    ...
    var a = e.fetch();
    if (Dr[a.text]) {
      if (t === "\\global" || t === "\\\\globallong") {
        a.text = Dr[a.text];
      }
      return j(e.parseFunction(), "internal");
    }
...
E({
  ...
  handler(r) {
    ...
    var a = Jn(e.gullet.popToken());
    e.gullet.consumeSpaces();
    var n = Dl(e);
    Qn(e, a, n, t === "\\\\globallet");
    return {
      type: "internal",
      mode: e.mode
    };
...
E({
  ...
  handler(r) {
    ...
    var a = Jn(e.gullet.popToken());
    var n = e.gullet.popToken();
    var i = e.gullet.popToken();
...
function Yr(e, t, a, n) {
  ...
  var l = k(n.concat(i.sizingClasses(a)), [e], a);
  var u = i.sizeMultiplier / a.sizeMultiplier;
  l.height *= u;
  l.depth *= u;
...
function _n(e, t, a) {
  ...
  var i = (1 - t.sizeMultiplier / n.sizeMultiplier) * t.fontMetrics().axisHeight;
  e.classes.push("delimcenter");
  e.style.top = z(i);
  e.height -= i;
  e.depth += i;
}
function Il(e, t, a, n, i, l) {
...
function ei(e, t, a, n, i, l) {
  var u = Rl(e, t, i, n);
  var c = Yr(k(["delimsizing", "size" + t], [u], n), F.TEXT, n, l);
  if (a) {
    _n(c, n, F.TEXT);
  }
  return c;
...
function ur(e, t, a) {
  ...
  var i = new pe("inner", Vs(e, Math.round(t * 1000)));
  var l = new se([i], {
    width: z(n),
    height: z(t),
    style: "width:" + z(n),
    viewBox: "0 0 " + n * 1000 + " " + Math.round(t * 1000),
    preserveAspectRatio: "xMinYMin"
  });
  var u = ve([], [l], a);
  u.height = t;
...
var Nl = new Set(["|", "\\lvert", "\\rvert", "\\vert"]);
var ql = new Set(["\\|", "\\lVert", "\\rVert", "\\Vert"]);
function ti(e, t, a, n, i, l) {
  var u;
  var c;
  var d;
  var f;
  ...
  var w = Je(u, x, i);
  var T = w.height + w.depth;
  var B = Je(d, x, i);
  var C = B.height + B.depth;
  var N = Je(f, x, i);
  var q = N.height + N.depth;
  var O = 0;
  var $ = 1;
  if (c !== null) {
    var P = Je(c, x, i);
  ...
  var U = T + q + O;
  var X = Math.max(0, Math.ceil((t - U) / ($ * C)));
  var G = U + X * $ * C;
  var J = n.fontMetrics().axisHeight;
  if (a) {
    J *= n.sizeMultiplier;
  }
  var Z = G / 2 - J;
  ...
  if (g.length > 0) {
    var x0 = G - T - q;
    var t0 = Math.round(G * 1000);
    var c0 = Ys(g, Math.round(x0 * 1000));
    var d0 = new pe(g, c0);
    var a0 = z(y / 1000);
    var w0 = z(t0 / 1000);
    var J0 = new se([d0], {
...
function Ll(e, t) {
  ...
  var n = si("\\surd", e * a.sizeMultiplier, ii, a);
  var i = a.sizeMultiplier;
  var l = Math.max(0, t.minRuleThickness - t.fontMetrics().sqrtRuleThickness);
  var u;
  var c = 0;
  var d = 0;
  var f = 0;
...
var ri = new Set(["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "⌊", "⌋", "\\lceil", "\\rceil", "⌈", "⌉", "\\surd"]);
var Hl = new Set(["\\uparrow", "\\downarrow", "\\updownarrow", "\\Uparrow", "\\Downarrow", "\\Updownarrow", "|", "\\|", "\\vert", "\\Vert", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "⟮", "⟯", "\\lmoustache", "\\rmoustache", "⎰", "⎱"]);
var ai = new Set(["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"]);
var Qe = [0, 1.2, 1.8, 2.4, 3];
function ni(e, t, a, n, i) {
  if (e === "<" || e === "\\lt" || e === "⟨") {
    e = "\\langle";
  } else if (e === ">" || e === "\\gt" || e === "⟩") {
    e = "\\rangle";
  }
  if (ri.has(e) || ai.has(e)) {
    return ei(e, t, false, a, n, i);
  }
  if (Hl.has(e)) {
    return ti(e, Qe[t], false, a, n, i);
  }
...
function Rr(e, t, a, n, i, l) {
  ...
  var c = si(e, t, u, n);
  if (c.type === "small") {
    return Il(e, c.style, a, n, i, l);
  } else if (c.type === "large") {
    return ei(e, c.size, a, n, i, l);
  } else {
    return ti(e, t, a, n, i, l);
  }
}
function dr(e, t, a, n, i, l) {
  var u = n.fontMetrics().axisHeight * n.sizeMultiplier;
  var c = 901;
  var d = 5 / n.fontMetrics().ptPerEm;
  var f = Math.max(t - u, a + u);
  var g = Math.max(f / 500 * c, f * 2 - d);
  return Rr(e, g, true, n, i, l);
}
var Ha = {
  "\\bigl": {
    mclass: "mopen",
...
var $l = new Set(["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "⌊", "⌋", "\\lceil", "\\rceil", "⌈", "⌉", "<", ">", "\\langle", "⟨", "\\rangle", "⟩", "\\lt", "\\gt", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "⟮", "⟯", "\\lmoustache", "\\rmoustache", "⎰", "⎱", "/", "\\backslash", "|", "\\vert", "\\|", "\\Vert", "\\uparrow", "\\Uparrow", "\\downarrow", "\\Downarrow", "\\updownarrow", "\\Updownarrow", "."]);
function $t(r, e) {
  var t = Ft(r);
  if (t && $l.has(t.text)) {
    return t;
...
E({
  ...
  htmlBuilder: (r, e) => r.delim === "." ? k([r.mclass]) : ni(r.delim, r.size, e, r.mode, [r.mclass]),
  mathmlBuilder: r => {
    var e = [];
    if (r.delim !== ".") {
      e.push($0(r.delim, r.mode));
    }
    var t = new M("mo", e);
    if (r.mclass === "mopen" || r.mclass === "mclose") {
...
E({
  ...
  htmlBuilder: (r, e) => {
    Oa(r);
    for (var t = y0(r.body, e, true, ["mopen", "mclose"]), a = 0, n = 0, i = false, l = 0; l < t.length; l++) {
      if (t[l].isMiddle) {
        i = true;
      } else {
        a = Math.max(t[l].height, a);
        n = Math.max(t[l].depth, n);
      }
    }
    a *= e.sizeMultiplier;
    n *= e.sizeMultiplier;
    ...
    if (r.left === ".") {
      ...
      u = dr(r.left, a, n, e, r.mode, ["mopen"]);
    }
    t.unshift(u);
    if (i) {
      for (var c = 1; c < t.length; c++) {
        ...
        var f = d.isMiddle;
        if (f) {
          t[c] = dr(f.delim, a, n, f.options, r.mode, []);
        }
      }
    }
    var g;
  ...
  mathmlBuilder: (r, e) => {
    ...
    if (r.right !== ".") {
      ...
      if (r.rightColor) {
        n.setAttribute("mathcolor", r.rightColor);
      }
      t.push(n);
    }
    return Ur(t);
...
var Gt = (r, e) => {
  ...
  var a = r.label.slice(1);
  var n = e.sizeMultiplier;
  var i;
  var l = 0;
  var u = le(r.body);
  if (a === "sout") {
    ...
    var f = e.havingBaseSizing();
    n = n / f.sizeMultiplier;
    var g = t.height + t.depth + c + d;
    t.style.paddingLeft = z(g / 2 + c);
    var y = Math.floor(g * 1000 * n);
    var x = js(y);
    var w = new se([new pe("phase", x)], {
      width: "400em",
      height: z(y / 1000),
    ...
    if (/fbox|boxed|fcolorbox/.test(a)) {
      ...
      i.style.borderWidth = z(C);
    } else if (a === "angl" && C !== 0.049) {
      i.style.borderTopWidth = z(C);
      i.style.borderRightWidth = z(C);
    }
    l = t.depth + B;
    if (r.backgroundColor) {
      i.style.backgroundColor = r.backgroundColor;
      if (r.borderColor) {
        i.style.borderColor = r.borderColor;
      }
    }
  }
  var N;
...
var Wt = (r, e) => {
  var t = 0;
  var a = new M(r.label.includes("colorbox") ? "mpadded" : "menclose", [r0(r.body, e)]);
  switch (r.label) {
    case "\\cancel":
    ...
    case "\\colorbox":
      ...
      a.setAttribute("width", "+" + t * 2 + "pt");
      a.setAttribute("height", "+" + t * 2 + "pt");
      a.setAttribute("lspace", t + "pt");
      a.setAttribute("voffset", t + "pt");
      if (r.label === "\\fcolorbox") {
  ...
  if (r.backgroundColor) {
    a.setAttribute("mathbackground", r.backgroundColor);
  }
  return a;
};
E({
  ...
  static range(e, t) {
    if (t) {
      if (!e || !e.loc || !t.loc || e.loc.lexer !== t.loc.lexer) {
        ...
        return new B0(e.loc.lexer, e.loc.start, t.loc.end);
      }
    } else {
      return e && e.loc;
    }
...
function be(r, e, t) {
  ...
  var B = [];
  var C = [];
  var N = c != null ? [] : undefined;
  function q() {
    if (c) {
      r.gullet.macros.set("\\@eqnsw", "1", true);
    }
  }
  function O() {
    if (N) {
      if (r.gullet.macros.get("\\df@tag")) {
        N.push(r.subparse([new I0("\\df@tag")]));
        r.gullet.macros.set("\\df@tag", undefined, true);
      } else {
  ...
  C.push(Fa(r));
  while (true) {
    var $ = r.parseExpression(false, d ? "\\end" : "\\\\");
    r.gullet.endGroup();
    r.gullet.beginGroup();
    var P = {
      type: "ordgroup",
    ...
    if (U === "&") {
      ...
      O();
      if (w.length === 1 && P.type === "styling" && P.body.length === 1 && P.body[0].type === "ordgroup" && P.body[0].body.length === 0 && (T.length > 1 || !f)) {
        T.pop();
      }
...
function K0(e, t) {
  ...
  var n;
  var i = e.body.length;
  var l = e.hLinesBeforeRow;
  var u = 0;
  var c = new Array(i);
  var d = [];
  var f = Math.max(t.fontMetrics().arrayRuleWidth, t.minRuleThickness);
  var g = 1 / t.fontMetrics().ptPerEm;
  var y = g * 5;
  if (e.colSeparationType && e.colSeparationType === "small") {
    var x = t.havingStyle(F.SCRIPT).sizeMultiplier;
    y = x / t.sizeMultiplier * 0.2778;
  }
  var w = e.colSeparationType === "CD" ? o0({
    number: 3,
    unit: "ex"
  }, t) : g * 12;
  var T = g * 3;
  var B = e.arraystretch * w;
  var C = B * 0.7;
  var N = B * 0.3;
  var q = 0;
  function O(te) {
  ...
  n = 0;
  d0 = 0;
  for (; n < u || d0 < x0.length; ++n, ++d0) {
    var Q0;
    for (var h0 = x0[d0], _0 = true; ((ye = h0) == null ? undefined : ye.type) === "separator";) {
      var ye;
      if (!_0) {
        c0 = k(["arraycolsep"], []);
      ...
      if (h0.separator === "|" || h0.separator === ":") {
        var Ve = h0.separator === "|" ? "solid" : "dashed";
        var E0 = k(["vertical-separator"], [], t);
        E0.style.height = z(q);
        ...
        var Ce = q - V;
        if (Ce) {
          E0.style.verticalAlign = z(-Ce);
        }
        t0.push(E0);
      } else {
        throw new A("Invalid separator type: " + h0.separator);
      }
      d0++;
      h0 = x0[d0];
      _0 = false;
    ...
    if (!(n >= u)) {
      ...
      if (n > 0 || e.hskipBeforeAndAfter) {
        var De;
        H0 = ((De = h0) == null ? undefined : De.pregap) ?? y;
        if (H0 !== 0) {
          c0 = k(["arraycolsep"], []);
          c0.style.width = z(H0);
          t0.push(c0);
      ...
      var m0 = k(["col-align-" + (((Q0 = h0) == null ? undefined : Q0.align) || "c")], [D0]);
      t0.push(m0);
      if (n < u - 1 || e.hskipBeforeAndAfter) {
        var F0;
        H0 = ((F0 = h0) == null ? undefined : F0.postgap) ?? y;
        if (H0 !== 0) {
          c0 = k(["arraycolsep"], []);
          c0.style.width = z(H0);
          t0.push(c0);
...
function Z0(e, t) {
  var a = [];
  var n = new M("mtd", [], ["mtr-glue"]);
  var i = new M("mtd", [], ["mml-eqn-num"]);
  for (var l = 0; l < e.body.length; l++) {
    for (var u = e.body[l], c = [], d = 0; d < u.length; d++) {
      c.push(new M("mtd", [r0(u[d], t)]));
    }
    if (e.tags && e.tags[l]) {
      c.unshift(n);
      c.push(n);
  ...
  var g = e.arraystretch === 0.5 ? 0.1 : 0.16 + e.arraystretch - 1 + (e.addJot ? 0.09 : 0);
  ...
  if (e.cols && e.cols.length > 0) {
    ...
    var C = 0;
    var N = w.length;
    if (w[0].type === "separator") {
      y += "top ";
      C = 1;
    }
    if (w[w.length - 1].type === "separator") {
      y += "bottom ";
      N -= 1;
    }
    for (var q = C; q < N; q++) {
      ...
      if (O.type === "align") {
        ...
        B = true;
      } else if (O.type === "separator" && B) {
        T += O.separator === "|" ? "solid " : "dashed ";
        B = false;
      }
    }
    f.setAttribute("columnalign", x.trim());
    if (/[sd]/.test(T)) {
      f.setAttribute("columnlines", T.trim());
    }
  }
  if (e.colSeparationType === "align") {
    for (var $ = e.cols || [], P = "", U = 1; U < $.length; U++) {
      P += U % 2 ? "0em " : "1em ";
    }
  ...
  var X = "";
  var G = e.hLinesBeforeRow;
  y += G[0].length > 0 ? "left " : "";
  y += G[G.length - 1].length > 0 ? "right " : "";
  for (var J = 1; J < G.length - 1; J++) {
    X += G[J].length === 0 ? "none " : G[J][0] ? "dashed " : "solid ";
  }
  if (/[sd]/.test(X)) {
    f.setAttribute("rowlines", X.trim());
  }
  if (y !== "") {
    f = new M("menclose", [f]);
    f.setAttribute("notation", y.trim());
  }
...
function ui(e, t) {
  if (!e.envName.includes("ed")) {
    jt(e);
  }
  var a = [];
  var n = e.envName.includes("at") ? "alignat" : "align";
  var i = e.envName === "split";
  var l = be(e.parser, {
    cols: a,
    addJot: true,
    autoTag: i ? undefined : Kr(e.envName),
    emptySingleRow: true,
    colSeparationType: n,
  ...
  if (t[0] && t[0].type === "ordgroup") {
    var f = "";
    for (var g = 0; g < t[0].body.length; g++) {
  ...
  l.colSeparationType = x ? "align" : "alignat";
  return l;
}
Y0({
  type: "array",
  ...
  handler(r, e) {
    var t = Ft(e[0]);
    var a = t ? [e[0]] : j(e[0], "ordgroup").body;
...
Y0({
  ...
  handler(r) {
    ...
    var l = Math.max(0, ...i.body.map(u => u.length));
    i.cols = new Array(l).fill({
      type: "align",
      align: t
    });
    if (e) {
...
Y0({
  ...
  handler(r) {
    ...
    var t = be(r.parser, e, Zr(r.envName));
    return {
      type: "leftright",
      mode: r.mode,
      body: [t],
...
E({
  ...
  handler(r, e) {
    ...
    var i = "";
    for (var l = 0; l < n.body.length; ++l) {
      i += j(n.body[l], "textord").text;
    }
    if (a === "\\begin") {
      if (!Pa.hasOwnProperty(i)) {
        throw new A("No such environment: " + i, n);
      }
      var u = Pa[i];
      var {
        args: c,
      ...
      var g = u.handler(f, c, d);
      t.expect("\\end", false);
      var y = t.nextToken;
      var x = j(t.parseFunction(), "environment");
      if (x.name !== i) {
...
E({
  ...
  handler: (r, e) => {
    ...
    var l = t.parseExpression(true, n);
    var u = "math" + a.slice(1);
    return {
      type: "font",
      mode: i,
      font: u,
...
var jl = (r, e) => {
  ...
  if (r.continued) {
    ...
    var c = 3.5 / e.fontMetrics().ptPerEm;
    l.height = l.height < u ? u : l.height;
    l.depth = l.depth < c ? c : l.depth;
  }
  i = e.havingStyle(n);
  ...
  if (r.hasBarLine) {
    ...
    f = null;
    g = 0;
    y = e.fontMetrics().defaultRuleThickness;
  }
  var x;
  var w;
  var T;
  if (t.size === F.DISPLAY.size) {
    ...
    if (g > 0) {
      x = e.fontMetrics().num2;
      w = y;
    } else {
      x = e.fontMetrics().num3;
      w = y * 3;
    }
  ...
  if (f) {
    ...
    if (x - l.depth - (N + g * 0.5) < w) {
      x += w - (x - l.depth - (N + g * 0.5));
    }
    if (N - g * 0.5 - (d.height - T) < w) {
      T += w - (N - g * 0.5 - (d.height - T));
    }
    var q = -(N - g * 0.5);
    B = _({
      positionType: "individualShift",
  ...
  } else if (t.size === F.SCRIPTSCRIPT.size) {
  ...
  if (r.leftDelim == null) {
    ...
    $ = Rr(r.leftDelim, O, true, e.havingStyle(t), r.mode, ["mopen"]);
  }
  if (r.continued) {
    P = k([]);
  } else if (r.rightDelim == null) {
    P = tt(e, ["mclose"]);
  } else {
    P = Rr(r.rightDelim, O, true, e.havingStyle(t), r.mode, ["mclose"]);
  }
  return k(["mord"].concat(i.sizingClasses(e)), [$, k(["mfrac"], [B]), P], e);
};
var Ul = (r, e) => {
...
E({
  ...
  handler(r, e) {
    ...
    var n = e[5];
    var i = Mt(e[0]);
    var l = i.type === "atom" && i.family === "open" ? Wa(i.text) : null;
    var u = Mt(e[1]);
    var c = u.type === "atom" && u.family === "close" ? Wa(u.text) : null;
    var d = j(e[2], "size");
    var f;
    var g = null;
    if (d.isBlank) {
...
E({
  ...
  handler: (r, e) => {
    ...
    if (t.settings.isTrusted({
      ...
      return t.formatUnsupportedCmd("\\href");
    }
  },
  htmlBuilder: (r, e) => {
    var t = y0(r.body, e, false);
...
E({
  ...
  handler: (r, e) => {
      ...
      case "\\htmlData":
        {
          for (var d = i.split(","), f = 0; f < d.length; f++) {
            ...
            var y = g.indexOf("=");
            if (y < 0) {
              throw new A("\\htmlData key/value '" + g + "' missing equals sign");
            }
            var x = g.slice(0, y);
            var w = g.slice(y + 1);
            c["data-" + x.trim()] = w;
    ...
    if (t.settings.isTrusted(u)) {
      ...
      return t.formatUnsupportedCmd(a);
    }
  },
  htmlBuilder: (r, e) => {
    var t = y0(r.body, e, false);
    var a = ["enclosing"];
    if (r.attributes.class) {
      a.push(...r.attributes.class.trim().split(/\s+/));
    }
    var n = k(a, t, e);
    for (var i in r.attributes) {
      if (i !== "class" && r.attributes.hasOwnProperty(i)) {
...
E({
  ...
  htmlBuilder: (r, e) => {
    var t = o0(r.height, e);
    var a = 0;
    if (r.totalheight.number > 0) {
      a = o0(r.totalheight, e) - t;
    }
    var n = 0;
    if (r.width.number > 0) {
      n = o0(r.width, e);
  ...
  mathmlBuilder: (r, e) => {
    ...
    var n = 0;
    if (r.totalheight.number > 0) {
      n = o0(r.totalheight, e) - a;
      t.setAttribute("valign", z(-n));
    }
...
E({
  ...
  handler(r, e) {
    ...
    if (t.settings.strict) {
      var i = a[1] === "m";
      var l = n.value.unit === "mu";
      if (i) {
        if (!l) {
          t.settings.reportNonstrict("mathVsTextUnits", "LaTeX's " + a + " supports only mu units, " + ("not " + n.value.unit + " units"));
        }
        if (t.mode !== "math") {
          t.settings.reportNonstrict("mathVsTextUnits", "LaTeX's " + a + " works only in math mode");
        }
      } else if (l) {
        t.settings.reportNonstrict("mathVsTextUnits", "LaTeX's " + a + " doesn't support mu units");
      }
    }
    return {
      type: "kern",
...
E({
  ...
  htmlBuilder: (r, e) => {
    ...
    var a = k(["fix"], []);
    var n = k([r.alignment], [t, a], e);
    var i = k(["strut"]);
    i.style.height = z(n.height + n.depth);
    if (n.depth) {
      i.style.verticalAlign = z(-n.depth);
    }
    n.children.unshift(i);
    n = k(["thinbox"], [n], e);
    return k(["mord", "vbox"], [n], e);
  },
  mathmlBuilder: (r, e) => {
...
E({
  ...
  handler(r, e) {
    ...
    a.switchMode("math");
    var i = t === "\\(" ? "\\)" : "$";
    var l = a.parseExpression(false, i);
    a.expect(i);
    a.switchMode(n);
    return {
      type: "styling",
...
var fi = (r, e, t, a, n, i, l) => {
  ...
  if (c && i !== 0 && !u) {
    var C = k(["mspace"], [], a);
    C.style.marginRight = z(i);
    B.unshift(C);
  }
  return k(["mop", "op-limits"], B, a);
};
var pi = new Set(["\\smallint"]);
var Xe = (r, e) => {
  var t;
  var a;
  var n = false;
  ...
  var l = e.style;
  var u = false;
  if (l.size === F.DISPLAY.size && i.symbol && !pi.has(i.name)) {
    u = true;
  }
  var c;
  if (i.symbol) {
    ...
    var x = y0(i.body, e, true);
    if (x.length === 1 && x[0] instanceof R0) {
      c = x[0];
      c.classes[0] = "mop";
    } else {
      c = k(["mop"], x, e);
    ...
    var w = [];
    for (var T = 1; T < i.name.length; T++) {
      w.push(Wr(i.name[T], i.mode, e));
    }
    c = k(["mop"], w, e);
  }
  var B = 0;
  var C = 0;
  if ((c instanceof R0 || i.name === "\\oiint" || i.name === "\\oiiint") && !i.suppressBaseShift) {
    B = (c.height - c.depth) / 2 - e.fontMetrics().axisHeight;
    C = c.italic || 0;
  }
  if (n) {
    return fi(c, t, a, e, l, C, B);
  } else {
    if (B) {
...
var it = (r, e) => {
  ...
  if (r.symbol) {
    ...
    if (pi.has(r.name)) {
      t.setAttribute("largeop", "false");
    }
  } else if (r.body) {
    t = new M("mo", q0(r.body, e));
  } else {
...
var vi = (r, e) => {
  ...
  if (i.body.length > 0) {
    var u = i.body.map(g => {
      var y = "text" in g ? g.text : undefined;
      if (typeof y == "string") {
        return {
          type: "textord",
          mode: g.mode,
    ...
    for (var c = y0(u, e.withFont("mathrm"), true), d = 0; d < c.length; d++) {
      var f = c[d];
      if (f instanceof R0) {
  ...
  if (n) {
    return fi(l, t, a, e, e.style, 0, 0);
  } else {
    return l;
  }
};
var Kl = (r, e) => {
  for (var t = q0(r.body, e.withFont("mathrm")), a = true, n = 0; n < t.length; n++) {
    var i = t[n];
    if (!(i instanceof Gn)) {
      if (i instanceof M) {
        switch (i.type) {
          ...
          case "mo":
            {
              var l = i.children[0];
              if (i.children.length === 1 && l instanceof p0) {
...
Be({
  ...
  htmlBuilder(r, e) {
    if (r.semisimple) {
      return ue(y0(r.body, e, false));
    } else {
      return k(["mord"], y0(r.body, e, true), e);
    }
  },
  mathmlBuilder(r, e) {
    return ge(r.body, e, true);
  }
});
E({
  type: "overline",
...
E({
  ...
  htmlBuilder: (r, e) => {
    var t = y0(r.body, e.withPhantom(), false);
    return ue(t);
  },
  mathmlBuilder: (r, e) => {
    var t = q0(r.body, e);
...
E({
  ...
  mathmlBuilder: (r, e) => {
    ...
    var a = new M("mphantom", t);
    var n = new M("mpadded", [a]);
...
E({
  ...
  mathmlBuilder(r, e) {
    var t = new M("mpadded", [r0(r.body, e)]);
    var a = r.dy.number + r.dy.unit;
    t.setAttribute("voffset", a);
    return t;
  }
});
E({
...
E({
  ...
  mathmlBuilder(r, e) {
    var t = o0(r.width, e);
    var a = o0(r.height, e);
    var n = r.shift ? o0(r.shift, e) : 0;
    var i = e.color && e.getColor() || "black";
    var l = new M("mspace");
...
function gi(r, e, t) {
  for (var a = y0(r, e, false), n = e.sizeMultiplier / t.sizeMultiplier, i = 0; i < a.length; i++) {
    var l = a[i].classes.indexOf("sizing");
    if (l < 0) {
      Array.prototype.push.apply(a[i].classes, e.sizingClasses(t));
    } else if (a[i].classes[l + 1] === "reset-size" + e.size) {
...
E({
  ...
  handler: (r, e) => {
    ...
    var i = n.parseExpression(false, t);
    return {
      type: "sizing",
      mode: n.mode,
      size: Ua.indexOf(a) + 1,
  ...
  mathmlBuilder: (r, e) => {
    var t = e.havingSize(r.size);
    var a = q0(r.body, t);
    var n = new M("mstyle", a);
    n.setAttribute("mathsize", z(t.sizeMultiplier));
    return n;
  }
});
E({
...
E({
  ...
  htmlBuilder(r, e) {
    var t = e0(r.body, e.havingCrampedStyle());
    if (t.height === 0) {
      t.height = e.fontMetrics().xHeight;
    }
    t = Pe(t, e);
    var a = e.fontMetrics();
    var n = a.defaultRuleThickness;
    var i = n;
    if (e.style.id < F.TEXT.id) {
      i = e.fontMetrics().xHeight;
    }
    var l = n + i / 4;
    var u = t.height + t.depth + l + n;
    var {
      span: c,
      ruleWidth: d,
      advanceWidth: f
    ...
    var g = c.height - d;
    if (g > t.height + t.depth + l) {
      l = (l + g - t.height - t.depth) / 2;
    }
    ...
    if (r.index) {
      ...
      var T = e0(r.index, w, e);
      var B = (x.height - x.depth) * 0.6;
      var C = _({
        positionType: "shift",
        positionData: -B,
        children: [{
  ...
  mathmlBuilder(r, e) {
    ...
    if (a) {
      return new M("mroot", [r0(t, e), r0(a, e)]);
    } else {
      return new M("msqrt", [r0(t, e)]);
    }
  }
});
var Xa = {
...
E({
  ...
  handler(r, e) {
    ...
    var i = n.parseExpression(true, t);
    var l = a.slice(1, a.length - 5);
    return {
      type: "styling",
      mode: n.mode,
      style: l,
  ...
  htmlBuilder(r, e) {
    var t = Xa[r.style];
    var a = e.havingStyle(t).withFont("");
    return gi(r.body, a, e);
  },
  mathmlBuilder(r, e) {
    var t = Xa[r.style];
    var a = e.havingStyle(t);
    var n = q0(r.body, a);
    var i = new M("mstyle", n);
    var l = {
      display: ["0", "true"],
      text: ["0", "false"],
      script: ["1", "false"],
...
Be({
  ...
  htmlBuilder(r, e) {
    ...
    if (n) {
      ...
      u = e0(n, x, e);
      if (!y) {
        f = l.height - x.fontMetrics().supDrop * x.sizeMultiplier / e.sizeMultiplier;
      }
    }
    if (i) {
      ...
      c = e0(i, w, e);
      if (!y) {
        g = l.depth + w.fontMetrics().subDrop * w.sizeMultiplier / e.sizeMultiplier;
      }
    }
    var T;
    if (e.style === F.DISPLAY) {
      T = d.sup1;
    } else if (e.style.cramped) {
      T = d.sup3;
    } else {
      T = d.sup2;
    }
    var B = e.sizeMultiplier;
    var C = z(0.5 / d.ptPerEm / B);
    var N = null;
    if (c) {
      var q = r.base && r.base.type === "op" && r.base.name && (r.base.name === "\\oiint" || r.base.name === "\\oiiint");
      if (l instanceof R0 || q) {
        N = z(-l.italic);
      }
    }
    var O;
    if (u && c) {
      f = Math.max(f, T, u.depth + d.xHeight * 0.25);
      g = Math.max(g, d.sub2);
      var $ = d.defaultRuleThickness;
      var P = $ * 4;
      if (f - u.depth - (c.height - g) < P) {
        g = P - (f - u.depth) + c.height;
        var U = d.xHeight * 0.8 - (f - u.depth);
        if (U > 0) {
          f += U;
          g -= U;
        }
      ...
      g = Math.max(g, d.sub1, c.height - d.xHeight * 0.8);
      var G = [{
        type: "elem",
        elem: c,
        marginLeft: N,
  ...
  mathmlBuilder(r, e) {
    ...
    var a;
    var n;
    if (r.base && r.base.type === "horizBrace") {
      n = !!r.sup;
      if (n === r.base.isOver) {
        t = true;
        a = r.base.isOver;
    ...
    if (r.base && (r.base.type === "op" || r.base.type === "operatorname")) {
      r.base.parentIsSupSub = true;
    }
    var i = [r0(r.base, e)];
    if (r.sub) {
      i.push(r0(r.sub, e));
    ...
    if (t) {
      ...
      if (r.sup) {
        var d = r.base;
        if (d && d.type === "op" && d.limits && e.style === F.DISPLAY || d && d.type === "operatorname" && d.alwaysHandleSupSub && (e.style === F.DISPLAY || d.limits)) {
          l = "munderover";
        } else {
          l = "msubsup";
        }
        ...
        var c = r.base;
        if (c && c.type === "op" && c.limits && (e.style === F.DISPLAY || c.alwaysHandleSupSub) || c && c.type === "operatorname" && c.alwaysHandleSupSub && (c.limits || e.style === F.DISPLAY)) {
          l = "munder";
        } else {
          l = "msub";
        }
      ...
      var u = r.base;
      if (u && u.type === "op" && u.limits && (e.style === F.DISPLAY || u.alwaysHandleSupSub) || u && u.type === "operatorname" && u.alwaysHandleSupSub && (u.limits || e.style === F.DISPLAY)) {
        l = "mover";
      } else {
        l = "msup";
      }
...
Be({
  ...
  mathmlBuilder(r, e) {
    ...
    if (r.family === "bin") {
      var a = Xr(r, e);
      if (a === "bold-italic") {
        t.setAttribute("mathvariant", a);
      }
    } else if (r.family === "punct") {
      t.setAttribute("separator", "true");
    } else if (r.family === "open" || r.family === "close") {
...
Be({
  ...
  mathmlBuilder(r, e) {
    ...
    if (r.mode === "text") {
      n = new M("mtext", [t]);
    } else if (/[0-9]/.test(r.text)) {
      n = new M("mn", [t]);
    } else if (r.text === "\\prime") {
      n = new M("mo", [t]);
    } else {
      n = new M("mi", [t]);
    }
  ...
  htmlBuilder(r, e) {
    if (vr.hasOwnProperty(r.text)) {
      ...
      if (r.mode === "text") {
        ...
        return k(["mspace", t], [Wr(r.text, r.mode, e)], e);
      }
    } else {
      if (pr.hasOwnProperty(r.text)) {
        return k(["mspace", pr[r.text]], [], e);
      }
...
Be({
  type: "tag",
  mathmlBuilder(r, e) {
    var t = new M("mtable", [new M("mtr", [Va(), new M("mtd", [ge(r.body, e)]), Va(), new M("mtd", [ge(r.tag, e)])])]);
...
var Za = (r, e) => {
  ...
  if (t) {
    if (Ya[t]) {
      return e.withTextFontFamily(Ya[t]);
    }
    if (Ka[t]) {
    ...
    if (t === "\\emph") {
      if (e.fontShape === "textit") {
        return e.withTextFontShape("textup");
      } else {
        return e.withTextFontShape("textit");
      }
    }
  } else {
    return e;
...
E({
  ...
  htmlBuilder(r, e) {
    ...
    var n = (t.height - a - (t.depth + a)) * 0.5;
    return _({
      positionType: "shift",
      positionData: n,
      children: [{
...
var Ja = r => r.body.replace(/ /g, r.star ? "␣" : "\xA0");
var me = Fn;
var yi = `[ \r
	]`;
var _l = "\\\\[a-zA-Z@]+";
...
?)[ \r	]*`;
var Nr = "[̀-ͯ]";
var ao = new RegExp(Nr + "+$");
var no = "(" + yi + "+)|" + (ro + "|") + "([!-\\[\\]-‧‪-퟿豈-￿]" + (Nr + "*") + "|[\uD800-\uDBFF][\uDC00-\uDFFF]" + (Nr + "*") + "|\\\\verb\\*([^]).*?\\4|\\\\verb([^*a-zA-Z]).*?\\5" + ("|" + to) + ("|" + eo + ")");
class Qa {
  constructor(e, t) {
    this.input = e;
    this.settings = t;
  ...
  lex() {
    ...
    if (t === e.length) {
      return new I0("EOF", new B0(this, t, t));
    }
...
m("\\@ifnextchar", function (r) {
  ...
  r.consumeSpaces();
  var t = r.future();
  if (e[0].length === 1 && e[0][0].text === t.text) {
    return {
      tokens: e[1],
      numArgs: 0
    };
...
m("\\char", function (r) {
  ...
  if (t) {
    ...
    for (var n; (n = _a[r.future().text]) != null && n < t;) {
      a *= t;
      a += n;
      r.popToken();
    }
...
var Jr = (r, e, t, a) => {
  ...
  if (n.length === 1 && n[0].text === "[") {
    var c = "";
    for (var d = r.expandNextToken(); d.text !== "]" && d.text !== "EOF";) {
      c += d.text;
      d = r.expandNextToken();
    }
    if (!c.match(/^\s*[0-9]+\s*$/)) {
      throw new A("Invalid number of arguments: " + c);
    }
    u = parseInt(c);
    n = r.consumeArg().tokens;
  }
...
m("\\newcommand", r => Jr(r, false, true, false));
m("\\renewcommand", r => Jr(r, true, false, false));
m("\\providecommand", r => Jr(r, true, true, true));
m("\\message", r => {
  var e = r.consumeArgs(1)[0];
  console.log(e.reverse().map(t => t.text).join(""));
  return "";
});
m("\\errmessage", r => {
  var e = r.consumeArgs(1)[0];
  console.error(e.reverse().map(t => t.text).join(""));
  return "";
});
m("\\show", r => {
  var e = r.popToken();
  var t = e.text;
  console.log(e, r.macros.get(t), me[t], n0.math[t], n0.text[t]);
  return "";
});
m("\\bgroup", "{");
m("\\egroup", "}");
...
var lo = new Set(["bin", "rel"]);
m("\\dots", function (r) {
  var e = "\\dotso";
  var t = r.expandAfterFuture().text;
  if (t in en) {
    e = en[t];
...
var xi = z(X0["Main-Regular"][84][1] - X0["Main-Regular"][65][1] * 0.7);
m("\\LaTeX", "\\textrm{\\html@mathml{" + ("L\\kern-.36em\\raisebox{" + xi + "}{\\scriptstyle A}") + "\\kern-.15em\\TeX}{LaTeX}}");
m("\\KaTeX", "\\textrm{\\html@mathml{" + ("K\\kern-.17em\\raisebox{" + xi + "}{\\scriptstyle A}") + "\\kern-.15em\\TeX}{KaTeX}}");
...
var wi = r => e => {
  ...
  e.macros.set("|", c(false));
  if (n.length) {
    e.macros.set("\\|", c(true));
  }
  var d = e.consumeArg().tokens;
  var f = e.expandTokens([...i, ...d, ...t]);
  e.macros.endGroup();
  return {
    tokens: f.reverse(),
    numArgs: 0
...
class oo {
  ...
  scanArgument(e) {
    ...
    this.pushToken(new I0("EOF", a.loc));
    this.pushTokens(n);
    return new I0("", B0.range(t, a));
  }
  consumeSpaces() {
    while (true) {
      var e = this.future();
  ...
  consumeArg(e) {
    ...
    do {
      ...
      if (i.text === "{") {
        ...
        throw new A("Unexpected end of input in a macro argument, expected '" + (e && a ? e[u] : "}") + "'", i);
      }
      if (e && a) {
  ...
  expandOnce(e) {
    var t = this.popToken();
    var a = t.text;
    var n = t.noexpand ? null : this._getExpansion(a);
    ...
    var i = n.tokens;
    var l = this.consumeArgs(n.numArgs, n.delimiters);
    if (n.numArgs) {
      i = i.slice();
  ...
  expandMacro(e) {
    if (this.macros.has(e)) {
      return this.expandTokens([new I0(e)]);
    } else {
      return undefined;
    }
  }
  ...
  _getExpansion(e) {
    ...
    if (typeof n == "string") {
      ...
      var u = new Qa(n, this.settings);
      var c = [];
      for (var d = u.lex(); d.text !== "EOF";) {
        c.push(d);
        d = u.lex();
      }
      c.reverse();
  ...
  isDefined(e) {
    return this.macros.has(e) || me.hasOwnProperty(e) || n0.math.hasOwnProperty(e) || n0.text.hasOwnProperty(e) || Si.hasOwnProperty(e);
  }
  isExpandable(e) {
    var t = this.macros.get(e);
    if (t != null) {
      ...
      return me.hasOwnProperty(e) && !me[e].primitive;
    }
  }
}
...
class Ut {
  ...
  parseExpression(e, t) {
    ...
    for (;;) {
      ...
      var n = this.fetch();
      if (Ut.endOfExpression.has(n.text) || t && n.text === t || e && me[n.text] && me[n.text].infix) {
        break;
      }
    ...
    return this.handleInfixNodes(a);
  }
  handleInfixNodes(e) {
    var t = -1;
    var a;
    ...
    if (t !== -1 && a) {
      ...
      var c = e.slice(0, t);
      var d = e.slice(t + 1);
      if (c.length === 1 && c[0].type === "ordgroup") {
        l = c[0];
      } else {
        l = {
          type: "ordgroup",
  ...
  handleSupSubscript(e) {
    ...
    do {
      var i;
      n = this.parseGroup(e);
    } while (((i = n) == null ? undefined : i.type) === "internal");
    if (!n) {
  ...
  parseAtom(e) {
    ...
    if ((t == null ? undefined : t.type) === "internal" || this.mode === "text") {
      return t;
    }
    var a;
    var n;
  ...
  parseArguments(e, t) {
    ...
    for (var l = 0; l < a; l++) {
      ...
      var c = l < t.numOptionalArgs;
      if ("primitive" in t && t.primitive && u == null || t.type === "sqrt" && l === 1 && i[0] == null) {
        u = "primitive";
      }
  ...
  parseStringGroup(e, t) {
    ...
    var n = "";
    for (var i; (i = this.fetch()).text !== "EOF";) {
      n += i.text;
      this.consume();
    }
    this.consume();
  ...
  parseRegexGroup(e, t) {
    var a = this.fetch();
    var n = a;
    for (var i = "", l; (l = this.fetch()).text !== "EOF" && e.test(i + l.text);) {
      n = l;
      i += n.text;
      this.consume();
    }
  ...
  parseSizeGroup(e) {
    ...
    if (!En(i)) {
      throw new A("Invalid unit: '" + i.unit + "'", t);
    }
    return {
      type: "size",
      mode: this.mode,
  ...
  parseGroup(e, t) {
    ...
    if (n === "{" || n === "\\begingroup") {
      ...
      var l = n === "{" ? "}" : "\\endgroup";
      this.gullet.beginGroup();
      var u = this.parseExpression(false, l);
      var c = this.fetch();
      this.expect(l);
      this.gullet.endGroup();
      i = {
      ...
      if (i == null && n[0] === "\\" && !Si.hasOwnProperty(n)) {
        if (this.settings.throwOnError) {
          throw new A("Undefined control sequence: " + n, a);
        }
        i = this.formatUnsupportedCmd(n);
        this.consume();
      }
    }
    return i;
    ...
    for (var t = e.length - 1, a = 0; a < t; ++a) {
      ...
      if (n.type === "textord") {
        ...
        if (!!l && l.type === "textord") {
          if (i === "-" && l.text === "-") {
            var u = e[a + 2];
            if (a + 1 < t && u && u.type === "textord" && u.text === "-") {
              e.splice(a, 3, {
                type: "textord",
                mode: "text",
                loc: B0.range(n, u),
  ...
  parseSymbol() {
    ...
    if (/^\\verb[^a-zA-Z]/.test(t)) {
      ...
      if (a.length < 2 || a.charAt(0) !== a.slice(-1)) {
    ...
    if (rn.hasOwnProperty(t[0]) && !n0[this.mode][t[0]]) {
    ...
    var l;
    if (n0[this.mode][t]) {
      if (this.settings.strict && this.mode === "math" && Ar.includes(t)) {
...
function go(r) {
  ...
  return function (t, a) {
    b1(t, "element", function (n, i) {
      ...
      const u = l.includes("language-math");
      const c = l.includes("math-display");
      const d = l.includes("math-inline");
      let f = c;
      if (!u && !c && !d) {
        return;
      }
      let g = i[i.length - 1];
      let y = n;
      if (n.tagName === "code" && u && g && g.type === "element" && g.tagName === "pre") {
        y = g;
        g = i[i.length - 2];
        f = true;
      }
      ...
      g.children.splice(T, 1, ...w);
      return y1;
    });
  };
}
const bo = /(^|[^\\])%.*$/gm;
const yo = /\\(?:(?:re)?newcommand|providecommand)\*?/g;
const xo = /\\DeclareMathOperator(\*)?/g;
const nn = /[A-Za-z]/;
const Ai = /^\\(?:[A-Za-z]+|.)$/;
const wo = r => r.replace(bo, "$1");
const So = (r, e) => {
  let t = 0;
  for (let a = e - 1; a >= 0 && r[a] === "\\"; a -= 1) {
    t += 1;
  }
  return t % 2 === 1;
};
...
const To = (r, e) => {
  for (const t of r.matchAll(yo)) {
    ...
    let n = a.endIndex;
    const i = sn(r, n);
    if (i && (n = i.endIndex, sn(r, n))) {
      continue;
    }
    const l = Xt(r, n);
    const u = Vt(r, l, "{", "}");
    if (u) {
      e[a.name] = u.value.trim();
    }
  }
};
const Ao = (r, e) => {
  for (const t of r.matchAll(xo)) {
    const a = t[1] === "*";
    const n = Mi(r, t.index + t[0].length);
    if (!n) {
      continue;
    }
    ...
    const l = Vt(r, i, "{", "}");
    if (l) {
      e[n.name] = `\\operatorname${a ? "*" : ""}{${l.value.trim()}}`;
    }
  }
};
const br = r => {
...
const I4 = r => {
  ...
  return r.map(t => {
    ...
    if (t.quote) {
      Object.assign(e, br(t.quote.text));
    }
    if (t.reasoning) {
      Object.assign(e, br(t.reasoning));
    }
    return {
      ...e
    };
...
const rt = (r, e) => {
  const t = /\r\n|\n|\r(?!\n)/.exec(r.slice(e));
  if (t) {
    return e + t.index + t[0].length;
  } else {
    return r.length;
  }
};
const zi = (r, e) => Math.max(r.lastIndexOf(`
`, e - 1), r.lastIndexOf("\r", e - 1)) + 1;
const Bi = (r, e) => r.startsWith(`\r
`, e) ? 2 : r[e] === "\r" || r[e] === `
` ? 1 : 0;
const ta = r => {
  let e = r;
...
const Ci = r => {
  ...
  if (t) {
    return t[1].length + t[2].length + Math.min(Ge(t[3]), 4);
  } else {
    return null;
  }
};
...
const Mo = ["align", "align*", "alignat", "alignat*", "aligned", "alignedat", "array", "Bmatrix", "Bmatrix*", "bmatrix", "bmatrix*", "cases", "CD", "darray", "dcases", "drcases", "equation", "equation*", "gather", "gather*", "gathered", "matrix", "matrix*", "pmatrix", "pmatrix*", "rcases", "smallmatrix", "split", "subarray", "vmatrix", "vmatrix*", "Vmatrix", "Vmatrix*"];
const Ei = Mo.map(r => r.replace("*", "\\*")).join("|");
const zo = new RegExp(`\\\\(begin|end)\\{(${Ei})\\}`, "g");
const ln = new RegExp(`^((?: {0,3}>[ \\t]?)*(?:[ \\t]*(?:[-+*]|\\d{1,9}[.)])[ \\t]+|[ \\t]*))\\\\begin\\{(${Ei})\\}`, "gm");
const Bo = /(?:\r\n|\n|\r(?!\n))(?: {0,3}>[ \t]?)*[ \t]*(?:\r\n|\n|\r(?!\n))/;
const Di = /^(?:\r\n|\n|\r(?!\n))(?: {0,3}>[ \t]?)*[ \t]*(?:\r\n|\n|\r(?!\n))/;
const aa = (r, e) => r[e] === "$" ? ra(r, e, "$") : 0;
const Ii = (r, e) => !j0(r, e) && ["\\(", "\\)", "\\[", "\\]"].some(t => r.startsWith(t, e));
const Ri = (r, e, t) => {
  const a = t.length;
  let n = e;
  while (n < r.length) {
...
const Ni = (r, e, t) => {
  ...
  while (a < r.length) {
    const n = Bi(r, a);
    if (n > 0) {
      if (t !== "\\]" || Di.test(r.slice(a))) {
        return -1;
      }
      a += n;
      continue;
    }
    if (r.startsWith(t, a) && !j0(r, a)) {
      return a;
    }
    if (Ii(r, a) || r[a] === "$" && !j0(r, a)) {
      return -1;
    }
    a += 1;
  }
...
const Eo = (r, e, t, a, {
  ...
  for (const c of r.matchAll(i)) {
    if (c.index < t || Co(r, c.index)) {
      continue;
    }
    if (n && Bo.test(r.slice(u, c.index))) {
      return null;
    }
    const d = c[1];
    const f = c[2];
...
const Io = (r, e, t) => {
  ...
  const n = a.content.match(/^([ \t]*)(?:[-+*]|\d{1,9}[.)])[ \t]+$/);
  const i = Ge((n == null ? undefined : n[1]) ?? a.content);
  const l = t.get(e) ?? null;
  return i <= 3 || l !== null && i >= l && i < l + 4;
};
const Ro = (r, e) => {
  let t = 0;
  let a = 0;
  while (t < r.length && a < e) {
    if (r[t] === " ") {
      a += 1;
    } else if (r[t] === "\t") {
      a += 4 - a % 4;
...
const Hi = (r, e, t) => {
  ...
  for (const l of r.matchAll(a)) {
    const u = Do(l[1]);
    if (!u || !Io(u, l.index, t) || l.index < i || e.some(d => l.index < d.end && d.start < l.index + l[0].length)) {
      continue;
    }
    const c = Eo(r, l[2], l.index + l[0].length, zo, {
...
const qo = (r, e) => {
  ...
  while (a < r.length) {
    const n = qi(r, a);
    if (!n || n.opening !== "$$" && n.opening !== "\\[" || e.some(c => a < c.end && c.start < a + n.opening.length)) {
      a += 1;
      continue;
    }
    const i = a + n.opening.length;
    const l = n.opening === "$$" ? Ri(r, i, "$$") : Ni(r, i, "\\]");
    if (l === -1) {
      a += n.opening.length;
      continue;
    }
...
const qr = r => $e(r).trim().length === 0;
const Fo = r => {
  const e = $e(r).trimEnd();
  return /^ {0,3}#{1,6}(?:[ \t]+|$)/.test(e) || /^ {0,3}(?:(?:\*[ \t]*){3,}|(?:_[ \t]*){3,}|(?:-[ \t]*){3,})$/.test(e) || /^ {0,3}=+[ \t]*$/.test(e);
};
const Po = (r, e, t) => {
  if (t <= e) {
    return null;
...
const on = (r, e, t, a) => {
  ...
  while (i < t) {
    ...
    const u = r.slice(i, l);
    const c = Po(r, e, i);
    const d = c === null || qr(r.slice(c.start, c.end)) || Fo(r.slice(c.start, c.end));
    const g = (a.get(i) ?? null ?? 0) + 4;
    if (!d || Ge($e(u)) < g) {
      i = l;
      continue;
    }
...
const Wo = (r, {
  protectLinkReferenceDefinitions: e = true
} = {}) => {
  var n;
  const t = [];
  let a = 0;
...
` || d === "\r") {
  ...
  if (e) {
    for (const i of r.matchAll(/^(?: {0,3}>[ \t]*)* {0,3}\[[^\]\r\n]+\]:[ \t]*(?:<[^>\r\n]*>|[^\s\r\n]+)[^\r\n]*$/gm)) {
      const l = i[0].indexOf("]:") + 2;
      const u = i.index + l;
      const c = ((n = i[0].slice(l).match(/^[ \t]*/)) == null ? undefined : n[0].length) ?? 0;
      t.push({
        start: u + c,
...
const jo = (r, {
  protectStandaloneHtmlTags: e = true
...
const un = (r, e, t, a = {}) => zt([...Go(r, e, t), ...Wo(r.slice(e, t), a).map(n => ({
  start: e + n.start,
  end: e + n.end
})), ...jo(r.slice(e, t), a).map(n => ({
  start: e + n.start,
  end: e + n.end
}))]);
const Fi = (r, e = {}) => {
  ...
  let i = 0;
  for (const f of t) {
    n.push(...un(r, i, f.start, e));
    i = f.end;
  }
  n.push(...un(r, i, r.length, e));
  const l = [...t, ...n];
  const u = [...Hi(r, l, a), ...qo(r, l)];
  const c = [...t];
  i = 0;
  for (const f of t) {
    c.push(...on(r, i, f.start, a).filter(g => !u.some(y => y.start <= g.start && g.end <= y.end)));
    i = f.end;
  }
  c.push(...on(r, i, r.length, a).filter(f => !u.some(g => g.start <= f.start && f.end <= g.end)));
...
const Uo = (r, e) => {
  ...
  const l = u => {
    a.push(u);
    const c = Math.max(u.lastIndexOf(`
`), u.lastIndexOf("\r"));
    i = c === -1 ? `${i}${u}` : u.slice(c + 1);
  };
  for (const u of t) {
    l(e(r.slice(n, u.start), {
      leadingLinePrefix: i
    }));
...
const Xo = (r, e) => Uo(r, t => {
  const a = Li(t);
  if (a.valid) {
    return a.segments.map(n => n.kind !== "math" || n.openingDelimiter !== "$" && n.openingDelimiter !== "$$" ? n.kind === "text" ? n.value : `${n.openingDelimiter}${n.body}${n.closingDelimiter}` : `${n.openingDelimiter}${e(n.body, n.openingDelimiter)}${n.closingDelimiter}`).join("");
  } else {
    return t;
  }
});
...
const Yo = (r, e = {}) => {
  const t = Fi(r, e);
  const a = Vo(r, t);
  const n = Hi(r, [...t, ...a], Oi(r));
  const i = zt([...a, ...n]);
  return {
    mathRanges: i,
    protectedRanges: zt([...t, ...i])
  };
};
const N4 = (r, e, t = {}) => {
  const {
  ...
  if (d.includes(n) || d.includes(i)) {
    throw new Error("Markdown prose transformation corrupted a protected marker.");
  }
  return d;
};
const Ko = "application/x-tex";
const Zo = "katex-error";
const cn = "\\htmlData";
const Jo = "highlight-id=";
const Qo = /[\p{L}\p{N}_]/u;
const gt = /[A-Za-z]/;
const _o = /\\[A-Za-z]+/;
const e4 = {
  "\\alpha": "α",
...
const r4 = (r, e) => r.trim().replace(/[^A-Za-z0-9_-]+/g, "-") || `highlight-${e}`;
const de = r => !!r && !!Qo.test(r);
const hn = (r, e) => {
  let t = 0;
  for (let a = e - 1; a >= 0 && r[a] === "\\"; a -= 1) {
    t += 1;
...
const mn = (r, e) => {
  if (!r.startsWith(cn, e)) {
    return null;
  }
  const t = Lr(r, e + cn.length);
  if (t == null || !t.content.startsWith(Jo)) {
    return null;
  }
...
const xt = r => {
  ...
  while (t < r.length) {
    ...
    if (n) {
      ...
      if ((i == null ? undefined : i.endIndex) === n.content.length) {
        e += i.content;
        t = n.endIndex;
        continue;
      }
...
const Pi = r => r.replace(/\\(?:left|right)/g, "").trim();
const _e = (r, e) => {
  const t = e.trim();
  if (!!t && t !== "$") {
    r.add(t);
...
const a4 = r => {
  const e = Pi(na(r));
  const t = new Set();
  const a = [e, e.replace(/([_^])([A-Za-z0-9])/g, "$1{$2}"), e.replace(/([_^])\{([A-Za-z0-9])\}/g, "$1$2")];
  for (const n of a) {
    _e(t, n);
    _e(t, n.replace(/\s+/g, ""));
  }
...
const n4 = r => {
  let e = Pi(na(r)).replace(/\\(?:mathbb|mathcal|mathrm|mathbf|mathfrak|mathsf|operatorname)\{([^{}]+)\}/g, "$1").replace(/\\[A-Za-z]+/g, t => e4[t] ?? t);
  if (_o.test(e)) {
    return null;
  } else {
...
const i4 = r => {
  ...
  const a = t !== r.trim();
  const n = n4(t);
  if (n && (!a || Array.from(n).length > 1)) {
    _e(e, n);
    _e(e, n.replace(/\s+/g, ""));
  }
  if (!t.includes("\\") && t === r.trim()) {
    _e(e, t);
  }
  return [...e];
};
const dn = r => [...r].sort((e, t) => t.term.length - e.term.length || e.term.localeCompare(t.term));
const q4 = r => {
  const e = new Set();
  const t = new Map();
  const a = [];
...
const l4 = (r, e, t) => {
  const a = r[e - 1];
  const n = r[e + t.length];
  const i = t.length === 1 && gt.test(t);
  if (t.startsWith("\\")) {
    return !gt.test(n ?? "");
  } else if (a === "\\") {
    return false;
  } else if (i) {
    return !gt.test(a ?? "") && !gt.test(n ?? "");
  } else {
    return (!de(t[0]) || !de(a)) && (!de(t[t.length - 1]) || !de(n));
  }
};
const $i = (r, e, t, a) => t.find(({
  term: n
}) => r.startsWith(n, e) && a(r, e, n));
const o4 = (r, e) => `{\\htmlData{highlight-id=${r}}{${e}}}`;
const u4 = (r, e) => {
  if (e.length === 0) {
    return r;
  }
...
const L4 = (r, e) => e.length === 0 ? r : Xo(r, t => u4(t, e));
const Gi = r => {
  var t;
  const e = (t = r.properties) == null ? undefined : t.className;
  if (Array.isArray(e)) {
    return e.map(String);
...
const c4 = r => {
  var a;
  var n;
  const e = (a = r.properties) == null ? undefined : a.dataHighlightId;
  const t = (n = r.properties) == null ? undefined : n["data-highlight-id"];
  if (typeof e == "string") {
    return e;
...
const h4 = r => {
  ...
  const t = Gi(r);
  return !!c4(r) || e === "a" || e === "annotation" || e === "code" || e === "math" || e === "pre" || e === "script" || e === "style" || e === "textarea" || t.includes("katex-mathml");
};
const m4 = (r, e) => ({
  type: "element",
  tagName: "span",
...
const Hr = r => r.children.map(e => e.type === "text" ? e.value : e.type === "element" ? Hr(e) : "").join("");
const p4 = r => {
  var e;
  return r.tagName.toLowerCase() === "annotation" && ((e = r.properties) == null ? undefined : e.encoding) === Ko;
};
const v4 = r => Gi(r).includes(Zo);
const g4 = () => r => {
  const e = t => {
    var a;
    for (const n of t) {
      if (n.type === "element") {
        ...
        if (v4(n)) {
          const i = xt(Hr(n));
          const l = (a = n.properties) == null ? undefined : a.title;
          n.children = [{
            type: "text",
            value: i
          }];
          if (typeof l == "string") {
            n.properties.title = xt(l);
          }
          continue;
        }
        e(n.children);
...
const b4 = (r, e) => ({
  ...e,
  strict: (t, a, n) => t === "htmlExtension" ? "ignore" : typeof e.strict == "function" ? e.strict(t, a, n) : e.strict,
  trust: t => {
    if (t.command !== "\\htmlData") {
      if (typeof e.trust == "function") {
        return e.trust(t);
      } else {
        return e.trust === true;
      }
    ...
    const n = a["data-highlight-id"];
    return Object.keys(a).length === 1 && typeof n == "string" && r.has(n);
  }
});
const H4 = (r, e, t = {}) => r.allowedHighlightIds.size === 0 ? e : [[go, b4(r.allowedHighlightIds, t)], g4, f4(r.textTerms)];
const y4 = r => typeof r.dataHighlightId == "string" ? r.dataHighlightId : typeof r["data-highlight-id"] == "string" ? r["data-highlight-id"] : null;
const O4 = (r, e, t, a) => {
  const n = e == null ? undefined : e.span;
  return {
    ...r,
    ...e,
    span: ({
      ...
      if (!g) {
        if (n) {
          ...
          return Y.createElement("span", c, u);
        }
      }
      const {
        dataHighlightId: y,
      ...
      const T = [g.tooltip, g.note].filter(Boolean).join(" ");
      return <_Component5 arrow={true} enterDelay={120} title={a(g)}><_Component4 component="span" {...w} aria-label={`${g.text}: ${T}`} tabIndex={0} sx={t4}>{u}</_Component4></_Component5>;
    }
  };
};
export { ln as B, z4 as C, B4 as F, C4 as M, E4 as P, A4 as T, T4 as a, M4 as b, I4 as c, pa as d, br as e, Uo as f, Yo as g, Eo as h, Bi as i, Do as j, zo as k, R4 as l, D4 as m, go as n, q4 as o, L4 as p, H4 as q, Xo as r, Li as s, N4 as t, O4 as u, xt as v, an as w };
