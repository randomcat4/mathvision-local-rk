import { ab as Q, am as W, r as N, aY as se, G as z, j as b, a8 as E, I as Y, K as R, aD as re, aQ as ae, F as le, T as K, H as O, a3 as J } from "./index-BM3ZINIl.js";
...
const Ce = N.forwardRef(function (t, l) {
  ...
  return <_ {...ee}><_Component {...te} />{B ? u : L}</_>;
});
function ue(o) {
  return Q("MuiFormControlLabel", o);
}
const P = W("MuiFormControlLabel", ["root", "labelPlacementStart", "labelPlacementTop", "labelPlacementBottom", "disabled", "label", "error", "required", "asterisk"]);
const me = o => {
  const {
    classes: t,
    disabled: l,
...
const _Component4 = R("label", {
  ...
  overridesResolver: (o, t) => {
    ...
    return [{
      [`& .${P.label}`]: t.label
    }, t.root, t[`labelPlacement${E(l.labelPlacement)}`]];
  }
})(J(({
  theme: o
}) => ({
...
const Pe = N.forwardRef(function (t, l) {
  ...
  if (d != null && d.type !== K && !y) {
    d = <_Component2 component="span" {...s} className={O(C.label, s == null ? undefined : s.className)}>{d}</_Component2>;
  }
  return <_Component4 className={O(C.root, u)} ownerState={g} ref={l} {...$}>{N.cloneElement(i, x)}{h ? <div>{d}<_Component3 ownerState={g} aria-hidden={true} className={C.asterisk}> *</_Component3></div> : d}</_Component4>;
});
