import { ab as q, am as I, r as N, F as O, aP as z, j as s, H as A, a8 as v, I as B, K as d, a3 as b, aV as p, aW as C, aX as L, E, ad as S } from "./index-BM3ZINIl.js";
function w(a) {
  return q("MuiLinearProgress", a);
}
I("MuiLinearProgress", ["root", "colorPrimary", "colorSecondary", "determinate", "indeterminate", "buffer", "query", "dashed", "bar", "bar1", "bar2"]);
const h = 4;
const x = L`
  0% {
    left: -35%;
...
const $ = (a, r) => a.vars ? a.vars.palette.LinearProgress[`${r}Bg`] : a.palette.mode === "light" ? a.lighten(a.palette[r].main, 0.62) : a.darken(a.palette[r].main, 0.5);
const V = d("span", {
  ...
  variants: [...Object.entries(a.palette).filter(p()).map(([r]) => ({
    props: {
      color: r
    },
    style: {
...
const X = d("span", {
  ...
  }, ...Object.entries(a.palette).filter(p()).map(([r]) => {
    const t = $(a, r);
    return {
      props: {
        color: r
...
const H = N.forwardRef(function (r, t) {
  ...
  return <V className={A(c.root, e)} ownerState={l} role="progressbar" {...u} ref={t} {...R}>{i === "buffer" ? <X className={c.dashed} ownerState={l} /> : null}<_ className={c.bar1} ownerState={l} style={f.bar1} />{i === "determinate" ? null : <F className={c.bar2} ownerState={l} style={f.bar2} />}</V>;
});
/**
...
function Q({
  ...
  return <S title={a} subtitle={r} icon={t} sx={n}><H sx={m} /></S>;
}
