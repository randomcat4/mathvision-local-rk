import { r as m, a_ as he, aY as Je, b6 as ne, aJ as Qe, aH as Ze, b7 as je, a$ as se, b8 as De, b9 as Ke, ab as He, am as et, j as I, H as ve, F as tt, aP as rt, G as Y, ba as Oe, a8 as Pe, I as at, K as Q, a3 as ie, aV as Ue, bb as We } from "./index-BM3ZINIl.js";
const nt = {
  border: 0,
  clip: "rect(0 0 0 0)",
  height: "1px",
...
function Ie(e, a, s, l) {
  ...
  const g = je(p);
  if ((S = e.current) == null || !S.contains(g) || Number(g == null ? undefined : g.getAttribute("data-index")) !== a) {
    const u = (f = e.current) == null ? undefined : f.querySelector(`[type="range"][data-index="${a}"]`);
    if (u != null) {
      if (l == null) {
        u.focus({
          preventScroll: true
...
function ft(e) {
  ...
  const Me = t => r => {
    ...
    if (["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight", "PageUp", "PageDown", "Home", "End"].includes(r.key)) {
      ...
      if (P != null) {
        ...
        const c = y[y.length - 1];
        const b = y.indexOf(d);
        const A = [g ? "ArrowRight" : "ArrowLeft", "ArrowDown", "PageDown", "Home"];
  ...
  Ze(() => {
    ...
    if (l && (r = h.current) != null && r.contains(t) && t != null && "blur" in t) {
      t.blur();
    }
  }, [l]);
  if (l && D !== -1) {
  ...
  const j = he(t => {
    ...
    if ("pointerType" in t && (o = h.current) != null && o.hasPointerCapture(t.pointerId)) {
  ...
  const Fe = t => r => {
    ...
    if (n !== false) {
      ...
      const c = L(n);
      if (c) {
        const b = (i = h.current) == null ? undefined : i.querySelector(`input[type="range"][data-index="${c.activeIndex}"]`);
...
function gt(e) {
  ...
  if (a) {
    ...
    }, <m.Fragment>{a.props.children}<span className={ve(p.offset, s)} aria-hidden={true}><span className={p.circle}><span className={p.label}>{l}</span></span></span></m.Fragment>);
  } else {
    return null;
  }
}
...
const ht = Q("span", {
  ...
  overridesResolver: (e, a) => {
    ...
    return [a.root, a[`color${Pe(s.color)}`], s.size !== "medium" && a[`size${Pe(s.size)}`], s.marked && a.marked, s.orientation === "vertical" && a.vertical, s.track === "inverted" && a.trackInverted, s.track === false && a.trackFalse];
  }
})(ie(({
  theme: e
}) => ({
  ...
  variants: [...Object.entries(e.palette).filter(Ue()).map(([a]) => ({
    props: {
      color: a
    },
    style: {
...
const yt = Q("span", {
  ...
  }, ...Object.entries(e.palette).filter(Ue()).map(([a]) => ({
    props: {
      color: a,
      track: "inverted"
    },
...
const Lt = e => {
  ...
  const Z = {
    root: ["root", a && "disabled", s && "dragging", l && "marked", p === "vertical" && "vertical", g === "inverted" && "trackInverted", g === false && "trackFalse", f && `color${Pe(f)}`, u && `size${Pe(u)}`],
    rail: ["rail"],
    track: ["track"],
    mark: ["mark"],
...
const Ct = m.forwardRef(function (a, s) {
  const l = tt({
    props: a,
    name: "MuiSlider"
  });
  ...
  return <G {...j}><_Component {...J} /><Fe {...xe} />{pe.filter(n => n.value >= ee && n.value <= E).map((n, o) => {
      ...
      if (O === false) {
        ...
        c = O === "normal" && (de ? n.value >= w[0] && n.value <= w[w.length - 1] : n.value <= w[0]) || O === "inverted" && (de ? n.value <= w[0] || n.value >= w[w.length - 1] : n.value >= w[0]);
      }
      return <m.Fragment key={o}><_Component2 data-index={o} {...me} {...!Oe(_Component2) && {
          markActive: c
        }} style={{
          ...i,
          ...me.style
        }} className={ve(me.className, c && k.markActive)} />{n.label != null ? <_Component3 aria-hidden={true} data-index={o} {...Se} {...!Oe(_Component3) && {
          markLabelActive: c
        }} style={{
          ...i,
          ...Se.style
        }} className={ve(k.markLabel, Se.className, c && k.markLabelActive)}>{n.label}</_Component3> : null}</m.Fragment>;
    })}{w.map((n, o) => {
      const d = Ae(n, ee, E);
      const i = z[N].offset(d);
      const _Component5 = R === "off" ? It : Ee;
      return <_Component5 {...!Oe(_Component5) && {
        valueLabelFormat: M,
        valueLabelDisplay: R,
        ...
        open: y === o || ue === o || R === "on",
        disabled: K
      }} {...$e} key={o}><Ne data-index={o} {...be} className={ve(k.thumb, be.className, ue === o && k.active, h === o && k.focusVisible)} style={{
          ...i,
          ...X(o),
          ...be.style
        }}><_Component4 data-index={o} aria-label={ye ? ye(o) : g} aria-valuenow={q(n)} aria-labelledby={f} aria-valuetext={le ? le(q(n), o) : S} value={w[o]} {...r} /></Ne></_Component5>;
    })}</G>;
});
export { Ct as S };
