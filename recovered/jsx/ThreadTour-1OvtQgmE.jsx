...
import { E as Jn, r as g, bM as Zn, aT as ee, aZ as pn, R as I, g as J, j as H, bN as Qn, _ as Dt, S as _Component, T as _Component2, aw as mn } from "./index-BM3ZINIl.js";
...
function ae() {
  var t;
  return typeof window !== "undefined" && (t = window == null ? undefined : window.document) != null && !!t.createElement;
}
function Or(t, ...e) {
...
var Lr = Zn();
var Nr = ["Array", "ArrayBuffer", "AsyncFunction", "AsyncGenerator", "AsyncGeneratorFunction", "Date", "Error", "Function", "Generator", "GeneratorFunction", "HTMLElement", "Map", "Object", "Promise", "RegExp", "Set", "URL", "WeakMap", "WeakSet"];
var Ir = ["bigint", "boolean", "null", "number", "string", "symbol", "undefined"];
function jt(t) {
...
var oo = t => ne(t) && !En(t) && t.nodeType === 1 && $t(t.nodeName) && Mr.every(e => e in t);
var io = t => $t(t) && t.length === 0 || Bt(t) && t.length === 0 || ne(t) && !he(t) && !ye(t) && Object.keys(t).length === 0 || ye(t) && t.size === 0 || he(t) && t.size === 0;
var so = (t, e) => !t || !e ? false : Object.getPrototypeOf(t) === e.prototype;
...
function lo() {
  ...
  function n(r) {
    if (r === null || typeof r == "boolean" || typeof r === "undefined") {
      ...
      return r.reduce(e, "");
    } else if (t(r) && Object.prototype.hasOwnProperty.call(r.props, "children")) {
  ...
  if (!$e) {
    ...
    (function (t) {
      ...
      function r(o) {
        ...
        const u = typeof (o == null ? undefined : o.cloneProtoObject) == "function" ? o.cloneProtoObject : undefined;
        const p = typeof (o == null ? undefined : o.isMergeableObject) == "function" ? o.isMergeableObject : n();
        const h = (o == null ? undefined : o.onlyDefinedProperties) === true;
        function T(b) {
          return typeof b != "object" || b === null;
        }
        const S = o && typeof o.mergeArray == "function" ? o.mergeArray({
          clone: d,
          deepmerge: w,
          getKeys: l,
          isMergeableObject: p
...
async function Ao(t, e) {
  ...
  const d = Zt(await i.getClippingRect({
    element: (n = await (i.isElement == null ? undefined : i.isElement(S))) == null || n ? S : S.contextElement || (await (i.getDocumentElement == null ? undefined : i.getDocumentElement(a.floating))),
    boundary: f,
    rootBoundary: m,
    strategy: c
  }));
  ...
  const w = await (i.getOffsetParent == null ? undefined : i.getOffsetParent(a.floating));
  const O = (await (i.isElement == null ? undefined : i.isElement(w))) ? (await (i.getScale == null ? undefined : i.getScale(w))) || {
    x: 1,
    y: 1
  } : {
    x: 1,
  ...
  const b = Zt(i.convertOffsetParentRelativeRectToViewportRelativeRect ? await i.convertOffsetParentRelativeRectToViewportRelativeRect({
    elements: a,
    rect: y,
    offsetParent: w,
    strategy: c
  ...
  for (let T = 0; T < i.length; T++) {
    ...
    if (E && p < ko) {
      ...
      if (typeof E == "object") {
        ...
        if (E.rects) {
          f = E.rects === true ? await s.getElementRects({
            reference: t,
            floating: e,
            strategy: o
          }) : E.rects;
...
const No = t => ({
  ...
  async fn(e) {
    ...
    const E = await (s.getOffsetParent == null ? undefined : s.getOffsetParent(f));
    let v = E ? E[w] : 0;
    ...
    const k = v / 2 - T[h] / 2 + P;
    const M = be(x, k, A);
    const $ = !c.arrow && st(o) != null && k !== M && i.reference[h] / 2 - (k < x ? L : C) - T[h] / 2 < 0;
...
function Io(t, e, n) {
  return (t ? [...n.filter(o => st(o) === t), ...n.filter(o => st(o) !== t)] : n.filter(o => ft(o) === o)).filter(o => t ? st(o) === t || (e ? Xt(o) !== o : false) : true);
}
const Do = function (t = {}) {
  return {
    name: "autoPlacement",
    ...
    async fn(e) {
      ...
      const w = On(y, i, await (c.isRTL == null ? undefined : c.isRTL(f.floating)));
      if (a !== y) {
        return {
          reset: {
            placement: T[0]
      ...
      const b = [...(((r = s.autoPlacement) == null ? undefined : r.overflows) || []), {
        placement: y,
        overflows: O
      }];
      const E = T[d + 1];
      ...
      const v = b.map(L => {
        ...
        return [L.placement, C && m ? L.overflows.slice(0, 2).reduce((x, A) => x + A, 0) : L.overflows[0], L.overflows];
      }).sort((L, C) => L[1] - C[1]);
      const _ = ((o = v.filter(L => L[2].slice(0, st(L[0]) ? 2 : 3).every(C => C <= 0))[0]) == null ? undefined : o[0]) || v[0][0];
      if (_ !== a) {
        return {
          data: {
            index: d + 1,
  ...
  return {
    ...
    async fn(e) {
      ...
      if (!_.every(k => k <= 0)) {
        ...
        const M = v[k];
        if (M && (!(l === "alignment" ? y !== ht(M) : false) || L.every(N => ht(N.placement) === y ? N.overflows[0] > 0 : true))) {
          return {
            data: {
              index: k,
              overflows: L
        ...
        let $ = (x = L.filter(D => D.overflows[0] <= 0).sort((D, N) => D.overflows[1] - N.overflows[1])[0]) == null ? undefined : x.placement;
        if (!$) {
          switch (p) {
            case "bestFit":
              {
                var A;
                const D = (A = L.filter(N => {
                  if (E) {
                    const U = ht(N.placement);
                    return U === y || U === "y";
                  }
                  return true;
                }).map(N => [N.placement, N.overflows.filter(U => U > 0).reduce((U, z) => U + z, 0)]).sort((N, U) => N[1] - U[1])[0]) == null ? undefined : A[0];
                if (D) {
                  $ = D;
                }
                break;
...
function tt(t) {
  var e;
  return (t == null || (e = t.ownerDocument) == null ? undefined : e.defaultView) || window;
}
function ct(t) {
  var e;
...
function Ce(t) {
  const e = nt(t) ? rt(t) : t;
  return wt(e.transform) || wt(e.translate) || wt(e.scale) || wt(e.rotate) || wt(e.perspective) || !Pe() && (wt(e.backdropFilter) || wt(e.filter)) || Ho.test(e.willChange || "") || Uo.test(e.contain || "");
}
function zo(t) {
  let e = bt(t);
  while (dt(e) && !vt(e)) {
...
function Pe() {
  if (pe == null) {
    pe = typeof CSS !== "undefined" && CSS.supports && CSS.supports("-webkit-backdrop-filter", "none");
  }
  return pe;
}
function vt(t) {
...
function Ko(t, e) {
  ...
  if (f <= 0) {
    ...
    const p = m.compatMode === "CSS1Compat" && parseFloat(u.marginLeft) + parseFloat(u.marginRight) || 0;
...
function Jo(t, e) {
  ...
  while (nt(s) && !vt(s)) {
    ...
    if (i ? !c && !o : !c && a.position === "static" && !!o && (o.position === "absolute" || o.position === "fixed") || Ht(s) && !c && Ln(t, s)) {
      r = r.filter(m => m !== s);
    } else {
      o = a;
    }
...
function ke() {
  var t;
  return typeof window !== "undefined" && (t = window.document) != null && !!t.createElement;
}
function sn(t) {
  let e = 0;
  let n = 0;
...
function Ri(t = false) {
  ...
  if (t) {
    const r = [e.scrollHeight, e.offsetHeight, n.clientHeight, n.scrollHeight, n.offsetHeight].sort((i, s) => i - s);
...
function cn(t) {
  ...
  if (r.skipScroll || e && !n && i !== R.TOOLTIP || r.placement === "center") {
    return false;
  }
...
function Li(t, e) {
  ...
  if (ke()) {
    o = typeof o == "number" && window.innerWidth < o ? window.innerWidth - 30 : o;
  }
  const i = {
    bottom: 0,
    left: 0,
...
const Ni = ["after", "arrowBase", "arrowColor", "arrowSize", "arrowSpacing", "backgroundColor", "beaconSize", "beaconTrigger", "before", "beforeTimeout", "buttons", "closeButtonAction", "skipBeacon", "dismissKeyAction", "disableFocusTrap", "hideOverlay", "skipScroll", "blockTargetInteraction", "loaderDelay", "offset", "overlayClickAction", "overlayColor", "primaryColor", "scrollDuration", "scrollOffset", "showProgress", "spotlightPadding", "spotlightRadius", "targetWaitTimeout", "textColor", "width", "zIndex"];
function Ne(t, e) {
  if (!e) {
    return null;
  }
  const n = St(wi, rn(t, "arrowComponent", "beaconComponent", "floatingOptions", "loaderComponent", "locale", "styles", "tooltipComponent"), e);
...
var _i = class {
  constructor(t) {
    ...
    G(this, "getPositionData", t => t === "beacon" ? this.beaconPosition : this.tooltipPosition);
    ...
    G(this, "setPositionData", (t, e) => {
      ...
      var o;
      var i;
      if (((r = t === "beacon" ? this.beaconPosition : this.tooltipPosition) == null ? undefined : r.placement) !== e.placement) {
      ...
      if ((this.state.lifecycle === R.BEACON_BEFORE || this.state.lifecycle === R.TOOLTIP_BEFORE) && !this.state.positioned) {
        this.updateState({
          positioned: true
        });
      }
      const n = (i = (o = this.getStep()) == null ? undefined : o.floatingOptions) == null ? undefined : i.onPosition;
      if (n) {
        n(e);
      }
    });
...
function Hi(t) {
  ...
  g.useEffect(() => {
    ...
    const k = f === B.START && (d.current === B.CLOSE || d.current === B.REPLAY);
    if (A || k) {
      d.current = f;
    }
  }, [f]);
  g.useEffect(() => {
    ...
    if (k("status", F.RUNNING) && [F.IDLE, F.READY, F.PAUSED].includes(O.current.status)) {
      r(q.TOUR_START, A);
    }
  ...
  g.useEffect(() => {
    ...
    } else if (w.current.status === F.RUNNING && l !== R.INIT && l !== R.COMPLETE && x("lifecycle")) {
  ...
  g.useEffect(() => {
    ...
    const D = w.current;
    if ((D.status === F.RUNNING || D.controlled && D.status === F.PAUSED && k) && M && x("lifecycle", R.COMPLETE) && A.lifecycle === R.TOOLTIP && (r(q.STEP_AFTER, M, {
      action: d.current ?? B.UPDATE,
  ...
  g.useEffect(() => {
    ...
    if (!w.current.controlled && T === F.RUNNING && x("lifecycle", R.COMPLETE) && m < h) {
      c.current.updateState({
        action: B.UPDATE,
        lifecycle: R.INIT
      });
...
function zi(t, e) {
  ...
  if (r === R.BEACON_BEFORE && n != null && n.placement) {
    ...
    if (l === "top") {
      const u = ((a = document.querySelector(".react-joyride__floater")) == null ? undefined : a.getBoundingClientRect().height) ?? 0;
      const p = (c = i.floatingOptions) != null && c.hideArrow ? 0 : i.arrowSize;
      const h = i.offset + i.spotlightPadding.top + p;
      s -= u + h;
    } else if (l === "left" || l === "right") {
      const u = ((f = document.querySelector(".react-joyride__floater")) == null ? undefined : f.getBoundingClientRect().height) ?? 0;
      const p = ((m = et(i.target)) == null ? undefined : m.getBoundingClientRect().height) ?? 0;
...
function Gi(t) {
  ...
  const f = Lr.useSyncExternalStore(c.current.subscribe, c.current.getSnapshot, c.current.getServerSnapshot);
  const [m, l] = g.useState([]);
...
function It(t, e) {
  ...
  return {
    height: Math.round(((r == null ? undefined : r.height) ?? 0) + e.top + e.bottom),
    isFixed: o,
    left: Math.round(((r == null ? undefined : r.left) ?? 0) - e.left),
    top: i,
    width: Math.round(((r == null ? undefined : r.width) ?? 0) + e.left + e.right)
  };
}
function Ji(t, e, n) {
  ...
  const f = g.useCallback(() => {
    ...
    i.current = window.setTimeout(() => {
      o(l => {
        const u = It(t, e);
        if (l.top === u.top && l.left === u.left && l.width === u.width && l.height === u.height && l.isFixed === u.isFixed) {
          return l;
        } else {
          return u;
        }
...
function ts(t) {
  ...
  const _ = ((D = p.overlay) == null ? undefined : D.backgroundColor) ?? "rgba(0, 0, 0, 0.5)";
  const L = g.useMemo(() => {
    const {
      backgroundColor: N,
      mixBlendMode: U,
  ...
  if (C) {
    if (c && E) {
      ...
      if (N) {
        const U = sn(N);
        const z = sn(E);
        k = un(U.left - z.left - m.left, U.top - z.top - m.top, N.offsetWidth + m.left + m.right, N.offsetHeight + m.top + m.bottom, l);
      }
    } else {
  ...
  }), k && Object.keys(p.spotlight).length > 0 && I.createElement("path", {
    d: k,
    fill: "none",
    style: {
      pointerEvents: "none"
...
const es = "a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), area[href], [tabindex]:not([tabindex=\"-1\"]), [contenteditable]";
function ns(t, e) {
  const n = g.useRef(null);
  g.useEffect(() => {
    if (!t) {
...
function as(t) {
  ...
  p.close = f.includes("close") && I.createElement(cs, {
...
function fs(t, e, n) {
  ...
  if (t) {
    return [gi()];
  } else if (((r = e.floatingOptions) == null ? undefined : r.flipOptions) === false) {
    return [];
  } else {
    return [mi({
      crossAxis: false,
...
function ds(t) {
  ...
  const _ = y ? "fixed" : ((U = u.floatingOptions) == null ? undefined : U.strategy) ?? (u.isFixed || E ? "fixed" : "absolute");
  const L = g.useMemo(() => {
    var K;
    var pt;
    var Nt;
    ...
    if (y) {
      ...
      return [nn(({
        ...
        return u.offset + Yn + ((_e = u.floatingOptions) != null && _e.hideArrow ? 0 : u.arrowSize);
      }, [u.offset, u.spotlightPadding, u.spotlightTarget, u.arrowSize, (K = u.floatingOptions) == null ? undefined : K.hideArrow]), ...fs(w, u, P), pi({
        padding: 10,
        ...v,
        ...((pt = u.floatingOptions) == null ? undefined : pt.shiftOptions)
      }), ...((Nt = u.floatingOptions) != null && Nt.hideArrow ? [] : [hi({
        element: T,
        padding: u.arrowSpacing
      }, [u.arrowSpacing, u.arrowBase])]), ...(((De = u.floatingOptions) == null ? undefined : De.middleware) ?? [])];
    }
  }, [y, u, w, P, v]);
  const C = en({
    ...(y ? {
  ...
  const x = en({
    ...
    middleware: g.useMemo(() => {
      var K;
      var pt;
      return [nn(((pt = (K = u.floatingOptions) == null ? undefined : K.beaconOptions) == null ? undefined : pt.offset) ?? -18)];
    }, [(at = (z = u.floatingOptions) == null ? undefined : z.beaconOptions) == null ? undefined : at.offset]),
  ...
  g.useEffect(() => {
    ...
    if (!!pt && !!K && o === R.TOOLTIP) {
      return Ze(pt, K, C.update, (Nt = u.floatingOptions) == null ? undefined : Nt.autoUpdate);
    }
  }, [o, C.update, (Ut = u.floatingOptions) == null ? undefined : Ut.autoUpdate, u.target, C.elements]);
  g.useEffect(() => {
    if (!y && p) {
  ...
  if (o === R.TOOLTIP || o === R.TOOLTIP_BEFORE) {
    ...
    N = I.createElement("div", {
      ...
      size: l,
      step: u
    }), !y && ((Ie = u.floatingOptions) == null || !Ie.hideArrow) && I.createElement(is, {
...
function ms({
  ...
  return I.createElement(I.Fragment, null, u !== R.INIT && I.createElement(ps, {
    ...n,
    continuous: i,
    controls: t,
    debug: s,
    ...
    element: m
  }, I.createElement(I.Fragment, null, T && I.createElement(Ki, {
    nonce: a,
    step: r
  }), !O && I.createElement(ts, {
    ...r,
    continuous: i,
    lifecycle: u,
    onClickOverlay: w,
...
const Gn = ({
  ...
  titleId: f,
  tooltipProps: m
}) => <div className="react-joyride__tooltip" data-joyride-step={i} {...c.id && {
  "data-joyride-id": c.id
}} style={c.styles.tooltip} {...m} aria-labelledby={c.title ? f : undefined} aria-describedby={n}><_Component aria-hidden="true" sx={Rs} /><_Component sx={ys}>{(o || r) && <_Component direction="row" spacing={1.35} sx={Ss}>{o && <_Component aria-hidden="true" sx={ws}>{o}</_Component>}{r && <_Component sx={bs}><_Component2 variant="cardEyebrow" color="primary">{r}</_Component2></_Component>}</_Component>}{a !== undefined && s && <_Component3 aria-label={s} aria-valuetext={s} variant="determinate" value={a} sx={Es} />}<_Component data-thread-tour-content={true} spacing={0.75} sx={Ts} key={i}>{c.title && <_Component2 id={f} variant="subtitle1" color="text.primary">{c.title}</_Component2>}<_Component2 id={n} variant="body2" color="text.secondary">{e}</_Component2></_Component><_Component4 /><_Component direction="row" spacing={1} sx={xs}>{t}</_Component></_Component></div>;
const vs = ({
  backProps: t,
  index: e,
  isLastStep: n,
  ...
  return <Gn index={e} step={s} tooltipProps={a} titleId={c} contentId={f} progressLabel={m} progressValue={(e + 1) / o * 100} content={s.content} actions={<H.Fragment>{s.buttons.includes("skip") && !n && <Dt aria-label={i["aria-label"]} data-action={i["data-action"]} data-testid="button-skip" size="small" title={i.title} variant="text" onClick={i.onClick}>{i["aria-label"]}</Dt>}<_Component direction="row" spacing={0.75} sx={Os}>{s.buttons.includes("back") && e > 0 && <Dt aria-label={t["aria-label"]} data-action={t["data-action"]} data-testid="button-back" size="small" startIcon={<_Component5 aria-hidden="true" size={16} />} title={t.title} variant="outlined" onClick={t.onClick}>{t["aria-label"]}</Dt>}{s.buttons.includes("primary") && <Dt aria-label={r["aria-label"]} data-action={r["data-action"]} data-testid="button-primary" endIcon={n ? <_Component6 aria-hidden="true" size={16} /> : <_Component7 aria-hidden="true" size={16} />} size="small" sx={zn} title={r.title} variant="contained" onClick={r.onClick}>{r["aria-label"]}</Dt>}</_Component></H.Fragment>} />;
};
const Cs = ({
  index: t,
  primaryProps: e,
  ...
  return <Gn index={t} step={r} tooltipProps={o} titleId={i} contentId={s} eyebrow="Quick start" icon={<_Component8 aria-hidden="true" size={21} strokeWidth={2.2} />} content={r.content} actions={<H.Fragment><Dt aria-label={n["aria-label"]} data-action={n["data-action"]} data-testid="button-soft-guide-dismiss" size="small" title={n.title} variant="text" onClick={n.onClick}>{n["aria-label"]}</Dt><Dt aria-label={e["aria-label"]} data-action={e["data-action"]} data-testid="button-soft-guide-show-now" endIcon={<_Component9 aria-hidden="true" fill="currentColor" size={14} />} size="small" sx={zn} title={e.title} variant="contained" onClick={f => {
      f.preventDefault();
      a();
    }}>{e["aria-label"]}</Dt></H.Fragment>} />;
};
const fn = 1200;
...
const ks = {
  ...
  question: "Question gives a focused answer to a specific mathematical question or point of confusion.",
  "lit-search": "Literature Search finds relevant research and organizes the sources around your question.",
  compute: "Compute runs a concrete Python or Sage calculation and reports the observed result.",
  visualization: "Visualization turns mathematical structure or data into an appropriate diagram, graph, or plot.",
  writeup: "Writeup produces a polished, structured mathematical document suitable for further editing or export.",
  referee: "Referee critiques an argument for gaps, hidden assumptions, invalid steps, and concrete fixes.",
  "next-steps": "Next Steps proposes useful directions for continuing the current problem or proof."
};
const Ls = ar.map(t => ({
  target: lr[t.value],
  title: t.label,
...
const Ns = t => () => typeof document === "undefined" ? null : document.querySelector(W(t)) ?? document.querySelector(W(V.composerOperation));
const Is = async t => {
  ...
  if (!!r && r.getAttribute("aria-expanded") !== "true") {
    r.dispatchEvent(new MouseEvent("mousedown", {
      bubbles: true,
      button: 0
    }));
    await dn(t, fn);
...
const Ds = () => new Promise(t => {
  ...
  if ((r = n == null ? undefined : n.querySelector(".MuiBackdrop-root")) != null) {
    r.click();
  }
...
const Cc = ({
  ...
  const c = g.useMemo(() => [{
    ...
    title: "Message",
    content: "Type your question, proof, or instructions here. Press Enter to run it, or Shift+Enter for a new line.",
    placement: "top-start"
  }, {
    target: W(V.composerOperation),
    title: "Operation",
    content: "Chat chooses the best operation automatically. Choose another operation here when you want to run it directly.",
    placement: "top-start"
  }, ...Ls.map(({
    target: m,
    title: l,
    ...
    content: "Run Next Steps directly when you want suggestions for where to take the work next.",
    placement: "top",
    before: Ds
  }, ...(t ? [{
    target: W(V.composerProRun),
    title: "Pro run",
    content: "Use your daily Math Vision Pro run for a deeper background analysis of a demanding prompt.",
    placement: "top"
  }] : []), {
    target: W(V.composerModel),
    title: "mathvision mode",
    content: "Choose the mathvision mode that will handle the request. Available modes can differ in speed and capability.",
    placement: "top"
  }, {
    target: W(V.composerAttachFiles),
    title: "Attach files",
    content: "Attach supporting PDFs, images, text, or other compatible files to the message.",
    placement: "top"
  }, {
    target: W(V.composerLatex),
    title: "Attach LaTeX",
    content: "Select LaTeX documents from your workspace so the model can use them as context.",
    placement: "top"
  }, {
    target: W(V.composerSubmit),
    title: "Run",
    content: "Run the selected operation. This button changes to Cancel while a response is in progress.",
    placement: "top-end"
  }, ...(e ? [{
    target: W(V.chatSidebarNewChat),
    title: "New chat",
    content: "Choose Recents or any Explorer folder, then create a chat without leaving the workspace.",
    placement: "right"
  }, {
    target: W(V.chatSidebarCreateFolder),
    title: "New folder",
    content: "Choose Explorer root or any existing folder as the destination. LaTeX projects and chats each have their own placement button beside it.",
    placement: "right"
  }, {
    ...
    content: "Folders, chat hierarchies, and LaTeX projects share one file-tree explorer. Loose chats stay in their own section.",
    placement: "right"
  }, {
    ...
    content: "See how much of the chat context is in use. Hover or click for details.",
    ...
    title: "Guided tour",
    content: "Open More actions and choose Guided tour whenever you want to replay this guide.",
    placement: "bottom-end"
  }])]), ...(n && !s ? [{
    ...
    target: W(V.workspaceMoreActions),
    title: "More actions",
    content: "Open the guided tour, announcements, Slack support, and the feedback form.",
    placement: "bottom-end"
  }] : [])], [e, t, n, s]);
  const f = g.useMemo(() => Wn(i), [i]);
  return <H.Fragment><Vn /><Un continuous={true} run={r} steps={c} locale={{
      back: "Back",
      last: "Done",
      next: "Next",
      skip: "Skip tour"
    ...
    }} styles={f} tooltipComponent={vs} onEvent={o} /></H.Fragment>;
};
const Pc = ({
  run: t,
  onDismiss: e,
  ...
  const i = g.useMemo(() => {
    ...
    return [{
      ...
      content: "Open More actions to find the guided tour, or start it now to learn every operation and composer control.",
      placement: "bottom-end",
      skipScroll: true,
      data: {
        onShowNow: n
  ...
  const a = g.useCallback(c => {
    if (c.status === F.FINISHED || c.status === F.SKIPPED) {
      e();
    }
  }, [e]);
  return <H.Fragment><Vn /><Un continuous={true} run={t} steps={i} locale={{
      last: "Show me now",
      skip: "Maybe later"
    }} options={{
      arrowBase: 24,
    ...
    }} styles={s} tooltipComponent={Cs} onEvent={a} /></H.Fragment>;
};
