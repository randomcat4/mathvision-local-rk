...
const l = () => {
  var e;
  return ((e = globalThis.navigator) == null ? undefined : e.language) ?? "en-US";
};
const T = (e = l()) => {
...
const _Component = ({
  ...
  return <time dateTime={u.toISOString()} className={a} title={u.toLocaleString(t)} {...r}>{n}</time>;
};
const x = ({
  time: e
}) => e ? <_Component3 label={<_Component date={e} />} size="xs" tooltip={<_Component2 value={e} />} /> : "-";
