import { p as k, r as t, w as R, t as B, Y as E, Z as d, j as e, B as _Component2, S as A, _ as _Component } from "./index-BM3ZINIl.js";
...
function ct({
  ...
  const p = t.useMemo(() => x && a.length <= d && !i && !s, [x, s, i, a.length]);
  ...
  return <W open={m} onClose={S} aria-labelledby="profile-personalization-title" maxWidth="sm" fullWidth={true}><_Component2 component="form" onSubmit={I}><_ id="profile-personalization-title">Personalization</_><F dividers={true}><A spacing={2}><U id="profile-custom-instructions" label="Custom instructions" value={a} disabled={v} placeholder="Tell the assistant to behave or change its tone, etc." fullWidth={true} multiline={true} minRows={7} maxRows={12} helperText={C} onChange={T} slotProps={D} /></A></F><N><_Component type="button" color="secondary" disabled={s} onClick={S}>Cancel</_Component><_Component type="submit" variant="contained" disabled={!p} startIcon={j}>{y}</_Component></N></_Component2></W>;
}
