import { A as go, j as p, ab as z, am as L, r as d, F as O, aJ as bo, aD as io, H as $, G as R, a8 as m, I as A, K as C, aQ as fo, a3 as lo, aV as _, aw as vo, Q as co, bu as yo, T as xo, E as ko, a6 as _Component5 } from "./index-BM3ZINIl.js";
import { e as Co, M as Do, B as So } from "./TextField-D8vc_sXz.js";
const $o = go(<path d="M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2zm5 13.59L15.59 17 12 13.41 8.41 17 7 15.59 10.59 12 7 8.41 8.41 7 12 10.59 15.59 7 17 8.41 13.41 12 17 15.59z" />);
function mo(o) {
  return z("MuiChip", o);
}
const e = L("MuiChip", ["root", "sizeSmall", "sizeMedium", "colorDefault", "colorError", "colorInfo", "colorPrimary", "colorSecondary", "colorSuccess", "colorWarning", "disabled", "clickable", "deletable", "outlined", "filled", "avatar", "icon", "label", "deleteIcon", "focusVisible"]);
const wo = o => {
  const {
    classes: a,
    disabled: t,
  ...
  const u = {
    root: ["root", n, t && "disabled", `size${m(r)}`, `color${m(i)}`, c && "clickable", s && "deletable"],
    label: ["label"],
    avatar: ["avatar"],
    icon: ["icon"],
...
const Ro = C("div", {
  name: "MuiChip",
  slot: "Root",
  shouldForwardProp: o => fo(o) && o !== "focusableWhenDisabled" && o !== "skipFocusWhenDisabled",
  overridesResolver: (o, a) => {
    ...
    }, a.root, a[`size${m(c)}`], a[`color${m(r)}`], i && a.clickable, s && a.deletable, a[n]];
  }
})(lo(({
  theme: o
}) => {
  ...
  return {
    ...
    variants: [{
    ...
    }, ...Object.entries(o.palette).filter(_(["contrastText"])).map(([t]) => ({
      props: {
        color: t
      },
      style: {
    ...
    }, ...Object.entries(o.palette).filter(_(["dark"])).map(([t]) => ({
      props: {
        color: t,
        onDelete: true
      },
    ...
    }, ...Object.entries(o.palette).filter(_()).map(([t]) => ({
      props: {
        variant: "outlined",
        color: t
      },
      style: {
        ...
        [`&.${e.focusVisible}`]: {
          backgroundColor: o.alpha((o.vars || o).palette[t].main, (o.vars || o).palette.action.focusOpacity)
        },
        [`& .${e.deleteIcon}`]: {
...
const Y = d.forwardRef(function (a, t) {
  ...
  let B = null;
  if (f) {
    B = g && d.isValidElement(g) ? d.cloneElement(g, {
  ...
  return <_Component2 as={F} {...ro}>{E || K}<_Component {...uo}>{P}</_Component>{B}</_Component2>;
});
function To(o) {
  return z("MuiDialog", o);
}
L("MuiDialog", ["root", "backdrop", "scrollPaper", "scrollBody", "container", "paper", "paperWidthFalse", "paperWidthXs", "paperWidthSm", "paperWidthMd", "paperWidthLg", "paperWidthXl", "paperFullWidth", "paperFullScreen"]);
...
const ho = o => {
  ...
  const c = {
    ...
    paper: ["paper", `paperWidth${m(String(r))}`, i && "paperFullWidth", s && "paperFullScreen"]
  };
  return A(c, To, a);
};
const Wo = C(Do, {
...
const jo = C(co, {
  ...
  overridesResolver: (o, a) => {
    ...
    return [a.paper, a[`paperWidth${m(String(t.maxWidth))}`], t.fullWidth && a.paperFullWidth, t.fullScreen && a.paperFullScreen];
  }
})(lo(({
  theme: o
}) => ({
  ...
  }, ...Object.keys(o.breakpoints.values).filter(a => a !== "xs").map(a => ({
    props: {
      maxWidth: a
    },
    style: {
...
const Yo = d.forwardRef(function (a, t) {
  ...
  return <F closeAfterTransition={true} slots={{
    backdrop: k
  }} slotProps={{
    backdrop: {
  ...
  }} onClose={M} open={W} onClick={V} {...N} {...Z}><_Component3 {...ro}><K onMouseDown={oo} {...H}><B as={X} elevation={24} role={Q} aria-describedby={c} aria-labelledby={j} aria-modal={u} {...E}><po.Provider value={ao}>{g}</po.Provider></B></K></_Component3></F>;
});
function Fo(o) {
...
const Go = d.forwardRef(function (a, t) {
  ...
  return <Eo component="h2" className={$(u.root, i)} ownerState={n} ref={t} variant="h6" id={s ?? g} {...c} />;
});
/**
...
const qo = o => {
  if (o.link !== undefined) {
    ...
    if (u) {
      return <_Component5 title={u}><Y {...g} clickable={P} component="a" href={s} rel={b} target={v} /></_Component5>;
    } else {
      return <Y {...g} clickable={P} component="a" href={s} rel={b} target={v} />;
    }
  }
  const {
    link: a,
  ...
  if (t) {
    return <_Component5 title={t}><Y {...r} clickable={i} /></_Component5>;
  } else {
