import { r as n, am as W, ab as A, bT as Z, F, j as i, H, a8 as V, I as G, K as Y, aD as J, a3 as K, aV as Q, E as C, B as T, T as _Component6, g, a6 as _Component8 } from "./index-BM3ZINIl.js";
import { M as _Component3, C as re, d as _Component0 } from "./MarkdownHighlights-C-ZhT8z1.js";
import { F as _Component5 } from "./file-code-corner-DV79SyC0.js";
import { D as _Component7 } from "./Divider-BcuihGce.js";
import { I as _Component9 } from "./TextField-D8vc_sXz.js";
function se(e) {
...
const k = W("MuiToggleButton", ["root", "disabled", "selected", "standard", "primary", "secondary", "sizeSmall", "sizeMedium", "sizeLarge", "fullWidth"]);
...
const de = e => {
  ...
  const b = {
    root: ["root", o && "selected", a && "disabled", r && "fullWidth", `size${V(u)}`, x]
  };
  return G(b, le, t);
};
...
const Qe = n.forwardRef(function (t, r) {
  ...
  const l = u || "";
  return <_Component className={H(a.className, I.root, s, l)} internalNativeButton={true} disabled={y} focusRipple={!R} ref={r} onClick={$} onChange={B} value={E} ownerState={S} aria-pressed={d} {...M}>{v}</_Component>;
});
function pe(e) {
  return A("MuiToggleButtonGroup", e);
}
const c = W("MuiToggleButtonGroup", ["root", "selected", "horizontal", "vertical", "disabled", "grouped", "fullWidth", "firstButton", "lastButton", "middleButton"]);
const fe = e => {
  const {
    classes: t,
    orientation: r,
...
const et = n.forwardRef(function (t, r) {
  ...
  return <_Component2 role="group" className={H(d.root, u)} ref={r} ownerState={w} {...B}><U.Provider value={M}>{S.map((l, f) => <q.Provider value={$(f)} key={f}>{l}</q.Provider>)}</U.Provider></_Component2>;
});
/**
...
const gt = ({
  kind: e,
  title: t
}) => <i.Fragment><T sx={Te}><T aria-hidden="true" sx={Me}>{e === "chat" && <_Component3 size={16} />}{e === "file" && <_Component4 size={16} />}{e === "folder" && <Be size={16} />}{e === "latex-project" && <_Component5 size={16} />}{e === "notebook" && <Se size={16} />}</T><T sx={Ie}><_Component6 variant="caption" color="textSecondary">{e === "chat" && "Chat actions"}{e === "file" && "File actions"}{e === "folder" && "Folder actions"}{e === "latex-project" && "Project actions"}{e === "notebook" && "Notebook actions"}</_Component6><_Component6 title={t} variant="subtitle2" color="textPrimary" noWrap={true}>{t}</_Component6></T></T><_Component7 sx={$e} /></i.Fragment>;
...
const bt = (e, t) => {
  ...
  t();
  if (u != null) {
    u.dispatchEvent(new window.MouseEvent("contextmenu", {
      bubbles: true,
      cancelable: true,
      button: 2,
      buttons: 2,
...
const mt = "0.85rem";
const yt = "0.80rem";
const L = (e, t) => g(t ? e.palette.primary.main : e.palette.text.primary, t ? 0.72 : 0.55);
const ht = ({
  hasUnread: e = false,
  isContextMenuOpen: t,
  ...
  const u = o ? g(a.palette.primary.main, 0.12) : r ? g(a.palette.primary.main, 0.04) : e ? g(a.palette.info.main, 0.07) : "transparent";
  const x = o ? g(a.palette.primary.main, 0.16) : e ? g(a.palette.info.main, 0.1) : g(a.palette.text.primary, 0.055);
  return {
    width: "100%",
    minWidth: 0,
    minHeight: _e,
...
const Ne = ({
  ...
  return <_Component8 title={`Last edited ${a}`}><_Component6 variant={O[t].dateVariant} color="textSecondary" align="left" noWrap={true}>{Pe(o, new Date())}</_Component6></_Component8>;
};
const Oe = 500;
const We = e => ({
  width: "fit-content",
...
const Fe = ({
  ...
  onClick: r,
  onDoubleClick: o
}) => <T data-inline-rename-trigger="true" sx={We(t)} onClick={r} onDoubleClick={o}>{e}</T>;
const He = ({
  ariaLabel: e,
  ...
  onChange: b,
  onSubmit: v
}) => <_Component9 autoFocus={true} disabled={r} fullWidth={!t} value={u} slotProps={{
  input: {
    "aria-label": e,
    maxLength: o,
...
const Ve = ({
  ...
  const S = n.useCallback(l => {
    if (!R.current || p.current || y.current || !B.current || (l.preventDefault(), l.stopPropagation(), d(), l.detail > 1)) {
      return;
    }
  ...
  const $ = n.useCallback(l => l.key !== "F2" || p.current ? false : (l.preventDefault(), l.stopPropagation(), h(), true), [h]);
  n.useEffect(() => d, [d]);
  return {
    beginRename: h,
    cancelRename: E,
...
const It = ({
  ...
  isExpanded: t,
  sx: r
}) => <_Component0 in={t} timeout={P} easing={j} sx={r}>{e}</_Component0>;
const Ye = e => ({
  maxWidth: "100%",
  minWidth: 0,
  display: "flex",
...
const $t = ({
  ...
  return <T sx={Ye}><Ne timestamp={t} /><_Component6 variant={O[r].dateVariant} color="textSecondary" noWrap={true}>{e}</_Component6></T>;
};
const Ke = (e, t, r, o) => a => ({
  position: "absolute",
  zIndex: 0,
  ...
  opacity: r ? 1 : 0,
  pointerEvents: "none",
  transition: r ? "none" : a.transitions.create("opacity", {
    duration: a.transitions.duration.shortest
  }),
  "@media (prefers-reduced-motion: reduce)": {
    transition: "none"
...
export { tt as A, vt as B, Ve as C, Bt as D, St as E, nt as F, rt as G, se as H, He as I, lt as J, _e as K, L, j as M, Se as N, Tt as O, yt as P, mt as Q, Le as R, gt as S, et as T, wt as U, P as V, Qe as a, Ct as b, ft as c, ct as d, pt as e, ut as f, at as g, it as h, dt as i, st as j, bt as k, kt as l, O as m, Et as n, $t as o, Mt as p, xt as q, Dt as r, Rt as s, It as t, N as u, ht as v, Be as w, _Component4 as x, Ne as y, ot as z };
