import { u as c, j as e, B as _Component0, e as _Component8, S as _Component2, T as _Component, h as _Component7, aU as _Component6, a5 as _Component3 } from "./index-BM3ZINIl.js";
import { C as _Component9 } from "./Container-C988byeG.js";
import { D as _Component4 } from "./Divider-BcuihGce.js";
import { M as _Component5 } from "./index-DzMT-bSF.js";
const f = {
  h1: ({
    children: n
  }) => <_Component component="h1" variant="h4" gutterBottom={true}>{n}</_Component>,
  h2: ({
    children: n
  }) => <_Component component="h2" variant="h5" gutterBottom={true}>{n}</_Component>,
  h3: ({
    children: n
  }) => <_Component component="h3" variant="h6" gutterBottom={true}>{n}</_Component>,
  p: ({
    children: n
  }) => <_Component component="p" variant="body1" color="textSecondary">{n}</_Component>,
  ul: ({
    children: n
  }) => <_Component2 component="ul" spacing={0.75} sx={{
    pl: 3,
    my: 0
  }}>{n}</_Component2>,
  ol: ({
    children: n
  }) => <_Component2 component="ol" spacing={0.75} sx={{
    pl: 3,
    my: 0
  }}>{n}</_Component2>,
  li: ({
    children: n
  }) => <_Component component="li" variant="body1" color="textSecondary">{n}</_Component>,
  a: ({
    children: n,
    href: i
  }) => {
    const o = i == null ? undefined : i.startsWith("http");
    return <_Component3 href={i} target={o ? "_blank" : undefined} rel={o ? "noreferrer" : undefined}>{n}</_Component3>;
  }
};
function D({
  document: n
  ...
  }}><_Component9 maxWidth="md"><_Component8 sx={{
        p: {
          xs: 3,
          md: 5
        }
      }}><_Component2 spacing={3.5}><_Component2 spacing={1}><_Component variant="h3">{n.title}</_Component><_Component variant="body2" color="textSecondary">Effective {n.effectiveDate} | Version {n.version}</_Component></_Component2><_Component4 /><_Component2 spacing={3}><_Component5 components={f}>{n.markdown}</_Component5></_Component2><_Component4 /><_Component2 direction={{
            xs: "column",
            sm: "row"
          }} spacing={1.25}><_Component7 variant="outlined" startIcon={<_Component6 fontSize="small" />} onClick={() => i.history.back()}>Go Back</_Component7></_Component2></_Component2></_Component8></_Component9></_Component0>;
}
...
`;
const v = `# Math Vision Terms of Service
