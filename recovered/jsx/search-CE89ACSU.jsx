import { ab as S, am as h, r as n, F as m, j as x, H as k, a8 as u, I as C, K as L, a3 as R, p as v, b5 as M, ar as j, E as p } from "./index-BM3ZINIl.js";
function E(e) {
...
const z = e => {
  ...
  const a = {
    root: ["root", s !== "default" && `color${u(s)}`, !o && "gutters", r && "inset", !i && "sticky"]
  };
  return C(a, E, t);
};
const U = L("li", {
  ...
  overridesResolver: (e, t) => {
    ...
    return [t.root, s.color !== "default" && t[`color${u(s.color)}`], !s.disableGutters && t.gutters, s.inset && t.inset, !s.disableSticky && t.sticky];
  }
})(R(({
  theme: e
}) => ({
...
function w(e = {}, t) {
  ...
  return n.useSyncExternalStore(n.useCallback(i => s.subscribe(() => {
