import { j as y, r as E, B as I, a5 as _Component4, V as _Component3, g as C } from "./index-BM3ZINIl.js";
import { D as _Component2 } from "./katex.min-ADdKj7O-.js";
import { t as ve, f as ut, h as Ae, s as he, i as ct, B as fe, j as Ee, k as ht, l as Se, e as ft, m as mt, n as pt, o as dt, p as gt, q as kt, u as xt } from "./MarkdownHighlights-C-ZhT8z1.js";
import { C as _Component } from "./CopyButton-BcOsqrNJ.js";
import { o as L, u as B, a as ne, n as q, c as V, v as wt, t as Fe, b as re, d as W, m as S, e as yt, f as Ct, g as F, s as G, r as Tt, h as D, i as O, j as Mt, M as _Component5, k as At } from "./index-DzMT-bSF.js";
...
function Dt(e, n = Ft) {
  ...
  for (var u = e.querySelectorAll(".katex-display annotation"), h = 0; h < u.length; h++) {
    var c = u[h];
    c.innerHTML = n.display[0] + c.innerHTML.substr(n.inline[0].length, c.innerHTML.length - n.inline[0].length - n.inline[1].length) + n.display[1];
  }
  return e;
}
function me(e) {
...
document.addEventListener("copy", function (e) {
  ...
  if (!!n && !n.isCollapsed && !!e.clipboardData) {
    ...
    if (i.querySelector(".katex-mathml")) {
      var s = Array.prototype.map.call(i.childNodes, a => a instanceof Text ? a.textContent : a.outerHTML).join("");
...
function Ht(e) {
  Rt(e, [[/(https?:\/\/|www(?=\.))([-.\w]+)([^ \t\r\n]*)/gi, qt], [new RegExp("(?<=^|\\s|\\p{P}|\\p{S})([-.\\w+]+)@([-\\w]+(?:\\.[-\\w]+)+)", "gu"), Ut]], {
    ignore: ["link", "linkReference"]
  });
}
function qt(e, n, t, r, o) {
  let l = "";
  if (!Le(o) || (/^w/i.test(n) && (t = n + t, n = "", l = "http://"), !Vt(t))) {
    return false;
  }
  const i = Xt(t + r);
  if (!i[0]) {
...
function Re(e, n, t, r) {
  ...
  l += o.move(t.safe(t.associationId(e), {
    after: "]",
    before: l
  }));
  s();
...
function on(e) {
  ...
  function t(r, o, l, i) {
    ...
    a += s.move(l.safe(l.associationId(r), {
      before: a,
      after: "]"
    }));
    h();
...
const ln = ["autolink", "destinationLiteral", "destinationRaw", "reference", "titleQuote", "titleApostrophe"];
Ie.peek = fn;
function sn() {
  return {
...
function pn(e, n) {
  ...
  while (++c < u) {
    ...
    let d = t.alignDelimiters === false ? 1 : Math.max(1, a[c] - b.length - x.length);
  ...
  while (++h < i.length) {
    ...
    while (++c < u) {
      ...
      if (t.padding !== false && (t.alignDelimiters !== false || d !== "") && (t.delimiterStart !== false || c)) {
        x.push(" ");
      }
      if (t.alignDelimiters !== false) {
        x.push(w);
    ...
    f.push(t.delimiterEnd === false ? x.join("").replace(/ +$/, "") : x.join(""));
  }
  return f.join(`
`);
}
...
function Tn(e, n, t, r) {
  ...
  let u = a.move("[");
  u += a.move(t.safe(t.associationId(e), {
    before: u,
    after: "]",
    ...a.current()
  }));
...
function $e(e, n, t, r) {
  ...
  const s = i.move(o);
  let a = i.move(t.containerPhrasing(e, {
    after: o,
    before: s,
    ...i.current()
  }));
...
function An(e, n) {
  ...
  return (!e.depth || !!(e.depth < 3)) && !!Fe(e) && (!!n.options.setext || !!t);
}
function En(e, n, t, r) {
...
function We(e, n, t, r) {
  ...
  if (Be(e, t)) {
    ...
    s = t.enter("autolink");
    let c = i.move("<");
    c += i.move(t.containerPhrasing(e, {
      before: c,
      after: ">",
      ...i.current()
    }));
  ...
  a = t.enter("label");
  let u = i.move("[");
  u += i.move(t.containerPhrasing(e, {
    before: u,
    after: "](",
    ...i.current()
  }));
...
function In(e) {
  ...
  if (t === n) {
    throw new Error("Expected `bullet` (`" + n + "`) and `bulletOther` (`" + t + "`) to be different");
  }
  return t;
}
function Pn(e) {
...
function $n(e, n, t, r) {
  ...
  if (!e.ordered) {
    ...
    if ((i === "*" || i === "-") && h && (!h.children || !h.children[0]) && t.stack[t.stack.length - 1] === "list" && t.stack[t.stack.length - 2] === "listItem" && t.stack[t.stack.length - 3] === "list" && t.stack[t.stack.length - 4] === "listItem" && t.indexStack[t.indexStack.length - 1] === 0 && t.indexStack[t.indexStack.length - 2] === 0 && t.indexStack[t.indexStack.length - 3] === 0) {
      a = true;
    }
    if (qe(t) === i && h) {
      let c = -1;
...
function _n(e) {
  ...
  if (n !== "tab" && n !== "one" && n !== "mixed") {
    throw new Error("Cannot serialize items with `" + n + "` for `options.listItemIndent`, expected `tab`, `one`, or `mixed`");
  }
  return n;
}
function Nn(e, n, t, r) {
  ...
  if (n && n.type === "list" && n.ordered) {
    l = (typeof n.start == "number" && n.start > -1 ? n.start : 1) + (t.options.incrementListMarker === false ? 0 : n.children.indexOf(e)) + l;
  }
  let i = l.length + 1;
  if (o === "tab" || o === "mixed" && (n && n.type === "list" && n.spread || e.spread)) {
    i = Math.ceil(i / 4) * 4;
  }
  const s = t.createTracker(r);
...
const jn = De(["break", "delete", "emphasis", "footnote", "footnoteReference", "image", "imageReference", "inlineCode", "inlineMath", "link", "linkReference", "mdxJsxTextElement", "mdxTextExpression", "strong", "text", "textDirective"]);
function Bn(e, n, t, r) {
...
function Un(e) {
  ...
  if (n < 3) {
    throw new Error("Cannot serialize rules with repetition `" + n + "` for `options.ruleRepetition`, expected `3` or more");
  }
  return n;
}
function Vn(e, n, t) {
...
function pr(e, n) {
  ...
  function o(i) {
    if (i === 40) {
      ...
      return l(i);
    } else if (i === 33 || i === 34 || i === 38 || i === 39 || i === 41 || i === 42 || i === 44 || i === 46 || i === 58 || i === 59 || i === 60 || i === 63 || i === 93 || i === 95 || i === 126) {
...
function dr(e, n, t) {
  return r;
  function r(s) {
    if (s === 33 || s === 34 || s === 39 || s === 41 || s === 42 || s === 44 || s === 46 || s === 58 || s === 59 || s === 63 || s === 95 || s === 126) {
      e.consume(s);
      return r;
    } else if (s === 38) {
      e.consume(s);
...
function Ze(e) {
  return e === null || e === 40 || e === 42 || e === 95 || e === 91 || e === 93 || e === 126 || S(e);
}
function Je(e) {
  return !W(e);
}
...
function wr(e, n) {
  ...
  const s = [e[t + 1], e[t + 2], ["enter", r, n], e[t + 3], e[t + 4], ["enter", o, n], ["exit", o, n], ["enter", l, n], ["enter", i, n], ["exit", i, n], ["exit", l, n], e[e.length - 2], e[e.length - 1], ["exit", r, n]];
  ...
  function o(i, s) {
    ...
    while (++a < i.length) {
      if (i[a][0] === "enter" && i[a][1].type === "strikethroughSequenceTemporary" && i[a][1]._close) {
        let u = a;
        while (u--) {
          if (i[u][0] === "exit" && i[u][1].type === "strikethroughSequenceTemporary" && i[u][1]._open && i[a][1].end.offset - i[a][1].start.offset === i[u][1].end.offset - i[u][1].start.offset) {
            ...
            const m = [["enter", h, s], ["enter", i[u][1], s], ["exit", i[u][1], s], ["enter", c, s]];
            const k = s.parser.constructs.insideSpan.null;
            if (k) {
              G(m, m.length, 0, Tt(k, i.slice(u + 1, a), s));
            }
            G(m, m.length, 0, [["exit", c, s], ["enter", i[a][1], s], ["exit", i[a][1], s], ["exit", h, s]]);
            G(i, u - 1, a - u + 3, m);
            a = u + m.length - 2;
            break;
          }
...
function Lr(e, n, t) {
  ...
  function k(p) {
    ...
    if (r.parser.lazy[r.now().line]) {
      ...
      i = false;
      if (O(p)) {
        return F(e, f, "linePrefix", r.parser.constructs.disable.null.includes("codeIndented") ? undefined : 4)(p);
      } else {
        return f(p);
      }
    }
...
function Rr(e, n) {
  ...
  while (++t < e.length) {
    ...
    if (k[0] === "enter") {
      ...
      } else if (o && (f.type === "data" || f.type === "tableDelimiterMarker" || f.type === "tableDelimiterFiller")) {
        r = false;
        if (i[2] === 0) {
          if (l[1] !== 0) {
            i[0] = i[1];
...
`);
  ...
  function r(l, i, s) {
    let a = l.value || "";
    let u = 1;
    for (n || u++; new RegExp("(^|[^$])" + "\\$".repeat(u) + "([^$]|$)").test(a);) {
      u++;
    }
    const h = "$".repeat(u);
    if (/[^ \r\n]/.test(a) && (/^[ \r\n]/.test(a) && /[ \r\n]$/.test(a) || /^\$|\$$/.test(a))) {
...
function Hr(e, n, t) {
  ...
  const l = o && o[1].type === "linePrefix" ? o[2].sliceSerialize(o[1], true).length : 0;
  let i = 0;
  return s;
  function s(d) {
    e.enter("mathFlow");
  ...
  function x(d, w, v) {
    let T = 0;
    return F(d, M, "linePrefix", r.parser.constructs.disable.null.includes("codeIndented") ? undefined : 4);
    function M(A) {
...
const oi = (e, n) => {
  ...
  for (const l of e.matchAll(t)) {
    ...
    const f = m.end < e.length && e[m.end] !== "\r" && e[m.end] !== `
`;
    r.push(e.slice(o, l.index));
    const g = k.split(`
...
const li = (e, {
  ...
  const l = s => {
    r.push(s);
    const a = Math.max(s.lastIndexOf(`
`), s.lastIndexOf("\r"));
...
const fi = e => `math-${e.replace(/[^A-Za-z0-9_-]+/g, "-").replace(/^-|-$/g, "")}`;
const mi = e => () => n => {
  let t = 1;
  const r = () => {
    const l = `${e}.${t}`;
...
const di = ["data:image/png;base64,", "data:image/jpeg;base64,", "data:image/svg+xml;base64,"];
const gi = ["data:application/json;base64,", "data:application/pdf;base64,", "data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,", "data:text/csv;base64,"];
const le = e => di.some(n => e.startsWith(n));
const rt = e => gi.some(n => e.startsWith(n));
const Hi = e => le(e) || rt(e);
const ki = [Or, Qr];
const xi = /^[ \t>]*\[Equation ([0-9]+(?:\.[0-9]+)?)\]:[ \t]*#[ \t]*".*"[ \t]*$/gm;
const bi = {
  "\\diff": "\\mathop{}\\!d"
};
const wi = {
...
const yi = e => ve(e, n => n.replace(xi, ""), {
...
const ot = e => e.type === "text" ? e.value : it(e) ? e.children.map(ot).join("") : "";
const Ti = e => {
  const n = e == null ? undefined : e.children.find(r => it(r) && r.tagName.toLowerCase() === "code");
  if (!n) {
    return null;
  }
  const t = Ci(n);
...
const vi = ({
  ...
  const r = Ti(e);
  if (r != null && r.trim()) {
    return <I className="markdown-code-block"><I className="markdown-code-block-actions"><_Component content={r} label="Copy" message="Code copied" size="small" sx={Mi} tooltipLabel="Copy code" variant="outlined" /></I><pre {...t}>{n}</pre></I>;
  } else {
    return <pre {...t}>{n}</pre>;
  }
};
const Ai = ({
  ...
  children: n,
  ...t
}) => <I className="markdown-table-scroll" tabIndex={0}><table {...t}>{n}</table></I>;
const Ei = ({
  node: e,
  src: n,
  alt: t,
  ...
  const l = n.startsWith("data:image/jpeg;") ? "jpg" : n.startsWith("data:image/svg+xml;") ? "svg" : "png";
  const i = o.replace(/[/\\?%*:|"<>]/g, "-").replace(/\s+/g, " ").trim() || "python-artifact";
  const s = () => {
  ...
  return <I component="span" className="markdown-artifact-image"><I component="img" src={n} alt={o} {...r} /><I component="span" className="markdown-artifact-image-actions"><_Component3 tooltip="Download image" aria-label={`Download ${o}`} size="small" disableRipple={true} onClick={s}><_Component2 size={17} /></_Component3></I></I>;
};
const te = {
  a: ({
    node: e,
...
const Fi = (e, n, t) => n === "src" && t.tagName === "img" && le(e) || n === "href" && t.tagName === "a" && rt(e) ? e : At(e);
const Di = {
...
const Me = e => n => {
  ...
  const l = t ? n.palette.getContrastText(n.palette.primary.dark) : n.palette.text.primary;
  const i = t ? C(n.palette.primary.dark, 0.38) : C(n.palette.text.primary, 0.04);
...
const Ii = ({
  ...
  const v = E.useMemo(() => m ? w : gt(w, d.latexTerms), [w, d.latexTerms, m]);
  const T = E.useMemo(() => kt(d, x, b), [x, d, b]);
  const M = E.useMemo(() => m || i === undefined ? T : [...T, mi(i)], [m, i, T]);
  const R = u ? [Me(n), zi] : [Me(n)];
  const $ = Array.isArray(t) ? [...R, ...t] : [...R, t];
  const A = E.useMemo(() => u ? Si : h && !m ? {
    ...te,
    pre: vi
  } : te, [u, m, h]);
  const p = E.useMemo(() => m ? r ? {
    ...A,
    ...r
  } : A : xt(A, r, d.highlightsById, _ => <Pi highlight={_} mathSyntax={s} />), [A, r, d.highlightsById, m, s]);
  return <I component={u ? "span" : "div"} sx={$}><_Component5 remarkPlugins={ki} rehypePlugins={M} components={p} urlTransform={Fi}>{v}</_Component5></I>;
};
const J = E.memo(Ii);
const Pi = ({
  highlight: e,
  mathSyntax: n
}) => <I sx={Di}><J content={e.text} mathSyntax={n} mode="compact" sx={Li} /><J content={e.tooltip} mathSyntax={n} mode="compact" sx={Te} />{e.note ? <I sx={Ri}><J content={e.note} mathSyntax={n} mode="compact" sx={Te} /></I> : null}</I>;
