  ...
  function w(I, x) {
    ...
    function T() {
      ...
      if (s == I.charAt(0) && o == I.charAt(1)) {
        for (var b = 2; f != I.charAt(b) && (o != I.charAt(b) || s != I.charAt(b + 1));) {
          ++b;
        }
        b += 2;
        if (f === I.charAt(b - 1)) {
...
function rr() {
  ...
  Pt = 1;
  var e = Ie && Ie.__importDefault || function (i) {
    if (i && i.__esModule) {
      return i;
    } else {
      return {
  ...
  function t(n) {
    ...
    if (typeof r.line == "number" && r.line > 0 && typeof r.column == "number" && r.column > 0) {
      return {
        line: r.line,
        column: r.column,
        offset: typeof r.offset == "number" && r.offset > -1 ? r.offset : undefined
      };
    }
  }
}
...
function wr(e, t) {
  ...
  for (i in t.properties) {
    if (i !== "children" && ot.call(t.properties, i)) {
      ...
      if (u) {
        const [l, a] = u;
        if (e.tableCellAlignToStyle && l === "align" && typeof a == "string" && cr.has(t.tagName)) {
          r = a;
        } else {
          n[l] = a;
        }
...
function ft(e, t) {
  ...
  while (++r < t.children.length) {
    ...
    let l;
    if (e.passKeys) {
      const c = u.type === "element" ? u.tagName : u.type === "mdxJsxFlowElement" || u.type === "mdxJsxTextElement" ? u.name : undefined;
      if (c) {
        const s = i.get(c) || 0;
        l = c + "-" + s;
        i.set(c, s + 1);
...
function Sr(e, t, n) {
  ...
  if (n != null && (typeof n != "number" || !Number.isNaN(n))) {
    ...
    return [e.elementAttributeNameCase === "react" && r.space ? Zn[r.property] || r.property : r.attribute, n];
  }
}
function Er(e, t) {
  try {
...
function dn(e, t) {
  ...
  if (n < 9 || n === 11 || n > 13 && n < 32 || n > 126 && n < 160 || n > 55295 && n < 57344 || n > 64975 && n < 65008 || (n & 65535) === 65535 || (n & 65535) === 65534 || n > 1114111) {
    return "�";
  } else {
...
function Vr(e) {
  ...
  function I(S, B) {
    ...
    if (t.parser.lazy[S.start.line]) {
      ...
      while (y--) {
        if (i.events[y][1].start.offset < l && (!i.events[y][1].end || i.events[y][1].end.offset > l)) {
          return;
        }
      }
...
function Hr(e, t, n) {
  return H(e, e.attempt(this.parser.constructs.document, t, n), "linePrefix", this.parser.constructs.disable.null.includes("codeIndented") ? undefined : 4);
}
function Bt(e) {
  if (e === null || Y(e) || Br(e)) {
    return 1;
      ...
      for (r = n; r--;) {
        if (e[r][0] === "exit" && e[r][1].type === "attentionSequence" && e[r][1]._open && t.sliceSerialize(e[r][1]).charCodeAt(0) === t.sliceSerialize(e[n][1]).charCodeAt(0)) {
          ...
          if (e[r][1].end.offset - e[r][1].start.offset) {
            s = G(s, [["enter", e[r][1], t], ["exit", e[r][1], t]]);
          }
          s = G(s, [["enter", i, t], ["enter", l, t], ["exit", l, t], ["enter", u, t]]);
          s = G(s, pt(t.parser.constructs.insideSpan.null, e.slice(r + 1, n), t));
          s = G(s, [["exit", u, t], ["enter", a, t], ["exit", a, t], ["exit", i, t]]);
          if (e[n][1].end.offset - e[n][1].start.offset) {
            o = 2;
            s = G(s, [["enter", e[n][1], t], ["exit", e[n][1], t]]);
          } else {
            o = 0;
          }
          re(e, r - 1, n - r + 3, s);
...
function Wr(e, t, n) {
  ...
  function i(l) {
    if (L(l)) {
      return H(e, u, "linePrefix", r.parser.constructs.disable.null.includes("codeIndented") ? undefined : 4)(l);
    } else {
      return u(l);
    }
  }
...
function Zr(e, t, n) {
  ...
  function s(y) {
    ...
    u = F && F[1].type === "linePrefix" ? F[2].sliceSerialize(F[1], true).length : 0;
    a = y;
    e.enter("codeFenced");
  ...
  function j(y, F, v) {
    ...
    function T(b) {
      ...
      if (L(b)) {
        return H(y, C, "linePrefix", r.parser.constructs.disable.null.includes("codeIndented") ? undefined : 4)(b);
      } else {
        return C(b);
      }
    }
...
function ni(e, t, n) {
  ...
  function u(s) {
    ...
    if (o && o[1].type === "linePrefix" && o[2].sliceSerialize(o[1], true).length >= 4) {
      return l(s);
    } else {
      return n(s);
    }
...
function ri(e, t, n) {
  ...
  function u(l) {
    ...
    if (a && a[1].type === "linePrefix" && a[2].sliceSerialize(a[1], true).length >= 4) {
      return t(l);
    } else if (z(l)) {
      return i(l);
    } else {
...
class si {
  ...
  slice(t, n) {
    ...
    if (r < this.left.length) {
      ...
      return this.right.slice(this.right.length - r + this.left.length, this.right.length - t + this.left.length).reverse();
    } else {
      return this.left.slice(t).concat(this.right.slice(this.right.length - r + this.left.length).reverse());
    }
  }
  splice(t, n, r) {
    const i = n || 0;
...
function kn(e) {
  ...
  while (++n < o.length) {
    ...
    r = o.get(n);
    if (n && r[1].type === "chunkFlow" && o.get(n - 1)[1].type === "listItemPrefix" && (c = r[1]._tokenizer.events, u = 0, u < c.length && c[u][1].type === "lineEndingBlank" && (u += 2), u < c.length && c[u][1].type === "content")) {
...
function oi(e, t) {
  ...
  for (h = n; ++d < a.length;) {
    if (a[d][0] === "exit" && a[d - 1][0] === "enter" && a[d][1].type === a[d - 1][1].type && a[d][1].start.line !== a[d][1].end.line) {
      E = d + 1;
      I.push(E);
...
function mi(e, t, n) {
  ...
  function u(l) {
    ...
    const a = r.events[r.events.length - 1];
    if (!r.parser.constructs.disable.null.includes("codeIndented") && a && a[1].type === "linePrefix" && a[2].sliceSerialize(a[1], true).length >= 4) {
      return t(l);
    } else {
...
function bn(e, t, n, r, i, u) {
  ...
  function o(h) {
    if (a > 999 || h === null || h === 91 || h === 93 && !c || h === 94 && !a && "_hiddenFootnoteSupport" in l.parser.constructs) {
      return n(h);
    } else if (h === 93) {
      e.exit(u);
      e.enter(i);
...
function yi(e, t, n) {
  ...
  function l(h) {
    return bn.call(r, e, a, n, "definitionLabel", "definitionLabelMarker", "definitionLabelString")(h);
  }
  function a(h) {
  ...
  function s(h) {
    return wn(e, o, n, "definitionDestination", "definitionDestinationLiteral", "definitionDestinationLiteralMarker", "definitionDestinationRaw", "definitionDestinationString")(h);
  }
  function o(h) {
...
function Si(e, t) {
  ...
  if (n > r) {
    ...
    re(e, r, n - r + 1, [["enter", i, t], ["enter", u, t], ["exit", u, t], ["exit", i, t]]);
  }
  return e;
}
function Ei(e, t, n) {
...
function _i(e, t, n) {
  ...
  function v(m) {
    if (m === null || m === 34 || m === 39 || m === 47 || m === 60 || m === 61 || m === 62 || m === 96 || Y(m)) {
      return j(m);
    } else {
      e.consume(m);
      return v;
...
function Li(e, t, n) {
  ...
  function A(p) {
    if (p === null || p === 34 || p === 39 || p === 60 || p === 61 || p === 96) {
      return n(p);
    } else if (p === 47 || p === 62 || Y(p)) {
      return D(p);
    } else {
  ...
  function J(p) {
    if (L(p)) {
      return H(e, ie, "linePrefix", r.parser.constructs.disable.null.includes("codeIndented") ? undefined : 4)(p);
    } else {
      return ie(p);
    }
  }
...
function Bi(e) {
  ...
  while (++t < e.length) {
    const r = e[t][1];
    n.push(e[t]);
    if (r.type === "labelImage" || r.type === "labelLink" || r.type === "labelEnd") {
  ...
  function a(d) {
    if (u) {
      if (u._inactive) {
        ...
        l = r.parser.defined.includes(xe(r.sliceSerialize({
          start: u.end,
          end: r.now()
        })));
        e.enter("labelEnd");
...
function vi(e, t, n) {
  ...
  function u(f) {
    if (f === 41) {
      ...
      return wn(e, l, a, "resourceDestination", "resourceDestinationLiteral", "resourceDestinationLiteralMarker", "resourceDestinationRaw", "resourceDestinationString", 32)(f);
    }
  }
  function l(f) {
    if (Y(f)) {
  ...
  function c(f) {
    if (f === 34 || f === 39 || f === 40) {
      return Sn(e, s, n, "resourceTitle", "resourceTitleMarker", "resourceTitleString")(f);
    } else {
      return o(f);
    }
  }
...
function Vi(e, t, n) {
  ...
  function u(a) {
    if (r.parser.defined.includes(xe(r.sliceSerialize(r.events[r.events.length - 1][1]).slice(1, -1)))) {
      return t(a);
    } else {
      return n(a);
    }
...
function Ji(e, t, n) {
  ...
  function c(h) {
    if (nt(h) && ++l < 10) {
      e.consume(h);
      return c;
    } else if ((!r.interrupt || l < 2) && (r.containerState.marker ? h === r.containerState.marker : h === 41 || h === 46)) {
...
function Ki(e, t, n) {
  ...
  function l(a) {
    ...
    return H(e, e.attempt(Q, t, n), "linePrefix", r.parser.constructs.disable.null.includes("codeIndented") ? undefined : 4)(a);
  }
}
function Zi(e, t, n) {
  const r = this;
  ...
  function i(u) {
    ...
    if (l && l[1].type === "listItemIndent" && l[2].sliceSerialize(l[1], true).length === r.containerState.size) {
      return t(u);
    } else {
      return n(u);
    }
...
function tu(e, t, n) {
  const r = this;
  return H(e, i, "listItemPrefixWhitespace", r.parser.constructs.disable.null.includes("codeIndented") ? undefined : 5);
  function i(u) {
    const l = r.events[r.events.length - 1];
...
function uu(e) {
  const t = this;
  const n = e.attempt(je, r, e.attempt(this.parser.constructs.flowInitial, i, H(e, e.attempt(this.parser.constructs.flow, i, e.attempt(ci, i)), "linePrefix")));
  return n;
  function r(u) {
    if (u === null) {
      e.consume(u);
    ...
    function V(A, b, O) {
      ...
      function K(U) {
        ...
        function we(se) {
          ...
          const Fe = [...(Array.isArray(pe) ? pe : pe ? [pe] : []), ...(Array.isArray(me) ? me : me ? [me] : [])];
          return ue(Fe)(se);
        }
      }
      function ue(U) {
      ...
      function m(U) {
        ...
        function we(se) {
          ...
          if (U.name && s.parser.constructs.disable.null.includes(U.name)) {
            ...
            return U.tokenize.call(C ? Object.assign(Object.create(s), C) : s, c, Z, fe)(se);
          }
        }
      }
      function Z(U) {
...
function Cu() {
  ...
  function i(u, l, a) {
    ...
    let d;
    let h;
    u = t + (typeof u == "string" ? u.toString() : new TextDecoder(l || undefined).decode(u));
    f = 0;
    t = "";
    if (n) {
...
function _u(e, t, n) {
  ...
  return Pu(n)(Iu(Eu(n).document().write(Cu()(e, t, true))));
}
function Pu(e) {
  const t = {
    transforms: [],
  ...
  function r(g) {
    ...
    for (M = -1; ++M < g.length;) {
      ...
      if (Cn.call(ee, g[M][1].type)) {
        ee[g[M][1].type].call(Object.assign({
  ...
  function i(g, k, P) {
    ...
    while (++N <= P) {
      ...
      if (!M && X[0] === "enter" && X[1].type === "listItemPrefix" || M === -1 && X[0] === "exit" && (X[1].type === "listUnordered" || X[1].type === "listOrdered")) {
        if (he) {
          let de = N;
          for (le = undefined; de--;) {
            const ae = g[de];
  ...
  function s(g, k) {
    ...
    if (N) {
      ...
      throw new Error("Cannot close `" + g.type + "` (" + Ae({
        start: g.start,
        end: g.end
      }) + "): it’s not open");
    }
  ...
  function T(g) {
    ...
    if (!this.data.setextHeadingSlurpLineEnding && t.canContainEols.includes(k.type)) {
      D.call(this, g);
      R.call(this, g);
    }
  }
...
function Ut(e, t) {
  throw e ? new Error("Cannot close `" + e.type + "` (" + Ae({
    start: e.start,
    end: e.end
...
const Me = typeof structuredClone == "function" ? (e, t) => t && ("json" in t || "lossy" in t) ? Wt(Gt(e, t)) : structuredClone(e) : (e, t) => Wt(Gt(e, t));
function ol(e, t) {
  const n = [{
    type: "text",
    value: "↩"
  ...
  function s(o) {
    ...
    if ("children" in o) {
      ...
      while (++h < d.length) {
        const w = a.one(d[h], o);
        if (w) {
          if (h && d[h - 1].type === "break" && (!Array.isArray(w) && w.type === "text" && (w.value = Jt(w.value)), !Array.isArray(w) && w.type === "element")) {
...
function gl(e, t) {
  const n = t.data || {};
  const r = "value" in t && !it.call(n, "hProperties") && !it.call(n, "hChildren") ? {
    type: "text",
    value: t.value
  } : {
    type: "element",
...
function kl() {
  ...
  function u(s) {
    ...
    var f = s.constructor && s.constructor.prototype && e.call(s.constructor.prototype, "isPrototypeOf");
...
function lt(e) {
  return e !== null && typeof e == "object" && !!("href" in e) && !!e.href && !!("protocol" in e) && !!e.protocol && e.auth === undefined;
}
function Nl(e) {
  if (typeof e == "string") {
    e = new URL(e);
...
function $l(e, t) {
  ...
  for (const o of Hl) {
    if (Object.hasOwn(t, o.from)) {
      "" + o.from + (o.to ? "use `" + o.to + "` instead" : "remove it") + vl + o.id;
      undefined;
    }
  }
  Fn(e, s);
...
function Ql(e) {
  ...
  const r = e.indexOf("#");
  const i = e.indexOf("/");
  if (t === -1 || i !== -1 && t > i || n !== -1 && t > n || r !== -1 && t > r || Vl.test(e.slice(0, t))) {
    return e;
  } else {
    return "";
  }
}
export { Gl as M, Or as a, W as b, Bt as c, ne as d, tt as e, je as f, H as g, z as h, L as i, Pr as j, Ql as k, Y as m, xe as n, Wl as o, pt as r, re as s, zr as t, Br as u, Fn as v };
