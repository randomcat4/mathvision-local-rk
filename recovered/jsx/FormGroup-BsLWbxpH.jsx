import { A as v, j as s, ab as z, am as F, r as u, F as I, G as H, H as P, a8 as m, I as R, K as j, aQ as U, a3 as V, aV as y } from "./index-BM3ZINIl.js";
import { S as B } from "./FormControlLabel-CQvCddOM.js";
import { m as O, u as E, f as N } from "./TextField-D8vc_sXz.js";
const D = v(<path d="M19 5v14H5V5h14m0-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z" />);
const L = v(<path d="M19 3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.11 0 2-.9 2-2V5c0-1.1-.89-2-2-2zm-9 14l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" />);
const T = v(<path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-2 10H7v-2h10v2z" />);
function A(o) {
  return z("MuiCheckbox", o);
}
const C = F("MuiCheckbox", ["root", "checked", "disabled", "indeterminate", "colorPrimary", "colorSecondary", "sizeSmall", "sizeMedium"]);
const K = o => {
  const {
    classes: e,
    indeterminate: r,
...
const Q = j(B, {
  ...
  overridesResolver: (o, e) => {
    ...
    return [e.root, r.indeterminate && e.indeterminate, e[`size${m(r.size)}`], r.color !== "default" && e[`color${m(r.color)}`]];
  }
})(V(({
  theme: o
}) => ({
