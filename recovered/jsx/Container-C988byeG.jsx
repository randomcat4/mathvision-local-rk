import { r as h, j as W, H as k, a7 as v, a8 as c, a9 as R, I as G, aa as $, ab as M, F as P, K as S } from "./index-BM3ZINIl.js";
const T = $();
const j = v("div", {
  name: "MuiContainer",
  slot: "Root",
  overridesResolver: (e, s) => {
    ...
    return [s.root, s[`maxWidth${c(String(o.maxWidth))}`], o.fixed && s.fixed, o.disableGutters && s.disableGutters];
  }
});
const y = e => R({
  props: e,
...
const L = (e, s) => {
  ...
  const a = {
    root: ["root", t && `maxWidth${c(String(t))}`, p && "fixed", l && "disableGutters"]
  };
  return G(a, o, u);
};
function N(e = {}) {
  ...
  const _Component = s(({
    ...
    theme: t,
    ownerState: a
  }) => a.fixed && Object.keys(t.breakpoints.values).reduce((i, r) => {
    const d = r;
  ...
  return h.forwardRef(function (a, i) {
    ...
    const g = L(x, u);
    return <_Component as={n} ownerState={x} className={k(g.root, d)} ref={i} {...C} />;
  });
}
const D = N({
