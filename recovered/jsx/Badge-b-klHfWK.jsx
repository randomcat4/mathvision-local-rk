import { r as f, ab as Z, am as _, F as G, G as O, H as K, j as S, a8 as n, I as q, K as T, a3 as J, aV as Q } from "./index-BM3ZINIl.js";
function z(a) {
  const o = f.useRef({});
  f.useEffect(() => {
    o.current = a;
...
const ra = a => {
  ...
  const i = {
    root: ["root"],
    badge: ["badge", l, r && "invisible", `anchorOrigin${n(t.vertical)}${n(t.horizontal)}`, `anchorOrigin${n(t.vertical)}${n(t.horizontal)}${n(e)}`, `overlap${n(e)}`, o !== "default" && `color${n(o)}`]
  };
  return q(i, oa, s);
};
const ea = T("span", {
...
const na = T("span", {
  ...
  overridesResolver: (a, o) => {
    ...
    return [o.badge, o[t.variant], o[`anchorOrigin${n(t.anchorOrigin.vertical)}${n(t.anchorOrigin.horizontal)}${n(t.overlap)}`], t.color !== "default" && o[`color${n(t.color)}`], t.invisible && o.invisible];
  }
})(J(({
  theme: a
}) => ({
  ...
  variants: [...Object.entries(a.palette).filter(Q(["contrastText"])).map(([o]) => ({
    props: {
      color: o
    },
    style: {
