import { r as g, ab as O, am as H, F, aY as no, G as y, H as N, j as s, I as V, K as m, Q as ro, a3 as A, aD as eo, A as z, S as L, T as _Component5, B as K, g as l } from "./index-BM3ZINIl.js";
...
const P = H("MuiAccordion", ["root", "heading", "rounded", "expanded", "disabled", "gutters", "region"]);
const po = o => {
  const {
    classes: t,
    square: n,
...
const _Component8 = g.forwardRef(function (t, n) {
  ...
  return <E {...D}><G {...u}><q.Provider value={w}>{x}</q.Provider></G><$ in={p} timeout="auto" {...j}><Z {...oo}>{S}</Z></$></E>;
});
function bo(o) {
...
const I = H("MuiAccordionSummary", ["root", "expanded", "focusVisible", "disabled", "gutters", "content", "expandIconWrapper"]);
const ho = o => {
  const {
    classes: t,
    expanded: n,
...
const Mo = g.forwardRef(function (t, n) {
  ...
  return <_Component2 {...v}><C {...E}>{a}</C>{i && <D {...G}>{i}</D>}</_Component2>;
});
const _Component3 = z(<path d="M16.59 8.59 12 13.17 7.41 8.59 6 10l6 6 6-6z" />);
const _Component4 = z(<path d="M19.3 16.9c.58-1.01.95-2.23.51-3.65-.53-1.72-2.04-3.05-3.84-3.22-2.87-.28-5.23 2.07-4.95 4.95.18 1.79 1.5 3.31 3.22 3.84 1.43.44 2.64.07 3.65-.51l2.5 2.5c.39.39 1.01.39 1.4 0s.39-1.01 0-1.4zm-3.8.1c-1.4 0-2.5-1.1-2.5-2.5s1.1-2.5 2.5-2.5 2.5 1.1 2.5 2.5-1.1 2.5-2.5 2.5M12 20v2C6.48 22 2 17.52 2 12S6.48 2 12 2c4.84 0 8.87 3.44 9.8 8h-2.07c-.64-2.46-2.4-4.47-4.73-5.41V5c0 1.1-.9 2-2 2h-2v2c0 .55-.45 1-1 1H8v2h2v3H9l-4.79-4.79C4.08 10.79 4 11.38 4 12c0 4.41 3.59 8 8 8" />);
const To = /[\p{L}\p{N}_]/u;
const U = o => !!o && !!To.test(o);
const Q = (o, t) => Number.isInteger(t) && t >= 0 && t <= o.length && co(o).mathRanges.some(n => n.start < t && t < n.end);
...
const Po = o => o.replace(/\\/g, "\\\\").replace(/\[/g, "\\[").replace(/\]/g, "\\]");
...
const _ = o => o.replace(/[-_]+/g, " ").replace(/\b\w/g, t => t.toUpperCase());
const Ho = o => {
  var t;
  return ((t = o.title) == null ? undefined : t.trim()) || o.domain.trim() || o.url;
};
const Y = o => {
  var a;
  const t = o.domain.trim().replace(/^www\./i, "").replace(/\/+$/g, "");
...
const X = o => o.filter(t => t.type === "text").map(t => t.text ?? "").join("");
const Fo = (o, t) => {
  if (t.startIndex === undefined || t.startIndex === null || t.endIndex === undefined || t.endIndex === null || t.startIndex < 0 || t.endIndex < t.startIndex || t.endIndex > o.length) {
    return null;
  }
  let n = t.endIndex;
  if (ko(o, n)) {
...
const zo = (o, t, n) => {
  ...
  }).filter(e => e.insertIndex !== null && !!e.marker).sort((e, i) => i.insertIndex - e.insertIndex || i.citationIndex - e.citationIndex);
  if (a.length === 0) {
    return o;
  } else {
...
const Ko = (o, t, n) => {
  ...
  const i = n.map(d => {
    ...
    if (Q(a, e)) {
      ...
      return J(d.sourceIds.map(c => r.get(c)).filter(c => c !== undefined));
    }
  }).join("");
  if (i.trim()) {
    return i;
...
const nt = ({
  ...
  return <_Component8 disableGutters={true} sx={Eo}><Mo expandIcon={<_Component3 fontSize="small" />} sx={Do}><L component="span" direction="row" sx={Go}><_Component4 fontSize="small" /><_Component5 component="span" variant="assistantSourceSummary" color="textPrimary">{t}</_Component5></L></Mo><So sx={Lo}>{o.map((n, r) => <K component="a" sx={_o} href={n.url} target="_blank" rel="noopener noreferrer" key={n.id}><_Component6 label={r + 1} sx={{
          borderRadius: 999
        }} variant="outlined" color="primary" /><L sx={{
          minWidth: 0
        }}><_Component5 variant="assistantSourceTitle" color="textPrimary">{Ho(n)}</_Component5><L component="span" direction="row" useFlexGap={true} sx={Uo}><_Component5 component="span" variant="assistantSourceMeta" color="textSecondary">{n.domain || n.url}</_Component5><_Component5 component="span" variant="assistantSourceMeta" color="textSecondary">{_(n.provider)}</_Component5><_Component5 component="span" variant="assistantSourceMeta" color="textSecondary">{_(n.tool)}</_Component5>{n.status !== "used" ? <_Component5 component="span" variant="assistantSourceMeta" color="textSecondary">{_(n.status)}</_Component5> : null}</L></L><_Component7 fontSize="small" sx={Oo} /></K>)}</So></_Component8>;
};
...
export { No as A, _Component3 as E, rt as M, Po as a, $o as b, Q as c, nt as d, _Component8 as e, Mo as f, Zo as g, So as h, ko as i, ot as j, tt as k, jo as t };
