...
import { b as br, a as _Component0 } from "./Markdown-Dh8LhaRc.js";
import { r as j, ab as te, am as re, F as ne, j as h, H as oe, I as se, K as ae, a3 as Pe, a8 as Q, E as Ut, B as P, _ as Ce, T as L, g as z, S as _Component7, V as $r, X as _Component8 } from "./index-BM3ZINIl.js";
import { d as _r, T as Ar, a as _Component4, F as Er } from "./MarkdownHighlights-C-ZhT8z1.js";
...
import { C as _Component10 } from "./Card-Bf0WPnf4.js";
...
const Or = j.forwardRef(function (t, r) {
  ...
  return <Xt.Provider value={i}><_Component as={n} role={n === Xe ? null : "table"} ref={r} className={oe(b.root, a)} ownerState={m} {...u} /></Xt.Provider>;
});
...
const Lr = j.forwardRef(function (t, r) {
  ...
  const l = zr(d);
  return <Me.Provider value={Hr}><Dr className={oe(l.root, a)} as={n} ref={r} role={n === qe ? null : "rowgroup"} ownerState={d} {...o} /></Me.Provider>;
});
function Fr(e) {
  return te("MuiTableCell", e);
}
const Br = re("MuiTableCell", ["root", "head", "body", "footer", "sizeSmall", "sizeMedium", "paddingCheckbox", "paddingNone", "alignLeft", "alignCenter", "alignRight", "alignJustify", "stickyHeader"]);
const Ur = e => {
  const {
    classes: t,
    variant: r,
  ...
  const d = {
    root: ["root", r, o && "stickyHeader", s !== "inherit" && `align${Q(s)}`, a !== "normal" && `padding${Q(a)}`, `size${Q(n)}`]
  };
  return se(d, Fr, t);
};
const Wr = ae("td", {
  ...
  overridesResolver: (e, t) => {
    ...
    return [t.root, t[r.variant], t[`size${Q(r.size)}`], r.padding !== "normal" && t[`padding${Q(r.padding)}`], r.align !== "inherit" && t[`align${Q(r.align)}`], r.stickyHeader && t.stickyHeader];
  }
})(Pe(({
  theme: e
}) => ({
...
const Ge = j.forwardRef(function (t, r) {
  ...
  return <Wr as={y} ref={r} className={oe(E.root, n)} aria-sort={x} scope={_} ownerState={S} {...i} />;
});
function Xr(e) {
...
const Qr = j.forwardRef(function (t, r) {
  ...
  const l = Kr(d);
  return <Me.Provider value={Zr}><Jr as={n} className={oe(l.root, a)} ref={r} role={n === Ve ? null : "rowgroup"} ownerState={d} {...o} /></Me.Provider>;
});
function en(e) {
...
const Je = j.forwardRef(function (t, r) {
  ...
  const b = tn(m);
  return <_Component2 as={n} ref={r} className={oe(b.root, a)} role={n === Ke ? null : "row"} ownerState={m} {...l} />;
});
/**
...
const qt = new Set(["version", "directed", "multigraph", "graph", "nodes", "edges"]);
const cn = qt;
const ln = new Set(["title", "description", "layout", "node_count", "edge_count"]);
const un = new Set(["layout", "node_count", "edge_count"]);
const dn = new Set(ze);
const st = new Set(["id", "label", "group", "x", "y"]);
const pn = new Set(["id", "source", "target"]);
const mn = new Set(["callback", "class", "classes", "css", "extension", "href", "html", "image", "layout", "plugin", "renderer", "src", "style", "stylesheet", "url"]);
const fn = ["add", "click", "drag", "error", "free", "grab", "key", "layout", "load", "mouse", "move", "pan", "pointer", "position", "ready", "remove", "render", "resize", "select", "tap", "touch", "unselect", "zoom"];
const hn = /<\s*\/?\s*[a-z][a-z0-9:-]*(?:(?:\s+|\/)[^<>]*)?>|(?:javascript|vbscript)\s*:|(?:https?|ftp|file|blob|mailto|tel):(?=\S)|\bdata:(?=[^\s,]*,)|\/\/[a-z0-9.-]+\.[a-z]{2,}\b|\bwww\.[a-z0-9.-]+\.[a-z]{2,}\b/i;
const he = e => e !== null && typeof e == "object" && !Array.isArray(e) ? e : null;
...
const Kt = (e, t) => {
  if (hn.test(e)) {
    throw new Error(`Interactive graph ${t} contains prohibited HTML, executable, or external-resource text.`);
  }
};
const ye = (e, t) => {
  if (typeof e != "string") {
...
const Jt = (e, t) => {
  ...
  throw new Error(`Interactive graph ${t} must be null, a boolean, a finite number, or a string.`);
};
const Zt = (e, t, r) => {
  if (!e || e.length > rt) {
    throw new Error(`Interactive graph attribute key ${t} must contain between 1 and ${rt} characters.`);
  }
  if (r) {
    return;
  }
  const a = e.replace(new RegExp("(?<=[a-z0-9])(?=[A-Z])", "g"), "_").toLowerCase().replace(/[^a-z0-9]+/g, "_").replace(/^_+|_+$/g, "");
  if (a.split("_").filter(Boolean).some(d => mn.has(d))) {
    throw new Error(`Interactive graph attribute ${t} uses a reserved renderer or resource field.`);
  }
...
const yn = e => {
  ...
  while (t.length > 0) {
    const r = t.pop();
    if (r.depth > ot) {
      throw new Error(`Interactive graph exceeds the ${ot}-level nesting limit.`);
    }
    if (Array.isArray(r.value)) {
      r.value.forEach(a => t.push({
        depth: r.depth + 1,
        value: a
      }));
      continue;
    ...
    const s = he(r.value);
    if (s) {
      Object.values(s).forEach(a => t.push({
        depth: r.depth + 1,
        value: a
      }));
    }
...
const bn = (e, t, r) => {
  ...
  if (o !== t) {
    throw new Error(`Interactive graph node count does not match its nodes: declared=${o}, actual=${t}.`);
  }
  if (d !== r) {
    throw new Error(`Interactive graph edge count does not match its edges: declared=${d}, actual=${r}.`);
  }
  return {
    layout: n,
    nodeCount: o,
...
const wn = (e, t, r, s) => {
  ...
  return e.map((o, d) => {
    ...
    if (a.has(b)) {
      throw new Error(`Interactive graph contains duplicate global element ID ${b}.`);
    }
    a.add(b);
    if (!t.has(i)) {
    ...
    if (!s) {
      const y = r || i <= c ? `${i.length}:${i}${c.length}:${c}` : `${c.length}:${c}${i.length}:${i}`;
      if (n.has(y)) {
        throw new Error(`Interactive graph non-multigraph contains duplicate edge endpoints ${i}, ${c}.`);
      }
      n.add(y);
...
const os = async (e, t) => {
  if (!Qt(t)) {
    throw new Error(`Interactive graph artifacts must use a ${_e} filename and ${de} content type.`);
  }
  if (Gt(e.type) !== de) {
  ...
  if (e.size > Ze) {
    throw new Error(`Interactive graph attachment exceeds the ${Ze}-byte limit.`);
  }
  if (t.sizeBytes !== null && t.sizeBytes !== e.size) {
    throw new Error(`Interactive graph attachment size did not match its ${t.sizeBytes}-byte metadata.`);
  }
  let r;
  try {
  ...
  const a = he(s);
  if (!a) {
    throw new Error("Interactive graph attachment must contain a top-level JSON object.");
  }
  yn(a);
  const n = Yt(a, cn);
  if (n.length > 0) {
...
const En = (e, t, r) => <L variant="caption" color="textSecondary">Showing {e} preview {e === 1 ? "row" : "rows"} · {t} {t === 1 ? "column" : "columns"}{r && " · More data exists"}</L>;
const er = e => e !== null && typeof e == "object" && !Array.isArray(e) ? e : null;
const be = e => typeof e == "string" ? e : null;
const Sn = e => typeof e == "number" && Number.isFinite(e) ? e : null;
const ee = e => typeof e == "boolean" ? e : null;
const X = e => typeof e == "number" && Number.isInteger(e) && e >= 0 ? e : null;
const Tn = e => !Array.isArray(e) || e.some(t => typeof t != "string") ? null : e;
const In = e => {
  if (!Array.isArray(e)) {
    return null;
  }
...
const Mn = e => {
  ...
  const n = be(e.layout);
  if (t === null || r === null || s === null || a === null || !n || !ze.includes(n)) {
    return null;
  } else {
    return {
      kind: "graph",
...
const jn = e => {
  ...
  if (t !== 1 || r === null || s === null || a === null || n === null || o === null || d === null || l === null || u === null || m === null) {
    return null;
  } else {
    return {
      kind: "scene",
...
const _Component5 = ({
  preview: e,
  label: t
}) => <h.Fragment>{En(e.rows.length, e.columns.length, e.truncated)}<Vr sx={_n}><Or size="small" stickyHeader={true} aria-label={t} sx={An}><caption>{t}</caption><Qr><Je>{e.columns.map((r, s) => <Ge scope="col" key={`${r}-${s}`}>{r}</Ge>)}</Je></Qr><Lr>{e.rows.map((r, s) => <Je key={`preview-row-${s}`}>{e.columns.map((a, n) => <Ge key={`preview-cell-${s}-${n}`}>{r[n] ?? ""}</Ge>)}</Je>)}</Lr></Or></Vr></h.Fragment>;
const _Component6 = ({
  children: e,
  label: t,
  inlineAction: r = false
}) => {
  const [s, a] = j.useState(false);
  const n = j.useId();
  return <P sx={o => $n(o, r)}><P><Ce type="button" size="small" variant="outlined" color="primary" startIcon={<_Component3 size={16} />} disableRipple={true} aria-expanded={s} aria-controls={n} onClick={() => a(o => !o)}>Preview</Ce></P><_r in={s} timeout="auto" id={n} sx={r ? xn : undefined}><P component="section" aria-label={t}>{e}</P></_r></P>;
};
const Nn = ({
  preview: e,
  inlineAction: t = false
}) => {
  const [r, s] = j.useState(0);
  const a = Math.min(r, Math.max(e.sheets.length - 1, 0));
  const n = e.sheets[a];
  return <_Component6 label="Workbook data preview" inlineAction={t}><L variant="caption" color="textSecondary">{e.sheetCount} {e.sheetCount === 1 ? "sheet" : "sheets"}{e.truncated && " · Preview is bounded"}</L>{e.sheets.length > 0 && <Ar value={a} onChange={(o, d) => {
      s(d);
    }} variant="scrollable" scrollButtons="auto" aria-label="Workbook sheets" sx={vn}>{e.sheets.map((o, d) => <_Component4 label={o.name} value={d} key={`${o.name}-${d}`} />)}</Ar>}{n && <_Component5 preview={n} label={`${n.name} data preview`} />}{e.sheets.length === 0 && <L variant="body2" color="textSecondary">This workbook does not contain any previewable sheets.</L>}</_Component6>;
};
const _Component1 = ({
  preview: e,
  label: t,
  inlineAction: r = false
}) => e.kind === "table" ? <_Component6 label={t} inlineAction={r}><_Component5 preview={e} label={t} /></_Component6> : e.kind === "workbook" ? <Nn preview={e} inlineAction={r} /> : null;
...
const Pn = new Set(["choropleth", "choroplethmap", "choroplethmapbox", "densitymap", "densitymapbox", "scattergeo", "scattermap", "scattermapbox"]);
const zn = new Set(["geo", "map", "mapbox"]);
const Dn = new Set(["customdata", "hovertemplate", "hovertext", "label", "labels", "meta", "name", "prefix", "suffix", "text", "texttemplate", "ticktext", "title"]);
const Hn = /^data:image\/(?:jpeg|png|webp);base64,([A-Za-z0-9+/]+={0,2})$/i;
const Ln = /<\s*(?:script|iframe|object|embed|link|meta|style|svg|math|img)\b|\b(?:href|src|srcdoc|style|on[a-z]+)\s*=|(?:javascript|vbscript)\s*:|data\s*:\s*text\/html/i;
const as = {
  responsive: false,
  displaylogo: false,
  editable: false,
  ...
  doubleClick: false,
  displayModeBar: true,
  modeBarButtonsToRemove: ["sendDataToCloud", "editInChartStudio", "resetCameraLastSave3d", "zoomIn2d", "zoomOut2d", "autoScale2d"]
};
const D = e => e !== null && typeof e == "object" && !Array.isArray(e) ? e : null;
const or = e => e.split(";", 1)[0].trim().toLowerCase();
const sr = e => e.name.toLowerCase().endsWith(ve) && or(e.mimeType) === pe;
const is = e => {
  if (e !== it) {
    throw new Error(`Interactive Plotly viewer requires Plotly.js ${it}, but loaded ${e ?? "an unknown version"}.`);
  }
};
const cs = async (e, t) => {
  if (!sr(t)) {
    throw new Error(`Interactive Plotly artifacts must use a ${ve} filename and ${pe} content type.`);
  }
  if (or(e.type) !== pe) {
  ...
  if (e.size > ct) {
    throw new Error(`Interactive Plotly attachment exceeds the ${ct}-byte limit.`);
  }
  if (t.sizeBytes !== null && t.sizeBytes !== e.size) {
    throw new Error(`Interactive Plotly attachment size did not match its ${t.sizeBytes}-byte metadata.`);
  }
  let r;
  try {
    r = new TextDecoder("utf-8", {
  ...
  const a = D(s);
  if (!a) {
    throw new Error("Interactive Plotly attachment must contain a top-level JSON object.");
  }
  const n = Object.keys(a).filter(b => !On.has(b));
  if (n.length > 0) {
    throw new Error(`Interactive Plotly attachment contains unsupported top-level fields: ${n.join(", ")}.`);
  }
  ...
  u.forEach((b, i) => {
    ...
    if (f !== undefined) {
      const g = D(f);
      if (!g) {
        throw new Error(`Interactive Plotly frames[${i}].layout must be an object.`);
      }
...
const mt = (e, t) => {
  e.forEach((r, s) => {
    ...
    if (n && Pn.has(n)) {
      throw new Error(`Interactive Plotly ${t}[${s}] uses unsupported network-dependent trace type ${n}.`);
    }
    if (n === "image") {
...
const ft = (e, t) => {
  ...
  if (r.length > 0) {
    throw new Error(`Interactive Plotly ${t} uses unsupported network-dependent fields: ${r.join(", ")}.`);
  }
...
const De = (e, t) => {
  ...
  try {
    ...
    throw new Error(`Interactive Plotly ${t} contains invalid base64 image data.`, {
      cause: s
    });
  }
};
...
const Wn = (e, t) => {
  ...
  while (r.length > 0) {
    ...
    if (typeof s == "string") {
      if (Ln.test(s)) {
        throw new Error(`Interactive Plotly field ${t} contains prohibited executable or resource-loading HTML text.`);
      }
      continue;
    }
    if (Array.isArray(s)) {
...
const Gn = (e, t) => typeof e != "string" || e.length === 0 || e.length > qn || !Xn.test(e) ? N(t, "must start with a letter and contain only letters, numbers, underscores, or hyphens.") : e;
const Vn = (e, t) => Number.isFinite(e) ? e : N(t, "must be a finite number.");
const Yn = new Set(["neg", "abs", "sqrt", "exp", "log", "log10", "sin", "cos", "tan", "asin", "acos", "atan", "sinh", "cosh", "tanh", "floor", "ceil", "round", "sign"]);
const Kn = new Set(["add", "sub", "mul", "div", "pow", "mod", "min", "max", "atan2"]);
    ...
    if (i === "var" || i === "param" || i === "const") {
      ...
      if (i === "var") {
        if (r.variables.has(f)) {
          ...
          return {
            expression: [i, f],
            type: ((c = r.variableTypes) == null ? undefined : c.get(f)) ?? "number"
          };
        } else {
...
const C = (e, t) => e === null || typeof e != "object" || Array.isArray(e) ? p(t, "must be an object.") : e;
const A = (e, t, r, s = []) => {
  for (const o of r) {
...
const U = (e, t) => typeof e != "number" || !Number.isFinite(e) ? p(t, "must be a finite number.") : e;
const F = (e, t) => {
  const r = U(e, t);
...
const k = (e, t, r) => typeof e != "string" ? p(t, "must be a string.") : [...e].length > r ? p(t, `must contain no more than ${r} characters.`) : ro.test(e) || to.test(e) ? p(t, "contains unsupported markup or control characters.") : e;
const O = (e, t) => typeof e != "string" || e.length === 0 || e.length > ar || !eo.test(e) ? p(t, "must start with a letter and contain only letters, numbers, underscores, or hyphens.") : e;
const ue = (e, t, r) => !Array.isArray(e) || e.length !== r ? p(t, `must contain exactly ${r} numbers.`) : e.map((s, a) => U(s, `${t}/${a}`));
const no = e => {
  const t = C(e, "/metadata");
  A(t, "/metadata", ["title"], ["description"]);
  const r = Object.hasOwn(t, "description") ? k(t.description, "/metadata/description", He) : undefined;
  return {
...
const oo = (e, t) => e === undefined ? "live" : e !== "live" && e !== "commit" ? p(t, "must be live or commit.") : e;
const so = e => {
  if (!Array.isArray(e)) {
  ...
  return e.map((r, s) => {
    ...
    if (n.type === "float" || n.type === "int") {
      A(n, a, ["id", "label", "type", "default"], ["update", "minimum", "maximum", "slider", "unit"]);
      const m = n.type === "int" ? F : U;
      const b = m(n.default, `${a}/default`);
      const i = Object.hasOwn(n, "minimum") ? m(n.minimum, `${a}/minimum`) : undefined;
      const c = Object.hasOwn(n, "maximum") ? m(n.maximum, `${a}/maximum`) : undefined;
      ...
      const g = Object.hasOwn(n, "unit") ? k(n.unit, `${a}/unit`, ar) : undefined;
      return {
        ...u,
        type: n.type,
        default: b,
    ...
    if (n.type === "enum") {
      ...
      if (!Array.isArray(n.options) || n.options.length < 1 || n.options.length > Ht) {
...
const cr = e => new Map(e.map(t => [t.id, t.type === "float" || t.type === "int" ? "number" : t.type === "bool" ? "boolean" : "string"]));
const ge = (e, t, r) => ({
  parameterTypes: cr(e),
  totalNodeCount: r,
  variables: t
...
const io = (e, t, r) => {
  ...
  if (t === "date") {
    ...
    if (!/^\d{4}-\d{2}-\d{2}$/.test(s) || s.startsWith("0000-") || Number.isNaN(a.valueOf()) || a.toISOString().slice(0, 10) !== s) {
  ...
  for (const [o, d] of e.entries()) {
    ...
    if (u.type === "table") {
      ...
      const y = u.columns.map((w, S) => {
        ...
        if (x.type !== "number" && x.type !== "string" && x.type !== "boolean" && x.type !== "date") {
    ...
    if (u.type === "transform") {
      ...
      if (!Array.isArray(u.operations) || u.operations.length < 1 || u.operations.length > Et) {
      ...
      const _ = u.operations.map((S, E) => {
        ...
        return p(`${x}/type`, "must be filter, sort, derive, rolling_mean, or linear_regression.");
      });
      const w = {
        id: m,
        type: "transform",
    ...
    if (u.type === "aggregate") {
      ...
      if (u.operation !== "count" && u.operation !== "sum" && u.operation !== "mean" && u.operation !== "min" && u.operation !== "max") {
...
const lr = e => e.type === "brownian_bridge_flat_torus" ? {
...
const uo = (e, t, r, s) => {
  ...
  const n = e.map((d, l) => {
    ...
    if (m.type === "brownian_bridge_flat_torus") {
      A(m, u, ["id", "type", "path_count", "seed", "start", "featured_path", "diffusion", "winding_limit"]);
      if (!r) {
      ...
      return {
        ...
        windingLimit: f,
        parameterIds: [...new Set([...y.parameterIds, ..._.parameterIds, ...S.flatMap(E => [...E.parameterIds]), ...r.durationParameterIds])]
      };
    }
  ...
  for (const d of n) {
    ...
    if (!l) {
      p(`/computations/${d.id}/source`, `references unknown computation ${d.source.computation}.`);
    }
...
const dr = (e, t) => {
  ...
  if (Object.hasOwn(r, "marker")) {
    if (r.marker !== "circle" && r.marker !== "square" && r.marker !== "diamond" && r.marker !== "cross") {
...
const fo = (e, t, r, s, a, n, o, d, l) => {
  ...
  return e.map((m, b) => {
    ...
    if (c.type === "computed_curve") {
      ...
      const je = c.expressions.map((q, ce) => B(q, `${i}/expressions/${ce}`, ie, "number"));
      ...
      return {
        ...
        parameterIds: [...new Set(je.flatMap(({
          parameterIds: q
        }) => [...q]))]
      };
    }
    ...
    return {
      ...
      parameterIds: [...new Set(M.flatMap(({
        parameterIds: I
      }) => [...I]))]
    };
  });
...
const Ft = (e, t, r, s) => {
  ...
  const n = Le(e, t);
  const o = ur(s, n);
  const d = o === "static_scalar_vector" ? "scalar" : o === "timeline_numeric_vector" ? "timeline_number" : undefined;
  if (!d) {
...
const bo = (e, t, r, s, a, n) => {
  ...
  if (o.type === "scatter" || o.type === "line") {
    ...
    return p(`${t}/type`, "must be scatter, line, area, bar, band, heatmap, or contour.");
  }
  const l = O(o.id, `${t}/id`);
  if (r.has(l)) {
...
const wo = e => {
  const t = C(e, "/");
  A(t, "/", ["version", "metadata", "parameters", "constraints", "datasets", "computations", "timeline", "panels", "layout"]);
  if (t.version !== 1) {
  ...
  for (const w of u) {
    ...
    if (g === null || !Number.isFinite(E * g) || E * g <= 0) {
      p(`/computations/${w.id}/diffusion`, "must have a finite positive product with the default timeline duration.");
    }
...
const $o = e => {
  ...
  const a = () => {
    ...
    const o = e.slice(t).match(/^(?:-?(?:0|[1-9]\d*)(?:\.\d+)?(?:[eE][+-]?\d+)?|true|false|null)/);
    if (!o) {
      throw new Error("Math Scene attachment contained malformed JSON.");
    }
    t += o[0].length;
...
const _o = e => sr(e) ? "plotly" : Qt(e) ? "graph" : fr(e) ? "scene" : br(e.href ?? "") || e.mimeType.startsWith("image/") ? "image" : "file";
const Fe = (e, t) => yr(e, t).map(r => ({
  key: r.key,
...
const Io = ({
  fileName: e,
  source: t
}) => <_Component7 direction="row" spacing={0.8} useFlexGap={true} sx={{
  flexWrap: "wrap"
}}><Sr content={t} label="Copy code" message="Code copied" size="small" variant="outlined" /><Ce type="button" size="small" variant="outlined" color="primary" startIcon={<Wt size={16} />} disableRipple={true} onClick={() => {
    To(t, e);
  }}>Download .py</Ce></_Component7>;
const Co = ({
  languageLabel: e,
  source: t
}) => {
  const r = t.split(/\r\n|\r|\n/).length;
  return <P sx={Ao}><P sx={vo}><P sx={Eo}><Tr size={17} /><L variant="subtitle2" color="inherit">{e}</L></P><L variant="caption" color="inherit">{r} {r === 1 ? "line" : "lines"}</L></P><P sx={So} tabIndex={0}><L variant="code" component="pre" color="inherit">{t}</L></P></P>;
};
const Mo = j.memo(Co);
const jo = e => ({
...
const Po = ({
  ...
  return <h.Fragment><Ce type="button" size="small" variant="outlined" color="primary" startIcon={<Ir size={16} />} disableRipple={true} aria-haspopup="dialog" aria-expanded={r} onClick={() => {
      s(true);
    }}>View code</Ce><Cr anchor="right" open={r} onClose={() => {
      s(false);
    }} slotProps={{
      paper: {
        variant: "panel",
      ...
      zIndex: 9999
    }}><P sx={Ro}><P sx={No}><L variant="h6" color="textPrimary" noWrap={true}>{e}</L><L variant="caption" color="textSecondary">Exact Python source used to generate this artifact</L></P><P sx={ko}><Io fileName={e} source={t} /><$r tooltip="Close Python source" aria-label="Close Python source" disableRipple={true} onClick={() => {
            s(false);
          }}><_Component8 size={18} /></$r></P></P><P sx={Oo}><Mo languageLabel="Python" source={t} /></P></Cr></h.Fragment>;
};
const zo = e => {
  switch (e.mimeType) {
    case "image/png":
...
const hr = e => {
  const t = zo(e);
  const r = e.name.replace(/[/\\?%*:|"<>]/g, "-").replace(/\s+/g, " ").trim() || "python-artifact";
...
const Lo = (e, t) => {
  ...
  return {
    artifact: j.useMemo(() => ({
      ...e,
      href: s,
      contentError: n ?? (!e.href && r.error ? r.error instanceof Error ? r.error.message : "Could not load artifact." : null)
    }), [e, n, s, r.error]),
    download: a,
...
const qo = e => e === null ? null : e < 1024 ? `${e} B` : e < 1048576 ? `${(e / 1024).toFixed(1)} KB` : `${(e / 1048576).toFixed(1)} MB`;
const _s = j.memo(function ({
  ...
  const l = ((i = t.preview) == null ? undefined : i.kind) === "unavailable" ? null : t.preview;
  const {
    artifact: u,
    download: m,
    isLoading: b
  } = Lo(t, false);
  return <_Component10 variant="inset" sx={Fo}><P sx={Uo}><P sx={Wo}><P sx={Bo}>{t.kind === "image" && <_Component9 size={16} />}{t.kind !== "image" && <Er size={16} />}</P><L variant="body2" color="textPrimary" noWrap={true}>{t.name}</L></P><_Component0 content={`Supporting file ${n}. ${r}`} mathSyntax={s} mode="compact" /><L variant="caption" color="textSecondary" noWrap={true}>{[t.mimeType, o].filter(Boolean).join(" · ")}</L>{t.omittedReason && <L variant="caption" color="error">{t.omittedReason}</L>}{u.contentError && <L variant="caption" color="error">{u.contentError}</L>}{((c = t.preview) == null ? undefined : c.kind) === "unavailable" && <L variant="caption" color="textSecondary">Preview unavailable: {t.preview.reason}</L>}{(!d || l) && <P sx={Xo}>{!d && <Ce type="button" size="small" variant="outlined" color="primary" startIcon={<Wt size={16} />} disableRipple={true} disabled={b || !u.attachmentId && !u.href} onClick={() => {
          m();
        }}>Download</Ce>}{!d && a && <Po fileName={Do(t)} source={a} />}{l && <_Component1 preview={l} label={`${t.name} data preview`} inlineAction={true} />}</P>}</P></_Component10>;
});
export { Mo as A, ze as G, _Component9 as I, Ee as M, as as P, _s as S, Po as V, hs as a, ys as b, Io as c, ds as d, ps as e, Rn as f, us as g, me as h, xs as i, Xo as j, Do as k, Lo as l, ms as m, hr as n, gs as o, os as p, ws as q, is as r, cs as s, ss as t, Ho as u, fs as v, ls as w, $s as x, bs as y };
