...
function z() {
  const x = y(),
    i = j(),
    p = v(),
    a = M({ queryKey: u.currentAccess(), queryFn: w, staleTime: T }),
    o = P({
      mutationFn: f,
      onSuccess: async (s) => {
            ...
            children: r.jsxs(t, {
              ...
              children: [
                r.jsxs(t, {
                  spacing: 1,
                  children: [
                    r.jsx(n, { variant: "h4", children: "Review Math Vision terms" }),
                    r.jsx(n, {
                      variant: "body1",
                      color: "textSecondary",
                      children:
                  ...
                  ? r.jsxs(t, {
                      ...
                      children: [
                        ...
                        r.jsx(n, {
                          variant: "body2",
                          color: "textSecondary",
                          children: "Loading account status",
                        }),
                      ],
                    })
                  : r.jsxs(t, {
                          ...
                          children: [
                            r.jsx(n, {
                              ...
                              children: r.jsxs(m, {
                                ...
                                children: [
                                  "Terms version: ",
                                  (e == null ? void 0 : e.termsVersion) ?? "Current",
                                ],
                              }),
                            }),
                            r.jsx(n, {
                              ...
                              children: r.jsxs(m, {
                                ...
                                children: [
                                  ...
                                  " ",
                                  (e == null ? void 0 : e.privacyPolicyVersion) ?? "Current",
                                ],
                              }),
                            }),
                          ],
                        }),
                        l ? r.jsx(Q, { severity: "error", children: l }) : null,
                        r.jsxs(t, {
                          ...
                          children: [
                            r.jsx(E, {
                              variant: "contained",
                              startIcon: r.jsx(q, { fontSize: "small" }),
                            ...
                            r.jsx(L, {
                              color: "secondary",
                              startIcon: r.jsx(I, { fontSize: "small" }),
                              onClick: () => R(),
                              children: "Sign Out",
                            }),
                          ],
