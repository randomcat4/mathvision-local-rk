import { A as i, j as t, B as n, g as s, T as r, K as l } from "./index-BM3ZINIl.js";
const m = i(
    t.jsx("path", {
  ...
  h = { width: "100%", height: "100%", objectFit: "cover", display: "block" },
  u = ({ kind: e, name: a, href: o }) =>
    e === "image" && o
      ? t.jsx(n, { sx: c, children: t.jsx(n, { component: "img", src: o, alt: a, sx: h }) })
      : t.jsx(n, {
          sx: c,
          children:
            e === "image" ? t.jsx(m, { fontSize: "small" }) : t.jsx(d, { fontSize: "small" }),
        }),
  x = 2,
  p = l("span")({
    minWidth: 0,
  ...
  b = ({ name: e, variant: a = "subtitle2" }) =>
    t.jsx(p, { children: t.jsx(r, { component: "span", variant: a, children: e }) });
