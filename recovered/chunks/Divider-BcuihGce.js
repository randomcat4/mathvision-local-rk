...
const R = (r) => {
  ...
  L = g("div", {
    ...
    overridesResolver: (r, t) => {
      ...
      return [
        ...
        e.textAlign === "right" && e.orientation !== "vertical" && t.textAlignRight,
    ...
    f(({ theme: r }) => ({
      ...
      variants: [
        ...
        { props: { variant: "inset" }, style: { marginLeft: 72 } },
        {
          ...
          style: { marginLeft: r.spacing(2), marginRight: r.spacing(2) },
        },
        {
          props: { variant: "middle", orientation: "vertical" },
          style: { marginTop: r.spacing(1), marginBottom: r.spacing(1) },
        },
        {
  ...
  W = m.forwardRef(function (t, e) {
    const n = w({ props: t, name: "MuiDivider" }),
      {
        absolute: s = !1,
        children: i,
        className: l,
    ...
    return v.jsx(L, {
      ...
      ref: e,
      ownerState: c,
      "aria-orientation": p === "separator" && (a !== "hr" || o === "vertical") ? o : void 0,
      ...u,
      children: i ? v.jsx(S, { className: d.wrapper, ownerState: c, children: i }) : null,
    });
  });
export { W as D };
