...
`,
    ...
    b(({ theme: a }) => ({
      ...
      variants: [
        ...Object.entries(a.palette)
          .filter(p())
          .map(([r]) => ({ props: { color: r }, style: { backgroundColor: $(a, r) } })),
        {
  ...
  X = d("span", { name: "MuiLinearProgress", slot: "Dashed" })(
    b(({ theme: a }) => ({
      position: "absolute",
      marginTop: 0,
      height: "100%",
      ...
      variants: [
        ...
        ...Object.entries(a.palette)
          ...
          .map(([r]) => {
            ...
            return {
              props: { color: r },
              style: { backgroundImage: `radial-gradient(${t} 0%, ${t} 16%, transparent 42%)` },
            };
          }),
      ],
    })),
    D || { animation: `${P} 3s infinite linear` },
  ),
  _ = d("span", {
    name: "MuiLinearProgress",
    slot: "Bar1",
    ...
    b(({ theme: a }) => ({
      ...
      variants: [
        ...
        ...Object.entries(a.palette)
          ...
          .map(([r]) => ({
            props: { color: r },
            style: { backgroundColor: (a.vars || a).palette[r].main },
          })),
        { props: { variant: "determinate" }, style: { transition: `transform .${h}s linear` } },
        {
          props: { variant: "buffer" },
          style: { zIndex: 1, transition: `transform .${h}s linear` },
        },
        {
        ...
        {
          props: ({ ownerState: r }) => r.variant === "indeterminate" || r.variant === "query",
          style: T || { animation: `${x} 2.1s cubic-bezier(0.65, 0.815, 0.735, 0.395) infinite` },
        },
      ],
    })),
  ),
    ...
    b(({ theme: a }) => ({
      ...
      variants: [
        ...Object.entries(a.palette)
          ...
          .map(([r]) => ({
            props: { color: r },
            style: { "--LinearProgressBar2-barColor": (a.vars || a).palette[r].main },
          })),
        {
        ...
        ...Object.entries(a.palette)
          ...
          .map(([r]) => ({
            ...
            style: { backgroundColor: $(a, r), transition: `transform .${h}s linear` },
          })),
        {
          props: ({ ownerState: r }) => r.variant === "indeterminate" || r.variant === "query",
          style: { width: "auto" },
        ...
        {
          props: ({ ownerState: r }) => r.variant === "indeterminate" || r.variant === "query",
          style: U || { animation: `${k} 2.1s cubic-bezier(0.165, 0.84, 0.44, 1) 1.15s infinite` },
        },
      ],
    })),
  ),
  H = N.forwardRef(function (r, t) {
    const n = O({ props: r, name: "MuiLinearProgress" }),
      {
        className: e,
        color: m = "primary",
        value: g,
      ...
      l = { ...n, color: m, variant: i },
      c = K(l),
      M = z(),
      u = {},
      f = { bar1: {}, bar2: {} };
    if ((i === "determinate" || i === "buffer") && g !== void 0) {
      ((u["aria-valuenow"] = Math.round(g)), (u["aria-valuemin"] = 0), (u["aria-valuemax"] = 100));
      let o = g - 100;
      (M && (o = -o), (f.bar1.transform = `translateX(${o}%)`));
    }
    if (i === "buffer" && j !== void 0) {
      let o = (j || 0) - 100;
      (M && (o = -o), (f.bar2.transform = `translateX(${o}%)`));
    }
    return s.jsxs(V, {
      ...
      ...R,
      children: [
        i === "buffer" ? s.jsx(X, { className: c.dashed, ownerState: l }) : null,
        s.jsx(_, { className: c.bar1, ownerState: l, style: f.bar1 }),
        i === "determinate" ? null : s.jsx(F, { className: c.bar2, ownerState: l, style: f.bar2 }),
      ],
    });
  });
/**
...
function Q({ title: a, subtitle: r, icon: t, sx: n, sxLoading: e }) {
  const m = e === void 0 ? y : Array.isArray(e) ? [y, ...e] : [y, e];
  return s.jsx(S, { title: a, subtitle: r, icon: t, sx: n, children: s.jsx(H, { sx: m }) });
}
