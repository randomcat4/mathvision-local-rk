...
import { d as xn, o as wn } from "./TextField-D8vc_sXz.jsx";
import {
  f as f1,
  p as ma,
  a as da,
...
const pa = Y.forwardRef(function (e, t) {
  ...
  const w0 = pn(t, a0);
  const J0 = () =>
    V.current ? V.current[c0 ? "clientWidth" : "clientHeight"] : 0;
  const L0 = qe(a0, (K, O0) => {
    if (V.current && c0) {
  ...
  const ye = qe(a0, (K) => {
    const O0 = J0();
    const { duration: D0, easing: m0 } = ha(
      {
        style: O,
        timeout: $,
        easing: d,
...
const _Component = V0(gn, {
  ...
  It(({ theme: r }) => ({
    ...
    variants: [
      ...
      {
        props: ({ ownerState: e, iconPosition: t }) =>
...
const q1 = Ct("MuiTabScrollButton", [
  "root",
  "vertical",
  "horizontal",
  "disabled",
...
const $1 = V0("div", {
  ...
  overridesResolver: (r, e) => {
    ...
    return [
      ...
      {
        [`& .${er.scrollButtons}`]:
          t.scrollButtonsHideMobile && e.scrollButtonsHideMobile,
      },
      e.root,
...
const A4 = Y.forwardRef(function (e, t) {
  ...
  const [Kt, { onChange: te, ...Ne }] = ae("scrollbar", {
  ...
  const [Zi, Ji] = ae("scroller", {
    ...
    additionalProps: {
      style: {
        overflow: K.overflow,
        [Z ? `margin${i ? "Left" : "Right"}` : "marginBottom"]: X
          ? undefined
          : -K.scrollbarWidth,
      },
    },
    ...
    <Yi {...Ki}>
      ...
      <Zi {...Ji}>
        <_Component3
          ...
          {...t1}
        >
          <u1.Provider value={ua}>{Vi}</u1.Provider>
        </_Component3>
        {C0 && oa}
      </Zi>
      {Jt.scrollButtonEnd}
...
function Or(r) {
  ...
  function e(t, a, n) {
    return (
      !!vs(t) &&
      !!r.call(this, t, typeof a == "number" ? a : undefined, n || undefined)
    );
  }
}
function ps(r) {
    ...
    a.push(
      Ss(
        t
          .slice(i, d)
          .replace(/[\u061C\u200E\u200F\u202A-\u202E\u2066-\u2069]/g, ""),
        i === 0 ? e.breakBefore : true,
        d === t.length ? e.breakAfter : true,
      ),
    );
    i = d + 1;
  }
...
function Vs(e, t) {
  switch (e) {
    ...
    case "∥":
      return (
        b0("M145 0 H188 V" + t + " H145z") + b0("M367 0 H410 V" + t + " H367z")
      );
    case "⎟":
    ...
    case "‖":
      return (
        b0("M257 0 H300 V" + t + " H257z") + b0("M478 0 H521 V" + t + " H478z")
      );
    default:
      return "";
  }
...
function Pn(e) {
  if (
    e instanceof We ||
    e instanceof Rt ||
    (e instanceof je && e.hasClass("enclosing"))
  ) {
    return e;
  } else {
    return null;
...
E({
  ...
  htmlBuilder: (r, e) =>
    r.delim === "."
      ? k([r.mclass])
      : ni(r.delim, r.size, e, r.mode, [r.mclass]),
  mathmlBuilder: (r) => {
    var e = [];
    if (r.delim !== ".") {
...
E({
  ...
  htmlBuilder: (r, e) => {
    Oa(r);
    for (
      var t = y0(r.body, e, true, ["mopen", "mclose"]),
        a = 0,
        n = 0,
        i = false,
        l = 0;
...
var Wt = (r, e) => {
  var t = 0;
  var a = new M(r.label.includes("colorbox") ? "mpadded" : "menclose", [
    r0(r.body, e),
  ]);
  switch (r.label) {
    case "\\cancel":
...
function K0(e, t) {
  ...
  for (; n < u || d0 < x0.length; ++n, ++d0) {
    var Q0;
    for (
      var h0 = x0[d0], _0 = true;
      ((ye = h0) == null ? undefined : ye.type) === "separator";
    ) {
      var ye;
      if (!_0) {
        c0 = k(["arraycolsep"], []);
    ...
    if (!(n >= u)) {
      ...
      var m0 = k(
        ["col-align-" + (((Q0 = h0) == null ? undefined : Q0.align) || "c")],
        [D0],
      );
      t0.push(m0);
...
function ui(e, t) {
  ...
  l.body.forEach(function (C) {
    ...
    if (x) {
      ...
      if (u < $) {
        throw new A(
          "Too many math in a row: " + ("expected " + u + ", but got " + $),
          C[0],
        );
      }
    }
...
E({
  ...
  handler(r, e) {
    ...
    if (a === "\\begin") {
      ...
      var u = Pa[i];
      var { args: c, optArgs: d } = t.parseArguments("\\begin{" + i + "}", u);
      var f = {
        mode: t.mode,
        envName: i,
        parser: t,
...
var di = (r, e) => {
  ...
  if (r.type === "supsub") {
    a = r.sup
      ? e0(r.sup, e.havingStyle(t.sup()), e)
      : e0(r.sub, e.havingStyle(t.sub()), e);
...
var Kl = (r, e) => {
  for (
    var t = q0(r.body, e.withFont("mathrm")), a = true, n = 0;
    n < t.length;
    n++
  ) {
    var i = t[n];
...
function gi(r, e, t) {
  for (
    var a = y0(r, e, false), n = e.sizeMultiplier / t.sizeMultiplier, i = 0;
    i < a.length;
    i++
  ) {
...
E({
  ...
  htmlBuilder(r, e) {
    ...
    var { span: c, ruleWidth: d, advanceWidth: f } = Ll(u, e);
    var g = c.height - d;
...
function Jl(e, t) {
  ...
  if (a) {
    if (a.type === "op") {
      var n =
        a.limits && (t.style.size === F.DISPLAY.size || a.alwaysHandleSupSub);
      if (n) {
        return Xe;
      } else {
        return null;
      ...
      var i =
        a.alwaysHandleSupSub && (t.style.size === F.DISPLAY.size || a.limits);
      if (i) {
        return vi;
      } else {
        return null;
  ...
  htmlBuilder(r, e) {
    ...
    if (i) {
      ...
      if (!y) {
        g =
          l.depth +
          (w.fontMetrics().subDrop * w.sizeMultiplier) / e.sizeMultiplier;
      }
    }
    var T;
    ...
    if (t) {
      ...
      if (r.sup) {
        ...
        if (
          (c &&
            c.type === "op" &&
            c.limits &&
            (e.style === F.DISPLAY || c.alwaysHandleSupSub)) ||
          (c &&
            c.type === "operatorname" &&
      ...
      if (
        (u &&
          u.type === "op" &&
          u.limits &&
          (e.style === F.DISPLAY || u.alwaysHandleSupSub)) ||
        (u &&
          u.type === "operatorname" &&
...
Be({
  ...
  mathmlBuilder(r, e) {
    var t = new M("mtable", [
      new M("mtr", [
        Va(),
        new M("mtd", [ge(r.body, e)]),
        Va(),
        new M("mtd", [ge(r.tag, e)]),
      ]),
    ]);
...
E({
  ...
  htmlBuilder(r, e) {
    for (
      var t = Ja(r), a = [], n = e.havingStyle(e.style.text()), i = 0;
      i < t.length;
      i++
    ) {
      var l = t[i];
...
m("\\dots", function (r) {
  ...
  if (t in en) {
    ...
    t.slice(0, 4) === "\\not" ||
    (t in n0.math && lo.has(n0.math[t].group))
  ) {
    e = "\\dotsb";
  }
  return e;
...
class Ut {
  ...
  parseAtom(e) {
    ...
    if (
      (t == null ? undefined : t.type) === "internal" ||
      this.mode === "text"
    ) {
      return t;
    }
...
function go(r) {
  ...
  return function (t, a) {
    b1(t, "element", function (n, i) {
      const l = Array.isArray(n.properties.className)
...
const Ii = (r, e) =>
  !j0(r, e) && ["\\(", "\\)", "\\[", "\\]"].some((t) => r.startsWith(t, e));
const Ri = (r, e, t) => {
  const a = t.length;
  let n = e;
  while (n < r.length) {
...
const Eo = (r, e, t, a, { stopAtMarkdownBlock: n = false } = {}) => {
...
const on = (r, e, t, a) => {
  ...
  while (i < t) {
    ...
    const c = Po(r, e, i);
    const d =
      c === null || qr(r.slice(c.start, c.end)) || Fo(r.slice(c.start, c.end));
...
const Wo = (r, { protectLinkReferenceDefinitions: e = true } = {}) => {
  var n;
  const t = [];
  let a = 0;
  while (a < r.length) {
...
const jo = (r, { protectStandaloneHtmlTags: e = true } = {}) => [
  ...[
    ...r.matchAll(
      /<(code|pre|script|style|textarea)\b[^>]*>[\s\S]*?<\/\1\s*>/gi,
    ),
  ].map((t) => ({
    start: t.index,
...
const Fi = (r, e = {}) => {
  ...
  for (const f of t) {
    c.push(
      ...on(r, i, f.start, a).filter(
        (g) => !u.some((y) => y.start <= g.start && g.end <= y.end),
      ),
    );
    i = f.end;
  }
  c.push(
    ...on(r, i, r.length, a).filter(
      (f) => !u.some((g) => g.start <= f.start && f.end <= g.end),
    ),
  );
  c.sort((f, g) => f.start - g.start);
  const d = [
    ...c,
    ...n.filter((f) => !c.some((g) => f.start < g.end && g.start < f.end)),
  ];
  return zt(d);
};
const Uo = (r, e) => {
  ...
  Uo(r, (t) => {
    ...
    if (a.valid) {
      return a.segments
        .map((n) =>
          n.kind !== "math" ||
          (n.openingDelimiter !== "$" && n.openingDelimiter !== "$$")
            ? n.kind === "text"
              ? n.value
...
const Vo = (r, e) => {
  ...
  const n = (i, l) => {
    ...
    for (const d of u.segments) {
      ...
      const f =
        d.openingDelimiter.length + d.body.length + d.closingDelimiter.length;
      t.push({
        start: c,
        end: c + f,
      });
...
const N4 = (r, e, t = {}) => {
  ...
  if (d.includes(n) || d.includes(i)) {
    throw new Error(
      "Markdown prose transformation corrupted a protected marker.",
    );
  }
  return d;
};
...
const r4 = (r, e) =>
  r.trim().replace(/[^A-Za-z0-9_-]+/g, "-") || `highlight-${e}`;
...
const n4 = (r) => {
  let e = Pi(na(r))
    .replace(
      /\\(?:mathbb|mathcal|mathrm|mathbf|mathfrak|mathsf|operatorname)\{([^{}]+)\}/g,
      "$1",
    )
...
const dn = (r) =>
  [...r].sort(
    (e, t) => t.term.length - e.term.length || e.term.localeCompare(t.term),
  );
const q4 = (r) => {
  const e = new Set();
  const t = new Map();
...
const $i = (r, e, t, a) =>
  t.find(({ term: n }) => r.startsWith(n, e) && a(r, e, n));
...
const Hr = (r) =>
  r.children
    .map((e) =>
      e.type === "text" ? e.value : e.type === "element" ? Hr(e) : "",
    )
    .join("");
const p4 = (r) => {
  var e;
  return (
    ...
    ((e = r.properties) == null ? undefined : e.encoding) === Ko
  );
};
...
const O4 = (r, e, t, a) => {
  ...
  return {
    ...
    span: ({ node: l, children: u, ...c }) => {
      ...
      return (
        <_Component5 arrow={true} enterDelay={120} title={a(g)}>
          <_Component4
            component="span"
            {...w}
            aria-label={`${g.text}: ${T}`}
