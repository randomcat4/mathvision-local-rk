...
import { g as ne } from "./assistantStructuredResponseLazy-CCAemx3W.jsx";
import { C as Se } from "./CopyButton-BcOsqrNJ.js";
import { M as _Component2 } from "./MChip-DiH8NXBU.jsx";
import {
  a as _Component,
  R as _Component6,
  c as _Component7,
} from "./ThinkingElapsedLabel-DKCKD95O.js";
import { C as Ce } from "./Card-Bf0WPnf4.jsx";
import { T as _Component3 } from "./TextField-D8vc_sXz.jsx";
import { S as _Component5 } from "./save-Bre0AB4-.js";
import { P as Ee } from "./MarkdownHighlights-C-ZhT8z1.jsx";
import { S as Te } from "./send-CDdCro4v.js";
import { A as Re } from "./Alert-DnFVD8li.jsx";
import { P as J } from "./play-3zl_nde-.js";
import { F as Pe, C as Ie } from "./FormGroup-BsLWbxpH.jsx";
import { F as $e } from "./FormControlLabel-CQvCddOM.jsx";
function te(e) {
...
const Ke = [
  ...
  },
  {
    label: "More diverse",
    feedback:
      "Give me a wider spread of directions instead of nearby variants.",
  },
  {
    label: "More concrete",
  ...
  const ce = (r) => {
    ...
    if (
      ...
      (!(s instanceof Element) ||
        !s.closest('[data-next-steps-action-trigger="true"]'))
    ) {
      O();
    }
  };
  ...
  return (
    <I sx={Qe}>
      {re(b) ? (
        ...
        <Re severity="error">Next Steps response is missing valid choices.</Re>
      )}
      {N && (
        <I sx={Ue}>
          {l && (
            <E
              ...
              startIcon={<_Component7 size={15} />}
              data-next-steps-action-trigger="true"
              aria-haspopup="dialog"
              aria-expanded={g}
              aria-controls={g ? F : undefined}
              onClick={(r) => {
                Z("regenerate", r);
              }}
            >
          ...
          {A && (
            <Me onClickAway={ce}>
              ...
              >
                <_Component8 direction="row" sx={Je}>
                  <_Component8 direction="row" sx={Ye}>
                    <I sx={Ze}>
                      {g && <_e size={17} aria-hidden="true" />}
                      {L && <J size={17} aria-hidden="true" />}
                    </I>
                    <_Component8>
                      <D variant="subtitle2" color="textPrimary">
                        {W}
                      </D>
                      <D variant="body2" color="textSecondary">
                        {H}
                      </D>
                    </_Component8>
                  </_Component8>
                ...
                <_Component8 sx={et}>
                  ...
                  >
                    {(u ?? []).map((r, s) => (
                      <$e
                        ...
                        key={`${r.operation}-${r.prompt}-${s}`}
                      />
                    ))}
                  </Pe>
                  {z === 0 && (
                    <D variant="caption" color="error">
                  ...
                  {g && (
                    <t.Fragment>
                      ...
                      <_Component3
                        ...
                        placeholder="For example: focus on computational checks, avoid literature search, and make each option testable."
                        value={m}
                  ...
                  <I sx={rt}>
                    <E type="button" color="secondary" onClick={Q}>
                      Cancel
                    </E>
                    <E
                      type="submit"
                      ...
                      loading={L && a}
                      startIcon={
                        g ? <_Component7 size={16} /> : <J size={16} />
                      }
                    >
                      {G}
                    </E>
