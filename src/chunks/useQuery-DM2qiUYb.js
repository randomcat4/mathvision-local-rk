...
var i = (s, t, e) => ($(s, t, "read from private field"), e ? e.call(s) : t.get(s)),
  p = (s, t, e) =>
    t.has(s)
      ...
      : t instanceof WeakSet
        ? t.add(s)
        : t.set(s, e),
  u = (s, t, e, r) => ($(s, t, "write to private field"), r ? r.call(s, e) : t.set(s, e), e),
...
var m,
  ...
  Ft =
    ((Et = class extends Tt {
      ...
      onSubscribe() {
        this.listeners.size === 1 &&
          ...
          Rt(i(this, a), this.options) ? l(this, n, j).call(this) : this.updateResult(),
      ...
      setOptions(t) {
        ...
        if (
          ...
          this.options.enabled !== void 0 &&
            ...
            typeof S(this.options.enabled, i(this, a)) != "boolean")
        )
        ...
        (l(this, n, ot).call(this),
          ...
          e._defaulted &&
            ...
            i(this, m)
              .getQueryCache()
              .notify({ type: "observerOptionsUpdated", query: i(this, a), observer: this }));
        const h = this.hasListeners();
        (h && St(i(this, a), r, this.options, e) && l(this, n, j).call(this),
          this.updateResult(),
          h &&
            (i(this, a) !== r ||
              S(this.options.enabled, i(this, a)) !== S(e.enabled, i(this, a)) ||
              A(this.options.staleTime, i(this, a)) !== A(e.staleTime, i(this, a))) &&
      ...
      getOptimisticResult(t) {
        const e = i(this, m).getQueryCache().build(i(this, m), t),
          r = this.createResult(e, t);
        return (
          Dt(this, r) && (u(this, g, r), u(this, D, this.options), u(this, x, i(this, a).state)),
          r
        );
      }
      getCurrentResult() {
      ...
      fetchOptimistic(t) {
        const e = i(this, m).defaultQueryOptions(t),
          r = i(this, m).getQueryCache().build(i(this, m), e);
      ...
      createResult(t, e) {
        ...
        if (e._optimisticResults) {
          const R = this.hasListeners(),
            B = !R && Rt(t, e),
            V = R && St(t, r, e, h);
          ((B || V) && (d = { ...d, ...xt(E.data, t.options) }),
            e._optimisticResults === "isRestoring" && (d.fetchStatus = "idle"));
        }
        let { error: Q, errorUpdatedAt: k, status: v } = d;
        f = d.data;
        let z = !1;
        if (e.placeholderData !== void 0 && f === void 0 && v === "pending") {
          ...
          (o != null &&
          o.isPlaceholderData &&
          e.placeholderData === (y == null ? void 0 : y.placeholderData)
            ? ((R = o.data), (z = !0))
            : (R =
                typeof e.placeholderData == "function"
                  ...
                  : e.placeholderData),
            R !== void 0 &&
              ((v = "success"), (f = vt(o == null ? void 0 : o.data, R, e)), (M = !0)));
        }
        if (e.select && f !== void 0 && !z)
          if (o && f === (c == null ? void 0 : c.data) && e.select === i(this, W)) f = i(this, P);
          else
            try {
              (u(this, W, e.select),
                (f = e.select(f)),
                (f = vt(o == null ? void 0 : o.data, f, e)),
                u(this, P, f),
                u(this, w, null));
            } catch (R) {
              u(this, w, R);
            }
        i(this, w) && ((Q = i(this, w)), (f = i(this, P)), (k = Date.now()), (v = "error"));
        const X = d.fetchStatus === "fetching",
          ...
          I = {
            ...
            isFetchedAfterMount:
              d.dataUpdateCount > b.dataUpdateCount || d.errorUpdateCount > b.errorUpdateCount,
            isFetching: X,
            isRefetching: X && !Y,
            isLoadingError: Z && !dt,
        ...
        if (this.options.experimental_prefetchInRender) {
          const R = I.data !== void 0,
            B = I.status === "error" && !R,
            V = (G) => {
              B ? G.reject(I.error) : R && G.resolve(I.data);
            },
            pt = () => {
          ...
          switch (K.status) {
            case "pending":
              t.queryHash === r.queryHash && V(K);
              break;
            case "fulfilled":
              (B || I.data !== K.value) && pt();
              break;
            case "rejected":
              (!B || I.error !== K.reason) && pt();
              break;
          }
        }
        return I;
    ...
    (st = function () {
      l(this, n, nt).call(this);
      const t = A(this.options.staleTime, i(this, a));
      if (et.isServer() || i(this, g).isStale || !mt(t)) return;
    ...
    (rt = function (t) {
      (l(this, n, ht).call(this),
        ...
        !(
          et.isServer() ||
          S(this.options.enabled, i(this, a)) === !1 ||
          !mt(i(this, T)) ||
          i(this, T) === 0
        ) &&
          u(
    ...
    (at = function () {
      (l(this, n, st).call(this), l(this, n, rt).call(this, l(this, n, it).call(this)));
    }),
    (nt = function () {
      i(this, _) !== void 0 && (J.clearTimeout(i(this, _)), u(this, _, void 0));
    }),
    (ht = function () {
      i(this, F) !== void 0 && (J.clearInterval(i(this, F)), u(this, F, void 0));
    }),
    (ot = function () {
...
function Ut(s, t) {
  return (
    S(t.enabled, s) !== !1 &&
    s.state.data === void 0 &&
    !(s.state.status === "error" && S(t.retryOnMount, s) === !1)
  );
}
function Rt(s, t) {
...
function ct(s, t, e) {
  if (S(t.enabled, s) !== !1 && A(t.staleTime, s) !== "static") {
...
function St(s, t, e, r) {
  return (
    (s !== t || S(r.enabled, s) === !1) && (!e.suspense || s.state.status !== "error") && ut(s, e)
  );
}
function ut(s, t) {
  return S(t.enabled, s) !== !1 && s.isStaleByTime(A(t.staleTime, s));
}
function Dt(s, t) {
  return !q(s.getCurrentResult(), t);
}
var wt = O.createContext(!1),
  Pt = () => O.useContext(wt);
wt.Provider;
function Lt() {
  let s = !1;
...
var Nt = O.createContext(Lt()),
  ...
  Bt = (s, t, e) => {
    const r =
      e != null && e.state.error && typeof s.throwOnError == "function"
        ...
        : s.throwOnError;
    (s.suspense || s.experimental_prefetchInRender || r) && (t.isReset() || (s.retryOnMount = !1));
  },
  jt = (s) => {
    O.useEffect(() => {
      s.clearReset();
  ...
  At = ({ result: s, errorResetBoundary: t, throwOnError: e, query: r, suspense: h }) =>
    s.isError &&
    !t.isReset() &&
    !s.isFetching &&
    r &&
  ...
  zt = (s, t) => (s == null ? void 0 : s.suspense) && t.isPending,
  yt = (s, t, e) =>
...
function Vt(s, t, e) {
  ...
  (f = (M = o.getDefaultOptions().queries) == null ? void 0 : M._experimental_beforeQuery) ==
    null || f.call(M, c);
  const y = o.getQueryCache().get(c.queryHash);
  ((c._optimisticResults = r ? "isRestoring" : "optimistic"), Ht(c), Bt(c, h, y), jt(h));
  ...
  if (
    (O.useSyncExternalStore(
      O.useCallback(
        (v) => {
          const z = d ? b.subscribe(Ct.batchCalls(v)) : tt;
          return (b.updateResult(), z);
        },
        [b, d],
      ),
      () => b.getCurrentResult(),
  ...
  if (
    ...
    throw E.error;
  if (
    ((k = (Q = o.getDefaultOptions().queries) == null ? void 0 : Q._experimental_afterQuery) ==
      null || k.call(Q, c, E),
    c.experimental_prefetchInRender && !et.isServer() && Wt(E, r))
  ) {
    const v = U ? yt(c, b, h) : y == null ? void 0 : y.promise;
    v == null ||
      v.catch(tt).finally(() => {
        b.updateResult();
      });
...
export { Ft as Q, Vt as a, Xt as u };
