...
import { L as E } from "./TextField-D8vc_sXz.jsx";
import { L as U } from "./ListItemIcon-CaLBil7Q.jsx";
import { L as O } from "./ListItemText-CBxudZz_.jsx";
import { a as G, W as Q, b as V } from "./WorkspaceSidePanelFrame-BElEFQhq.jsx";
import {
  u as q,
  R as K,
  a as _,
  r as h,
  g as X,
} from "./ResearchProblemsContext-D2iMu4To.js";
import { M as _Component9 } from "./MChip-DiH8NXBU.jsx";
import { T as Y } from "./TimeRelative-HYP_-RcH.js";
import { A as J } from "./Alert-DnFVD8li.jsx";
  ...
  A(({ theme: r }) => ({
    ...
    variants: [
      ...
      },
      {
        ...
        style: {
          "--AppBar-background": r.vars
            ? r.vars.palette.AppBar.defaultBg
            : r.palette.grey[100],
          "--AppBar-color": r.vars
        ...
        style: {
          ...
          ...r.applyStyles("dark", {
            backgroundColor: r.vars
              ...
              : null,
            color: r.vars
              ? S(r.vars.palette.AppBar.darkColor, "var(--AppBar-color)")
              : null,
          }),
        },
      },
...
const _Component6 = () => (
  ...
  >
    <M component="a" href={w} aria-label="Back to main app" sx={pr}>
      <U sx={cr}>
        <_Component3 />
      </U>
      <O
      ...
      {!r.hideHeader && (
        ...
        >
          ...
          >
            ...
            >
              <a href={w}>
                <_Component4 variant="h5">Math Vision</_Component4>
              </a>
            </_Component5>
            <_Component5 sx={{}}>
              <_Component6 />
...
function _Component0() {
  ...
  const t = g.useMemo(
    () =>
      r.filter(
        (e) => e.submissionType === "problem" || e.problemSubmissionId === null,
      ),
    [r],
  );
  ...
  return (
    <Q
      ...
      header={
        <V>
          <_Component5 sx={xr}>
            <_Component4 variant="subtitle2" color="textPrimary" noWrap={true}>
              Research problems
            </_Component4>
            <_Component4 variant="caption" color="textSecondary" noWrap={true}>
    ...
    >
      <_Component5 sx={gr}>
        ...
        >
          <_Component4 variant="overline" color="textSecondary">
            Submitted entries
          </_Component4>
          <_Component9 label={t.length} size="small" />
        </_Component5>
        <_Component5 sx={yr}>
          {o && (
          ...
          {s && <J severity="error">Could not load submissions.</J>}
          {!o &&
            !s &&
            t.map((e) => (
              <H
              ...
              >
                <_Component5 sx={hr}>
                  ...
                  >
                    <_Component4 variant="subtitle2" noWrap={true}>
                      {e.title}
                    </_Component4>
                    <_Component9
                      size="small"
                      color={
                        e.submissionType === "problem" ? "primary" : "default"
                      }
                      sx={{
                        ml: 0.5,
...
const jr = () => {
  ...
  const { mutateAsync: s, isPending: t } = F({
    mutationFn: _,
    onSuccess: async () => {
  ...
  const l = g.useMemo(() => {
    ...
    return {
      researchSubmissions:
        ((p = o.data) == null ? undefined : p.submissions) ?? [],
      ...
      isPilotIntakeOpen:
        ((e = o.data) == null ? undefined : e.isPilotIntakeOpen) ?? false,
      pilotSubmissionLimit:
        ((m = o.data) == null ? undefined : m.pilotSubmissionLimit) ?? 0,
      remainingPilotSubmissionSlots:
        ((c = o.data) == null ? undefined : c.remainingPilotSubmissionSlots) ??
        0,
      attachmentMaxCount:
        ((x = o.data) == null ? undefined : x.attachmentMaxCount) ?? 0,
    };
  }, [i, t, o.data, o.error, o.isError, o.isPending]);
  return (
    <_Component1 noSpacing={true}>
      <K.Provider value={l}>
        <_Component5 sx={vr}>
          <_Component0 />
          <_Component5 component="main" sx={Sr}>
            <N />
          </_Component5>
        </_Component5>
      </K.Provider>
