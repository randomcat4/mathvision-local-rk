import { Q as v, a as p } from "./useQuery-DM2qiUYb.js";
import { au as x, av as b } from "./index-BM3ZINIl.jsx";
var l = class extends v {
  ...
  createResult(e, t) {
    ...
    const { state: s } = e,
      ...
      { isFetching: a, isRefetching: g, isError: c, isRefetchError: d } = i,
      r = (P = (f = s.fetchMeta) == null ? void 0 : f.fetchMore) == null ? void 0 : P.direction,
      h = c && r === "forward",
      n = a && r === "forward",
      o = c && r === "backward",
      u = a && r === "backward";
