...
import { J as Io } from "./SidebarTreeConnector-DsRNfBIo.jsx";
import { g as yc } from "./cache-BNzcfneg.js";
import { j as Ul } from "./useLatexQueries-DBpKOPUv.js";
import { w as zd } from "./MarkdownHighlights-C-ZhT8z1.jsx";
import "./katex.min-ADdKj7O-.js";
import { D as _Component, a as _d, b as Fd } from "./MChip-DiH8NXBU.jsx";
import { T as Ud, L as Hd } from "./TextField-D8vc_sXz.jsx";
let Zr = [];
let xc = [];
(() => {
  let n =
  ...
  static from(e, t = e.reduce((i, s) => i + s.length + 1, -1)) {
    ...
    function f(d) {
      ...
      if (d.lines > r && d instanceof lt) {
        ...
        d instanceof se &&
        a &&
        (m = c[c.length - 1]) instanceof se &&
        d.lines + m.lines <= 32
      ) {
        a += d.lines;
        h += d.length + 1;
        c[c.length - 1] = new se(
          m.text.concat(d.text),
          m.length + 1 + d.length,
        );
      } else {
        if (a + d.lines > s) {
...
class y {
  ...
  static cursor(e, t = 0, i, s) {
    return $t.create(
      e,
      e,
      (t == 0 ? 0 : t < 0 ? 8 : 16) | (i == null ? 7 : Math.min(6, i)),
      s,
    );
  }
          ...
          if (
            this.dependencies.every((O) =>
              O instanceof T
                ? u.facet(O) === f.facet(O)
                : O instanceof le
                  ? u.field(O, false) == f.field(O, false)
                  : true,
            ) ||
...
function Rc(n, e, t) {
  ...
  return {
    ...
    selection: e.selection
      ? e.selection.map(r)
      : (i = n.selection) === null || i === undefined
        ? undefined
        : i.map(s),
...
function Kr(n, e, t) {
  ...
  return {
    changes:
      e.changes instanceof de
        ? e.changes
        : de.of(e.changes || [], t, n.facet(Xc)),
...
function mm(n) {
  ...
  for (let e = 0; e < n.length; e++) {
    ...
    if (
      /\w/.test(t) ||
      (t > "" && (t.toUpperCase() != t.toLowerCase() || dm.test(t)))
    ) {
      return true;
    }
  }
...
class Fo {
  ...
  between(e, t, i, s) {
    for (
      let r = this.findIndex(t, -1000000000, true),
        o = this.findIndex(i, 1000000000, false, r);
      r < o;
      r++
    ) {
...
class Li {
  ...
  addActive(e) {
    let t = 0;
    let { value: i, to: s, rank: r } = this.cursor;
    while (
...
var $ = {
  ...
  webkit: ha,
  webkit_version: ha
    ? +(/\bAppleWebKit\/(\d+)/.exec(Te.userAgent) || [0, 0])[1]
    : 0,
  safari: ho,
  safari_version: ho
    ? +(/\bVersion\/(\d+(\.\d+)?)/.exec(Te.userAgent) || [0, 0])[1]
    : 0,
  tabSize:
    oo.documentElement.style.tabSize != null ? "tab-size" : "-moz-tab-size",
};
function Uo(n, e) {
  for (let t in n) {
    if (t == "class" && e.class) {
...
class gn extends X {
  ...
  eq(e) {
    return (
      this == e ||
      (e instanceof gn && this.tagName == e.tagName && Ho(this.attrs, e.attrs))
    );
  }
  range(e, t = e) {
    if (e >= t) {
  ...
  eq(e) {
    return (
      ...
      (e instanceof sn &&
        ...
        Ho(this.attributes, e.attributes))
    );
  }
  static create(e) {
    return new sn(
...
function $e(n, e, t) {
  ...
  if (i.length) {
    ...
    !window.onerror ||
    !window.onerror(String(e), t, undefined, undefined, e)
  ) {
    if (t) {
      console.error(t + ":", e);
    } else {
      ...
      if (s.isComposite()) {
        if (o) {
          ...
          if (
            ...
            (!i || i.skip(a, 0, a.length) !== false || !a.isComposite)
          ) {
            o = !!h;
            r++;
            e -= a.length;
...
class Im {
  ...
  endLine() {
    if (this.curLine) {
      ...
      if (
        !e ||
        !Oa(this.curLine, false) ||
        (e.dom.nodeName != "BR" &&
          e.isWidget() &&
          (!$.ios || !Oa(this.curLine, true)))
      ) {
        this.curLine.append(
          this.cache.findWidget(ur, 0, 32) || new li(ur.toDOM(), 0, ur, 32),
        );
      }
  ...
  getBlockPos() {
    ...
    for (let i of this.wrappers) {
      ...
      if (i.from < this.pos && s instanceof xt && s.wrapper.eq(i.wrapper)) {
        ...
        let r = xt.of(
          i.wrapper,
          this.cache.find(xt, (o) => o.wrapper.eq(i.wrapper))?.dom,
        );
        t.append(r);
        t = r;
      }
      ...
      point: (l, a, h, c, f, u) => {
        if (h instanceof ri) {
          ...
          if (f > c.length) {
            ...
            let m = _m(h);
            let p =
              this.cache.findWidget(d, a - l, m) ||
              li.of(d, this.view, a - l, m);
            if (h.block) {
              if (h.startSide > 0) {
...
class ga {
  ...
  updateSelection(e = false, t = false) {
    ...
    this.impreciseAnchor = h.precise
      ? null
      : new He(f.anchorNode, f.anchorOffset);
  ...
  enforceCursorAssoc() {
    ...
    let i = rn(e.root);
    let { anchorNode: s, anchorOffset: r } = e.observer.selectionRange;
  ...
  scrollIntoView(e) {
    ...
    let s = this.coordsAt(
      i.head,
      i.assoc ?? (i.empty ? 0 : i.head > i.anchor ? -1 : 1),
    );
    let r;
    if (!s) {
      return;
    ...
    let { offsetWidth: a, offsetHeight: h } = this.view.scrollDOM;
    vm(
      this.view.scrollDOM,
      l,
      i.head < i.anchor ? -1 : 1,
  ...
  scanTile(e, t) {
    ...
    let s = this.scan(i, (l) => {
      ...
      if (a.flags & 48) {
        ...
        return (
          a.dom.nodeType == 1 ? a.dom : ln(a.dom, 0, a.length)
        ).getClientRects();
      }
    });
    ...
    for (let s = e; ;) {
      ...
      if (
        (o && a
          ...
          : (o ? o.breakAfter : ms(s)) ||
            (ms(l) &&
              (s.nodeName != "BR" || (o != null && o.isWidget())) &&
              this.text.length > r)) &&
        !mp(l, t)
      ) {
        this.lineBreak();
...
function bf(n, e) {
  ...
  let o =
    n.inputState.lastKeyTime > Date.now() - 100 ? n.inputState.lastKeyCode : -1;
  if (e.bounds) {
...
function Op(n, e, t) {
  ...
  if (o > -1) {
    ...
    i = s.replaceSelection(
      n.state.toText(
        a + e.insert.sliceString(0, undefined, n.state.lineBreak) + h,
      ),
    );
  } else {
    let a = s.changes(e);
    ...
    if (
      ...
      i = s.changeByRange((m) => {
        ...
        return {
          changes: b,
          range: h
            ? y.range(Math.max(0, h.anchor + x), Math.max(0, h.head + x))
            : m.map(b),
        };
      });
    } else {
  ...
  flushIOSKey(e) {
    ...
    if (
      ...
      return bi(
        ...
        t.key,
        t.keyCode,
        t instanceof KeyboardEvent ? t : undefined,
      );
    }
  }
...
Ke.dragstart = (n, e) => {
  ...
  if (e.dataTransfer) {
    e.dataTransfer.setData(
      "Text",
      zs(n.state, el, n.state.sliceDoc(t.from, t.to)),
    );
...
function va(n, e, t, i) {
  ...
  let { draggedContent: r } = n.inputState;
  let o =
    i && r && vp(n, e)
      ? {
          from: r.from,
...
Ke.beforeinput = (n, e) => {
  ...
  if (e.inputType == "insertReplacementText" && n.observer.editContext) {
    let r =
      (t = e.dataTransfer) === null || t === undefined
        ? undefined
...
class ye extends Xe {
  ...
  blockAt(e, t, i, s) {
    ...
    if (t.lineWrapping) {
      ...
      let { from: c, length: f } = t.doc.line(r + h);
  ...
  updateHeight(e, t = 0, i = false, s) {
    ...
    if (s && s.from <= t + this.length && s.more) {
      ...
      let a = -1;
      for (
        s.from > t && o.push(new ye(s.from - t - 1).updateHeight(e, t));
        l <= r && s.more;
      ) {
...
class Xa {
  ...
  updateForViewport() {
    let e = [this.viewport];
    let { main: t } = this.state.selection;
    for (let i = 0; i <= 1; i++) {
  ...
  measure() {
    ...
    if (a) {
      ...
      if (
        o ||
        (s.lineWrapping && Math.abs(Q - this.contentDOMWidth) > s.charWidth)
      ) {
        let {
          lineHeight: S,
          charWidth: k,
  ...
  getViewport(e, t) {
    ...
    let { visibleTop: o, visibleBottom: l } = this;
    let a = new An(
      s.lineAt(o - i * 1000, H.ByHeight, r, 0, 0).from,
      s.lineAt(l + (1 - i) * 1000, H.ByHeight, r, 0, 0).to,
    );
    if (t) {
      let { head: h } = t.range;
      if (h < a.from || h > a.to) {
        ...
        a = new An(
          s.lineAt(u - 500, H.ByHeight, r, 0, 0).from,
          s.lineAt(u + c + 500, H.ByHeight, r, 0, 0).to,
        );
      }
    }
    return a;
  ...
  viewportIsAppropriate({ from: e, to: t }, i = 0) {
    ...
    let { bottom: r } = this.heightMap.lineAt(
      t,
      H.ByPos,
      this.heightOracle,
      0,
    ...
    let a = (c, f, u, d) => {
      ...
      if (!O) {
        if (
          ...
          t &&
          i &&
          t.visibleRanges.some((Q) => Q.from <= f && Q.to >= f)
        ) {
...
class Up {
  ...
  onSelectionChange(e) {
    ...
    if (
      i.state.facet(yt) ? i.root.activeElement != this.dom : !_i(this.dom, s)
    ) {
      return;
    }
  ...
  flush(e = true) {
    ...
    if (
      this.view.state == i &&
      (t.domChanged ||
        (t.newSel && !bs(this.view.state.selection, t.newSel.main)))
    ) {
      this.view.update([]);
    }
    return s;
  ...
  update(e) {
    if (this.editContext) {
      ...
      if (e.startState.facet(yt) != e.state.facet(yt)) {
        e.view.contentDOM.editContext = e.state.facet(yt)
    ...
    e.changes.iterChanges((r, o, l, a, h) => {
      ...
      if (o <= this.from) {
        ...
        if (
          r < this.from ||
          o > this.to ||
          this.to - this.from + h.length > 30000
        ) {
          i = true;
          return;
        }
...
class v {
    ...
    try {
      ...
      for (let u of e) {
        ...
        if (u.scrollIntoView) {
          ...
          let { x: m, y: p } = this.state.facet(v.cursorScrollMargin);
          f = new yi(
  ...
  measure(e = true) {
    ...
    let { scrollAnchorPos: r, scrollAnchorHeight: o } = this.viewState;
  ...
  get themeClasses() {
    return (
      Qo + " " + (this.state.facet(xo) ? Xf : $f) + " " + this.state.facet(Rn)
    );
  }
  updateAttrs() {
    let e = Va(this, cf, {
  ...
  mountStyles() {
    ...
    Rt.mount(
      this.root,
      this.styleModules.concat(_p).reverse(),
      e
        ? {
            nonce: e,
          }
  ...
  bidiSpans(e) {
    ...
    for (let r of this.bidiCache) {
      if (
        r.from == e.from &&
        r.dir == t &&
        (r.fresh || Uc(r.isolates, (i = ma(this, e))))
      ) {
        return r.order;
      }
    }
  ...
  get hasFocus() {
    return (
      (this.dom.ownerDocument.hasFocus() ||
        ($.safari && this.inputState?.lastContextMenu > Date.now() - 30000)) &&
  ...
  scrollSnapshot() {
    ...
    return $n.of(
      new yi(y.cursor(i.from), "start", "start", i.top - e, t, true),
    );
  }
  setTabFocusMode(e) {
    if (e == null) {
...
class ii {
  ...
  static forRange(e, t, i) {
    if (i.empty) {
      ...
      let r = Mf(e);
      return [
        new ii(t, s.left - r.left, s.top - r.top, null, s.bottom - s.top),
      ];
    } else {
      return oO(e, t, i);
    }
...
const cO = Rf({
  ...
  markers(n) {
    ...
    for (let s of e.selection.ranges) {
      ...
      if (
        s.empty ||
        (t.drawRangeCursor && (!r || !$.ios || !t.iosSelectionHandles))
      ) {
        let o = r
...
const fO = Rf({
  ...
  markers(n) {
    let e = [];
    let { main: t, ranges: i } = n.state.selection;
    for (let s of i) {
      if (!s.empty) {
    ...
    for (let r of e.visibleRanges) {
      ...
      if (l >= o) {
        ...
        if (a == h) {
          ...
          Na(e.state.doc, this.regexp, c, f, (p, O) =>
            this.addMatch(O, e, p, m),
          );
        }
        t = t.update({
          filterFrom: c,
...
function Ya(n, e) {
  ...
  let r =
    s > vo
      ...
      : s == i.length
        ? AO(n, e.clientX)
        : Ei(i.text, n.state.tabSize, t - i.from);
  return {
    line: i.number,
    col: r,
    off: s,
...
const br = T.define({
  combine: (n) => {
    return {
      position: $.ios
        ? "absolute"
        : n.find((s) => s.position)?.position || "fixed",
        ...
        let Q =
          u.width > i.right - i.left
            ...
            : x
              ? Math.max(
                  i.left,
                  Math.min(f.left - (d ? 14 : 0) + b.x, i.right - p),
                )
              : Math.min(
                  Math.max(i.left, f.left - p + (d ? 14 : 0) - b.x),
                  i.right - p,
                );
        let C = this.above[l];
        if (
...
class YO {
  ...
  mousemove(e) {
    ...
    if (
      (s.length && !this.locked.has(s) && r && !GO(r.dom, e)) ||
      this.pending
    ) {
...
const UO = K.fromClass(
  class {
    ...
    syncGutters(n) {
      ...
      let i = [];
      let s = this.gutters.map(
        (r) => new HO(r, this.view.viewport, -this.view.documentPadding.top),
      );
  ...
  iterate(e) {
    ...
    for (let a = this.cursor(o | te.IncludeAnonymous); ;) {
      ...
      if (
        a.from <= r &&
        a.to >= s &&
        ((!l && a.type.isAnonymous) || t(a) !== false)
      ) {
        if (a.firstChild()) {
          continue;
        }
...
class Dt {
  ...
  findChild(e, t, i, s, r) {
    ...
    for (
      let a = e;
      a != t && (!Ff(r, s, o[a + 1], o[a + 2]) || !((l = a), i > 0));
      a = o[a + 3]
    );
    return l;
  }
...
class At extends Uf {
  ...
  get nextSibling() {
    ...
    if (
      t < (this._parent ? e.buffer[this._parent.index + 3] : e.buffer.length)
    ) {
...
function ul(n) {
  return n.children.some(
    (e) => e instanceof Dt || !e.type.isAnonymous || ul(e),
  );
}
function fg(n) {
  let {
...
function ih(n, e, t) {
  ...
  if (!i || i.allowsNesting) {
    for (
      let r = s;
      r;
      r = r.enter(e, t, te.ExcludeBuffers | te.EnterBracketed)
    ) {
      if (r.type.isTop) {
        s = r;
      }
...
class ws {
  ...
  takeTree() {
    ...
    if (this.parse && (e = this.parse.parsedPos) >= this.treeLen) {
      ...
      this.tree = t;
      this.fragments = this.withoutTempSkipped(
        ni.addTree(this.tree, this.fragments, true),
      );
      this.parse = null;
    }
  }
...
const vr =
  typeof navigator !== "undefined" &&
  (wr = navigator.scheduling) !== null &&
  wr !== undefined &&
  wr.isInputPending
    ? () => navigator.scheduling.isInputPending()
    : null;
const vg = K.fromClass(
  class {
    constructor(e) {
      this.view = e;
      this.working = null;
    ...
    work(e) {
      ...
      let o =
        ...
        Math.min(
          this.chunkBudget,
          100,
          e && !vr ? Math.max(25, e.timeRemaining() - 5) : 1000000000,
        );
      let l = r.context.treeLen < s && i.doc.length > s + 1000;
      let a = r.context.work(
        () => (vr && vr()) || Date.now() > o,
        s + (l ? 0 : 100000),
      );
...
class Fs {
  ...
  lineAt(e, t = 1) {
    ...
    let { simulateBreak: s, simulateDoubleBreak: r } = this.options;
  ...
  column(e, t = 1) {
    ...
    let o = this.options.overrideIndentation
...
function Vg() {
  return Y.transactionFilter.of((n) => {
    ...
    let t = n.newDoc;
    let { head: i } = n.newSelection.main;
    let s = t.lineAt(i);
    if (i > s.from + Rg) {
      return n;
    }
    ...
    class {
      ...
      update(o) {
        if (
          ...
          o.startState.field(Nt, false) != o.state.field(Nt, false) ||
      ...
      buildMarkers(o) {
        ...
        for (let a of o.viewportLineBlocks) {
          let h = qs(o.state, a.from, a.to)
            ? i
            : Cs(o.state, a.from, a.to)
              ? t
              : null;
          if (h) {
...
function oh(n) {
  ...
  for (let i of n.selection.ranges) {
    ...
    let s =
      ...
      (t.afterCursor &&
        (ft(n, i.head, 1, t) ||
          (i.head < n.doc.length && ft(n, i.head + 1, -1, t))));
    if (s) {
...
function ob(n, e, t, i, s, r, o) {
  ...
  for (let u = 0; !c.next().done && u <= r;) {
    ...
    let m = e + u * t;
    for (
      let p = t > 0 ? 0 : d.length - 1, O = t > 0 ? d.length : -1;
      p != O;
      p += t
    ) {
      let b = o.indexOf(d[p]);
...
class Me {
  ...
  toJSON() {
    ...
    return {
      changes:
        (e = this.changes) === null || e === undefined ? undefined : e.toJSON(),
      mapped:
        (t = this.mapped) === null || t === undefined ? undefined : t.toJSON(),
      startSelection:
        (i = this.startSelection) === null || i === undefined
          ? undefined
          : i.toJSON(),
...
function qb(n, e, t) {
  let i = Su(
    n.selectionsAfter.length ? n.selectionsAfter.map((l) => l.map(e)) : Ze,
    t,
  );
  if (!n.changes) {
    return Me.selection(i);
...
function Au(n, e) {
  let t = Eu(n);
  let { state: i } = n;
  let s = Ai(i.selection, (o) =>
    o.empty ? n.moveVertically(o, e, t.height) : Ks(o, e),
  );
  if (s.eq(i.selection)) {
    return false;
  }
...
const f0 = ({ state: n, dispatch: e }) => zu(n, e, false);
const u0 = ({ state: n, dispatch: e }) => zu(n, e, true);
function ju(n, e, t) {
  if (n.readOnly) {
    return false;
  }
...
const d0 = ({ state: n, dispatch: e }) => ju(n, e, false);
const m0 = ({ state: n, dispatch: e }) => ju(n, e, true);
const p0 = (n) => {
  if (n.state.readOnly) {
    return false;
  }
...
class $i {
  ...
  match(e, t, i, s, r) {
    ...
    if (
      o &&
      this.test &&
      !this.test(o.from, o.to, this.buffer, this.bufferStart)
    ) {
      o = null;
    }
    return o;
...
function $s(n, e) {
  ...
  while (
    e < t.to &&
    (i = t.text.charCodeAt(e - t.from)) >= 56320 &&
    i < 57344
  ) {
    e++;
  }
...
function X0(n, e, t, i) {
  return (
    n(e.sliceDoc(t, t + 1)) == ee.Word && n(e.sliceDoc(i - 1, i)) == ee.Word
  );
}
...
function ci(n, e, t, i) {
  ...
  return new $i(
    ...
    t,
    i,
    n.caseSensitive ? undefined : (r) => r.toLowerCase(),
    s,
  );
}
function W0(n, e) {
...
function N0(n) {
  return (e, t, i) =>
    !i[0].length ||
    ((n(Xs(i.input, i.index)) != ee.Word ||
      n(Es(i.input, i.index)) != ee.Word) &&
...
const Ps = wn((n, { query: e }) => {
  let { state: t } = n;
  let { from: i } = t.selection.main;
...
const xh = wn((n, { query: e }) => {
  let { state: t } = n;
  let { from: i, to: s } = t.selection.main;
  if (t.readOnly) {
    return false;
  }
...
function Wo(n, e) {
  ...
  return new Ju({
    search:
      ((e == null ? undefined : e.literal) ?? h.literal)
        ? a
        : a.replace(/\n/g, "\\n"),
...
const Cl = (n) => {
  ...
  if (e && e.panel) {
    ...
    n.dispatch({
      effects: [
        wl.of(true),
        e ? un.of(Wo(n.state, e.query.spec)) : M.appendConfig.of(H0),
      ],
    });
  }
  return true;
...
class oy {
  constructor(e, t, i) {
    ...
    let { options: r, selected: o } = s.open;
  ...
  measureInfo() {
    ...
    if (
      s.top > Math.min(r.bottom, t.bottom) - 10 ||
...
function hy(n, e) {
  ...
  if (i) {
    ...
    let f = 0;
    let u = (d, m) =>
      (d.rank === "dynamic" && m.rank === "dynamic"
        ? s[m.name] - s[d.name]
        : 0) ||
      (typeof d.rank == "number" ? d.rank : 1000000000) -
        (typeof m.rank == "number" ? m.rank : 1000000000) ||
      (d.name < m.name ? -1 : 1);
...
class Rs {
  ...
  update(e) {
    let { state: t } = e;
    let i = t.facet(ge);
    let r = (i.override || t.languageDataAt("autocomplete", si(t)).map(ty)).map(
      (a) =>
        (
...
class Qi extends ze {
  ...
  updateFor(e, t) {
    ...
    if (
      l > o ||
      !s ||
      (t & 2 && (si(e.startState) == this.from || l < this.limit))
    ) {
...
function jn(n, e = "option") {
  return (t) => {
    ...
    let l =
      i.open.selected > -1 ? i.open.selected + s * (n ? 1 : -1) : n ? 0 : o - 1;
    if (l < 0) {
      l = e == "page" ? 0 : o - 1;
    } else if (l >= o) {
      l = e == "page" ? o - 1 : 0;
    ...
    update(n) {
      ...
      for (let r = 0; r < this.running.length; r++) {
        ...
        if (
          ...
          (o.updates.length + n.transactions.length > yy &&
            Date.now() - o.time > xy)
        ) {
      ...
      this.debounceUpdate = e.active.some(
        (r) =>
          r.isPending && !this.running.some((o) => o.active.source == r.source),
      )
...
function Ml(n, e) {
  return y.create(
    n.filter((t) => t.field == e).map((t) => y.range(t.from, t.to)),
  );
}
function Ty(n) {
  let e = Pl.parse(n);
  return (t, i, s, r) => {
    ...
    let h = {
      ...
      scrollIntoView: true,
      annotations: i
        ? [Tl.of(i), fe.userEvent.of("input.complete")]
        : undefined,
    };
    if (l.length) {
      h.selection = Ml(l, 0);
...
function Iy(n, e, t, i) {
  ...
  let o = n.changeByRange((l) => {
    ...
    if (h == e) {
      ...
      if (
        t &&
        n.sliceDoc(a - e.length * 2, a) == e + e &&
        (c = $h(n, a - e.length * 2, s)) > -1 &&
        Th(n, c)
      ) {
        return {
          changes: {
...
const zy = kt.highest(
  Yt.computeN([ge], (n) => (n.facet(ge).defaultKeymap ? [Wl] : [])),
);
class Xh {
  constructor(e, t, i) {
    this.from = e;
  ...
  static init(e, t, i) {
    ...
    for (let d = 0; ;) {
      ...
      if (b) {
        ...
        let Q = l.reduce(
          (C, w) => (w.markClass ? C + " " + w.markClass : C),
          "",
        );
        o.add(
          p,
...
function Bt(n, e = null, t = 0) {
  let i = null;
  n.between(t, 1000000000, (s, r, { spec: o }) => {
...
const Re = le.define({
  ...
  update(n, e) {
    ...
    for (let t of e.effects) {
      if (t.is(ir)) {
        let i = e.state.facet(dt).autoPanel
          ? t.value.length
            ? On.open
            : null
          : n.panel;
...
const Ll = (n) => {
  ...
  if (
    !i &&
    ((i = Bt(e.diagnostics, null, 0)), !i || (i.from == t.from && i.to == t.to))
  ) {
    return false;
  } else {
    n.dispatch({
    ...
    Nf(n, i.from, 1, {
      ...
      until: (s) =>
        s.docChanged ||
        s.newSelection.main.head < i.from ||
        s.newSelection.main.head > i.to,
    });
    return true;
  }
};
const bd = (n) => {
  ...
  Nf(n, h, 1, {
    ...
    until: (f) =>
      f.docChanged ||
      f.newSelection.main.head < h ||
      f.newSelection.main.head > c,
  });
  return true;
};
const Hy = [
...
const Ky = K.fromClass(
  class {
    ...
    update(n) {
      ...
      if (
        n.docChanged ||
        e != n.startState.facet(dt) ||
        (e.needsRefresh && e.needsRefresh(n))
      ) {
    ...
    (i = e.actions) === null || i === undefined
      ...
      : i.map((r, o) => {
          ...
          let f =
            c < 0
              ? h
              : [h.slice(0, c), j("u", h.slice(c, c + 1)), h.slice(c + 1)];
...
function s1(n, e, t) {
  function i() {
    let o = n.elementAtHeight(
      e.getBoundingClientRect().top + 5 - n.documentTop,
    );
...
var Rr = null;
var k1 = () =>
  typeof window === "undefined" ? new Nh() : ((Rr ||= new Nh()), Rr);
var Bh = Ot.define();
var w1 = 200;
var v1 = [];
function C1(n) {
...
const E1 = ({ maxEntries: n = 24 } = {}) => {
  if (!Number.isInteger(n) || n < 1) {
    throw new Error(
      "LaTeX editor session cache size must be a positive integer.",
    );
  }
  const e = new Map();
  const t = (l, a) => {
...
const Gh = (n) =>
  n instanceof Error
    ? n
    : new Error("Could not preserve the LaTeX editor session.");
const R1 = ({
  fileId: n,
  source: e,
  cache: t = A1,
  ...
  if (!Number.isFinite(i) || i < 0) {
    throw new Error(
      "LaTeX editor session capture delay must be a non-negative number.",
    );
  }
  const o = P.useRef(e);
  o.current = e;
      ...
      if (!!n && !!S) {
        try {
          ...
          if (p.current) {
            ...
            console.error(
              "Could not preserve the outgoing LaTeX editor session.",
              R,
            );
          }
        }
  ...
  const t = e
    .map((o, l) => {
      if (!Number.isInteger(o) || o < 0 || o > n.length) {
        throw new Error(
          "LaTeX source positions must be valid character offsets.",
        );
      }
      return {
        index: l,
...
`);
  ...
  i.forEach((a) => {
    ...
    const c = /^\$\$\s*$/.test(h);
    const u =
      /^(?:\\end\s*\{|\\\]|\\\))/.test(h) || (c && l) ? Math.max(0, r - 1) : r;
    s.push(`${t.repeat(u)}${h}`);
    r = Math.max(0, r + N1(h));
    if (c) {
...
const G1 = ({ callbacks: n, keybindings: e }) => {
  const t = [
    {
      id: "format-document",
...
class Ws {
  ...
  reduce(e) {
    ...
    if (
      c >= 2000 &&
      ((t = this.p.parser.nodeSet.types[s]) === null ||
        t === undefined ||
        !t.isAnonymous)
    ) {
  ...
  nextFragment() {
    ...
    if (e) {
      this.safeFrom = e.openStart
        ? _h(e.tree, e.from + e.offset, 1) - e.offset
        : e.from;
      this.safeTo = e.openEnd
        ? _h(e.tree, e.to + e.offset, -1) - e.offset
        : e.to;
...
class H1 {
  ...
  advanceStack(e, t, i) {
    ...
    for (let h = 0; h < a.length;) {
      ...
      if (Ne) {
        console.log(
          `${o + this.stackID(m)} (via ${(c & 65536) == 0 ? "shift" : `reduce of ${r.getName(c & 65535)}`} for ${r.getName(f)} @ ${s}${m == e ? "" : ", split"})`,
        );
      }
      if (d) {
        return true;
  ...
  runRecovery(e, t, i) {
    ...
    for (let o = 0; o < e.length; o++) {
      ...
      for (
        ...
        d < 10 &&
        f.forceReduce() &&
        (Ne && console.log(u + this.stackID(f) + " (via force-reduce)"),
      ...
      if (this.stream.end > l.pos) {
        ...
        if (Ne) {
          console.log(
            `${c + this.stackID(l)} (via recover-delete ${this.parser.getName(a)})`,
          );
        }
        Fh(l, i);
...
function XS(n = {}) {
  ...
  return (t) => {
    ...
    if (
      e.checkMissingReferences ||
      e.checkDuplicateLabels ||
      e.checkCitesWithoutBibliography
    ) {
      RS(o, r, s, {
...
function RS(n, e, t, i) {
  ...
  n.cursor().iterate((h) => {
    if (h.name === "LabelCtrlSeq") {
      ...
      h.name === "BibliographyCtrlSeq" ||
      h.name === "BiblatexCtrlSeq"
    ) {
      l = true;
    } else if (
...
const LS = {
  ...
  "\\maketitle": {
    description:
      "Generates a title based on \\title, \\author, and \\date commands.",
    syntax: "\\maketitle",
    example: "\\maketitle",
  },
  "\\title": {
...
\\end{equation*}`,
  ...
  align: {
    description:
      "Environment for aligning multiple equations, with equation numbers.",
...
\\end{align}`,
  ...
  "align*": {
    description:
      "Environment for aligning multiple equations, without equation numbers.",
    syntax: "\\begin{align*}...\\end{align*}",
    example: `\\begin{align*}
a &= b \\\\
c &= d
\\end{align*}`,
  ...
  verbatim: {
    description:
      "Environment for verbatim text, where LaTeX commands are not processed.",
...
const US =
  /\\(?:text|paren|foot|smart|super)?cite\w*\*?(?:\s*\[[^\]]*]){0,2}\s*\{([^{}]*)$/;
...
const tk = (n, e) => {
  const t = n.citations.map((s) => ({
    label: s.key,
    detail:
      [s.author, s.filePath].filter(Boolean).join(" · ") ||
      "Bibliography entry",
    info: s.title,
    type: "constant",
  }));
...
const rk = (n, e, t) => {
  ...
  const a = [...new Set([...Ns.environments, ...e.environments, ...o])].map(
    (h) => ({
      label: h,
      detail: o.has(h)
...
const xw = (n, e) =>
  n === e || (n.length === e.length && n.every((t, i) => Go(t) === Go(e[i])));
const Qw = (...n) => {
  const e = new Map();
  n.forEach((t) => {
    t.forEach((i) => {
...
const fk = (n) => {
  ...
  if (!t) {
    throw new Error(
      "The LaTeX editor theme font size must be expressed in rem.",
    );
  }
  const i = Number(t[1]);
  if (!Number.isFinite(i) || i <= 0) {
    throw new Error(
      "The LaTeX editor theme font size must be a positive rem value.",
    );
  }
  return i;
};
const uk = (n, e = fk(n)) => {
  ...
  const o = t
    ? qe(n.palette.codeSource.background, 0.94)
    : qe(n.palette.text.primary, 0.025);
  return [
    v.theme(
      {
        "&": {
...
const bk = (n, e) => () => {
  ...
  s.textContent = [
    "author" in e ? e.author : undefined,
    e.filePath,
    "line" in e && e.line ? `line ${e.line}` : undefined,
  ]
    .filter(Boolean)
    .join(" · ");
  if (s.textContent) {
...
const yk = (n, e, t) =>
  n.kind === "reference"
    ? (t.labels.find((i) => i.key === n.key) ??
      e.labels.find((i) => i.key === n.key))
    : (t.citations.find((i) => i.key === n.key) ??
      e.citations.find((i) => i.key === n.key));
const xk = (n, e) =>
  al(
    (t, i) => {
...
const vk = (n, e) => {
  ...
  const r = new Set(
    ((l = e.projectIndex) == null
      ? undefined
      : l.citations.map((a) => a.key)) ?? [],
  );
  for (const a of n.matchAll(
    /(?:@[A-Za-z]+\s*|\\bibitem(?:\[[^\]]*])?\s*)\{\s*([^,}\s]+)/g,
  )) {
    r.add(a[1].trim());
  }
  for (const a of n.matchAll(
...
const Ck = (n, e = {}) => {
  const t = wt(n);
  return [...Qk(n, t), ...Sk(t), ...wk(n, t), ...vk(t, e)].sort(
    (i, s) => i.from - s.from,
  );
};
const qk = new Set([
...
const Mk = (n) => {
  const e = n
    ...
    .sort((i, s) => i.from - s.from || i.to - s.to);
  const t = [];
  e.forEach((i) => {
    const s = t.at(-1);
    if (!s || i.from > s.to) {
  ...
  K.fromClass(
    class {
      ...
      render() {
        ...
        const i = this.view.state.field(n).ranges.map(({ from: s, to: r }) => {
...
const jk = (n, e) =>
  e
    ...
    .map((t) => {
      ...
      const r = t.endLine
        ? n.state.doc.line(Math.min(t.endLine, n.state.doc.lines))
        : i;
...
const Ir = (n, e) => {
  ...
  return {
    ...
    column: t - i.from + 1,
    cursorOffset: t,
    selectionLength: n.selection.ranges.reduce(
      (s, r) => s + Math.abs(r.to - r.from),
      0,
    ),
    wordCount: e,
...
const ew = (n) =>
  [n.title, n.description, n.category, n.shortcut]
    .filter(Boolean)
    .join(" ")
    .toLowerCase();
const _Component2 = ({ commands: n, editorView: e, open: t, onClose: i }) => {
  ...
  const u = (m) => {
    ...
    if (
      !!e &&
      ((p = m.isEnabled) == null ? undefined : p.call(m, e)) !== false
    ) {
      m.run(e);
      f();
      e.focus();
  ...
  return (
    <_Component
      ...
      onClose={f}
    >
      <_d id="latex-command-palette-title">
        <Wi variant="h6">Editor commands</Wi>
      </_d>
      <Fd sx={Uk}>
        <Ud
          autoFocus={true}
        ...
        >
          {h.map((m, p) => {
            var b;
            const O = e
              ? ((b = m.isEnabled) == null ? undefined : b.call(m, e)) !== false
              : false;
            return (
              <Gd
                disabled={!O}
                ...
                key={m.id}
              >
                <Fl direction="row" sx={Kk}>
                  <Fl sx={Jk}>
                    <Wi variant="subtitle2">{m.title}</Wi>
                    <Wi variant="caption" color="textSecondary">
                      {m.description}
                    </Wi>
                  </Fl>
                  {m.shortcut && (
                    <Wi variant="code" color="textSecondary" noWrap={true}>
                      {m.shortcut}
                    </Wi>
                  )}
                </Fl>
          ...
          {h.length === 0 && (
            <Wi variant="body2" color="textSecondary" align="center">
